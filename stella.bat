...
REM                                                                            #
REM Portions created by the Initial Developer are Copyright (C) 1996-2020      #
...
SET STELLA_CLASSES=%STELLA_ROOT%native\java\stella\target\classes
SET CLASSPATH=%STELLA_JAR%:%STELLA_CLASSES%
