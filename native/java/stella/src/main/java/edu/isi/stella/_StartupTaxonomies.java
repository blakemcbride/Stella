    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD (DELETED? BOOLEAN) ((SELF TAXONOMY-NODE)) :GLOBALLY-INLINE? TRUE (RETURN (EQL? (LABEL SELF) DELETED-LABEL)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.TaxonomyNode", "deletedP", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (DELETED?-SETTER BOOLEAN) ((SELF TAXONOMY-NODE) (VALUE BOOLEAN)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.TaxonomyNode", "deletedPSetter", new java.lang.Class [] {java.lang.Boolean.TYPE})), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD (MEMBER? BOOLEAN) ((INTERVAL INTERVAL) (N INTEGER)) :GLOBALLY-INLINE? TRUE (RETURN (AND (>= N (LOWER-BOUND INTERVAL)) (<= N (UPPER-BOUND INTERVAL)))))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Interval", "memberP", new java.lang.Class [] {java.lang.Integer.TYPE})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NUMBERING-INTERVAL* INTEGER 100 :PUBLIC? TRUE :DOCUMENTATION \"Spacing between postorder numbers for nodes.  Allows limited\nincremental insertions without having to renumber the whole graph.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT MARKER-LABEL INTEGER -99 :DOCUMENTATION \"Dummy label used for marking a node\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT DELETED-LABEL INTEGER -99 :DOCUMENTATION \"Label used for marking deleted nodes\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *TAXONOMY-POSTORDER-NUMBER* INTEGER NULL)", null);
        }
