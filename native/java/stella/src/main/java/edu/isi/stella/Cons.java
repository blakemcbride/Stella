...
public class Cons extends StandardObject {
   ...
   * @return Cons
   */
  public static Cons consSetFirstGetNext(Cons list, Stella_Object value) {
    if (!(list == Stella.NIL)) {
      list.value = value;
    }
    return (list.rest);
   ...
   * @return Cons
   */
  public static Cons makeConsList(int size) {
    { Cons cell = null;
...
;
  ...
  public static Stella_Object javaTranslateSuperMethodCall(Cons tree) {
    { Cons otree = Symbol.javaTranslateNormalMethodCall(((Symbol)(tree.rest.rest.value)), ((Surrogate)(tree.rest.value)), tree.rest.rest.rest);

      otree.fourthSetter(Cons.list$(Cons.cons(Stella.SYM_STELLA_JAVA_IDENT, Cons.cons(StringWrapper.wrapString("super"), Cons.cons(Stella.NIL, Stella.NIL)))));
      return (otree);
    }
  }
...
;
  ...
  public static void cppOutputCast(Cons tree) {
    ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.print("(");
    if (Surrogate.subtypeOfStringP(Stella_Object.safePrimaryType(tree.rest.value))) {
      ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.print("(" + StringWrapper.unwrapString(((StringWrapper)(tree.rest.value))) + ")");
    }
    else {
      Stella_Object.cppOutputStatement(tree.rest.value);
    }
  ...
  public static Cons cppTranslateSuperMethodCall(Cons tree) {
    { Symbol methodname = ((Symbol)(tree.rest.value));
      Surrogate owner = ((Surrogate)(tree.value));
      Cons arguments = tree.rest.rest;
      Slot slot = Stella_Class.lookupSlot(((Stella_Class)(owner.surrogateValue)), methodname).slotDirectEquivalent;
      Cons otree = Symbol.cppTranslateNormalMethodCall(methodname, slot.slotOwner, arguments, false);
      String qualmethodname = StringWrapper.unwrapString(((StringWrapper)(Cons.consTreeNth(otree, Cons.cons(IntegerWrapper.wrapInteger(1), Cons.cons(IntegerWrapper.wrapInteger(1), Stella.NIL)))))) + "::" + ((StringWrapper)(Cons.consTreeNth(otree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(1), Stella.NIL))))).wrapperValue;

      otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_FUNCTION_CALL, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_IDENT, Cons.cons(StringWrapper.wrapString(qualmethodname), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(otree.nthRest(4).concatenate(Stella.NIL, Stella.NIL), Stella.NIL))));
      return (otree);
    }
  }
  ...
  public static Cons cppTranslateTheCode(Cons tree) {
    { Cons otree = null;
      ...
      { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree.rest.value));
        ...
        if (testValue000 == Stella.KWD_FUNCTION) {
          { Stella_Object methodspec = tree.rest.rest.value;
            boolean overloadedP = (Stella_Object.symbolP(methodspec) &&
                Symbol.cppPossiblyOverloadedFunctionNameP(((Symbol)(methodspec)))) ||
                (Stella_Object.methodSlotP(methodspec) &&
                 MethodSlot.cppMethodObjectIsOverloadedFunctionP(((MethodSlot)(methodspec))));

            otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_FUNCTION_POINTER, Cons.cons((Stella_Object.methodSlotP(methodspec) ? MethodSlot.cppTranslateFunctionName(((MethodSlot)(methodspec)), true) : Symbol.cppTranslateFunctionNameFromName(((Symbol)(methodspec)))), Cons.cons(Stella.NIL, Stella.NIL))));
            if (overloadedP) {
              if (Stella_Object.symbolP(methodspec)) {
                methodspec = Symbol.lookupFunction(((Symbol)(methodspec)));
              }
              otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_CAST, Cons.cons(otree, Cons.cons(Cons.cons(MethodSlot.cppTranslateFunctionSignature(((MethodSlot)(methodspec))), Stella.NIL), Stella.NIL))));
            }
            otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_CAST, Cons.cons(otree, Cons.cons(Cons.cons(StringWrapper.wrapString("cpp_function_code"), Stella.NIL), Stella.NIL))));
          }
        }
        else if (testValue000 == Stella.KWD_METHOD) {
          { Stella_Object methodspec = tree.fourth();
            Stella_Object ownerspec = tree.rest.rest.value;

            otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_CAST, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_METHOD_POINTER, Cons.cons((Stella_Object.methodSlotP(methodspec) ? MethodSlot.cppTranslateMethodName(((MethodSlot)(methodspec)), true) : Symbol.cppTranslateMethodNameFromName(((Symbol)(methodspec)), ((StandardObject)(ownerspec)))), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(StringWrapper.wrapString("cpp_method_code"), Cons.cons(Stella.NIL, Stella.NIL)))));
          }
        }
        else {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  public static Cons cppTranslateForeachTree(Cons tree) {
    { Object old$Cpploopexit$000 = Stella.$CPPLOOPEXIT$.get();

      try {
        Native.setSpecial(Stella.$CPPLOOPEXIT$, null);
        { Cons iteratorbindings = ((Cons)(tree.rest.value));
          Cons valuetrees = ((Cons)(tree.rest.rest.value));
          Cons nexttrees = ((Cons)(tree.fourth()));
          ...
          if (!(vadeclarations == Stella.NIL)) {
            otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_BLOCK, Cons.cons(vadeclarations.concatenate(declarations, Stella.NIL), Cons.cons(Cons.cons(Cons.cons(Stella.SYM_STELLA_CPP_STATEMENTS, Symbol.cppYieldVaStartTree(varargsiterator).concatenate(Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_FOREACH, Cons.cons(variables, Cons.cons(Cons.cons(continuationtest, Cons.cons(valueassignments, Cons.cons(nextassignments, Cons.cons(body, Stella.NIL)))), Stella.NIL)))), Symbol.cppYieldVaEndTree(varargsiterator).concatenate(Stella.NIL, Stella.NIL)), Stella.NIL)), Stella.NIL), Stella.NIL))));
          }
          else {
            otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_BLOCK, Cons.cons(declarations, Cons.cons(Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_FOREACH, Cons.cons(variables, Cons.cons(Cons.cons(continuationtest, Cons.cons(valueassignments, Cons.cons(nextassignments, Cons.cons(body, Stella.NIL)))), Stella.NIL)))), Stella.NIL), Stella.NIL))));
          }
          if (((Symbol)(Stella.$CPPLOOPEXIT$.get())) != null) {
            otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_STATEMENTS, Cons.cons(otree, Cons.cons(Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_GOTO_LABEL, Cons.cons(Stella_Object.cppTranslateATree(((Symbol)(Stella.$CPPLOOPEXIT$.get()))), Cons.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL))));
          }
          return (otree);
        }

      } finally {
        Stella.$CPPLOOPEXIT$.set(old$Cpploopexit$000);
      }
    }
  }
  ...
  public static Cons cppTranslateBreak(Cons tree) {
    if ((!(((Symbol)(Stella.$CPPLOOPEXIT$.get())) == Stella.SYM_STELLA_CPP_BREAK)) &&
        ((Boolean)(Stella.$CPPLOOPEXITACTIVEp$.get())).booleanValue()) {
      if (((Symbol)(Stella.$CPPLOOPEXIT$.get())) == null) {
        Native.setSpecial(Stella.$CPPLOOPEXIT$, Stella.localGensym("LOOP-EXIT"));
      }
      return (Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_GOTO, Cons.cons(Stella_Object.cppTranslateATree(((Symbol)(Stella.$CPPLOOPEXIT$.get()))), Cons.cons(Stella.NIL, Stella.NIL)))));
    }
    else {
  ...
  public static Cons cppTranslateWhile(Cons tree) {
    { Object old$Cpploopexit$000 = Stella.$CPPLOOPEXIT$.get();
      ...
      try {
        Native.setSpecial(Stella.$CPPLOOPEXIT$, null);
        { Stella_Object test = Stella_Object.cppTranslateATree(tree.rest.value);
          Cons otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_WHILE, Cons.cons(test, Cons.cons(Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_PROGN, Cons.cons(Cons.cons(Stella.SYM_STELLA_CPP_STATEMENTS, Cons.cppTranslateListOfTrees(tree.rest.rest).concatenate(Stella.NIL, Stella.NIL)), Cons.cons(Stella.NIL, Stella.NIL)))), Stella.NIL), Stella.NIL))));
  ...
  public static Cons cppTranslateLoop(Cons tree) {
    { Object old$Cpploopexit$000 = Stella.$CPPLOOPEXIT$.get();
      ...
      try {
        Native.setSpecial(Stella.$CPPLOOPEXIT$, null);
        { Cons otree = Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_LOOP, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_PROGN, Cons.cons(Cons.cons(Stella.SYM_STELLA_CPP_STATEMENTS, Cons.cppTranslateListOfTrees(tree.rest).concatenate(Stella.NIL, Stella.NIL)), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL))));
  ...
  public static Cons cppTranslateCaseTree(Cons tree) {
    { Cons otherwisecondition = null;
      ...
      { Object old$CpploopexitactiveP$000 = Stella.$CPPLOOPEXITACTIVEp$.get();

        try {
          Native.setBooleanSpecial(Stella.$CPPLOOPEXITACTIVEp$, true);
          { Stella_Object condition = null;
            Cons iter000 = tree.rest.rest;
          ...
          Stella.$CPPLOOPEXITACTIVEp$.set(old$CpploopexitactiveP$000);
        }
      }
    }
  }
...
;
  ...
  public static StringWrapper findFileInLoadPathEvaluatorWrapper(Cons arguments) {
    { String result = Stella.findFileInLoadPath(((StringWrapper)(arguments.value)).wrapperValue, ((Cons)(arguments.rest.value)));
  ...
  public static void transferFiles(Cons files, Keyword outputLanguage) {
    ...
    { String flotsamfilename = "";
      String systemSubDirectory = (Stella.stringEqlP(((String)(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$.get())), "") ? "" : Stella.fileNameAsDirectory(((String)(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$.get()))));
...
;
                ...
                fromfilename = Stella.concatenateFileNames(Stella.rootSourceDirectory(), Cons.cons(StringWrapper.wrapString(systemSubDirectory), Cons.cons(StringWrapper.wrapString(filename), Stella.NIL)));
...
;
                  ...
                  Stella.ensureDirectoriesExist(tofilename);
  ...
  public static void defineLogicalHostPropertyEvaluatorWrapper(Cons arguments) {
    Stella.defineLogicalHostProperty(((StringWrapper)(arguments.value)).wrapperValue, ((Keyword)(arguments.rest.value)), arguments.rest.rest.value);
  }
  ...
  public static Stella_Object ignore(Cons variables) {
    { Cons ignoretrees = Stella.NIL;
      ...
      { Stella_Object variable = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          variable = iter000.value;
          Symbol.setLocalVariableInfo(((Symbol)(variable)), Stella.KWD_READ_ONLYp, Stella.FALSE_WRAPPER);
          if (collect000 == null) {
            {
...
;
  ...
  public static Stella_Object clTranslateCallSuperMethodTree(Cons tree) {
    tree.firstSetter(Stella.SYM_STELLA_SYS_CALL_METHOD);
    { Symbol operator = null;
      Surrogate owner = null;
      Cons arguments = null;
      ...
      operator = Stella.internCommonLispSymbol("CALL-NEXT-METHOD");
      return (Symbol.clTranslateNormalCallMethodTree(operator, owner, arguments));
    }
  }
...
;
              ...
              else if (operatorname000 == Stella.SYM_STELLA_SETQ) {
                if (arguments.length() == 2) {
                  { Stella_Object varname = arguments.value;
                    Stella_Object value = arguments.rest.value;
                    StandardObject valuetype = null;
                    GlobalVariable global = null;

                    if (Stella_Object.symbolP(varname)) {
...
;
                          ...
                          stream003.nativeStream.println("':");
                          stream003.nativeStream.print("Undefined global variable: `" + varname + "'");
                          throw ((EvaluationException)(EvaluationException.newEvaluationException(stream003.theStringReader()).fillInStackTrace()));
                        }
                      }
                      { Object [] caller_MV_returnarray = new Object[1];

                        value = Stella_Object.evaluateArgumentTree(value, true, caller_MV_returnarray);
                        valuetype = ((StandardObject)(caller_MV_returnarray[0]));
                      }
                      GlobalVariable.writeGlobalVariableValue(global, value);
                      { Stella_Object _return_temp = value;

                        MV_returnarray[0] = valuetype;
                        return (_return_temp);
                      }
                    }
                  }
...
;
                  ...
                  stream004.nativeStream.println("':");
                  stream004.nativeStream.print("Illegal SETQ expression");
...
;
                    ...
                    stream005.nativeStream.println("':");
                    stream005.nativeStream.print("Undefined operator: `" + operatorname000 + "'");
            ...
            { OutputStringStream stream006 = OutputStringStream.newOutputStringStream();
              ...
              stream006.nativeStream.print("While evaluating '" + ((Stella_Object)(Stella.$EVALUATIONTREE$.get())));
              if (((Stella_Object)(Stella.$EVALUATIONPARENTTREE$.get())) != null) {
                {
                  stream006.nativeStream.println();
                  stream006.nativeStream.print("' inside '" + ((Stella_Object)(Stella.$EVALUATIONPARENTTREE$.get())));
                }
;
              }
              stream006.nativeStream.println("':");
              stream006.nativeStream.print("Illegal operator: `" + operatorname + "'");
              throw ((EvaluationException)(EvaluationException.newEvaluationException(stream006.theStringReader()).fillInStackTrace()));
            }
          }
            ...
            if ((nofargs < minargs) ||
              ...
              { String minstring = Native.integerToString(((long)(minargs)));
                ...
                { OutputStringStream stream007 = OutputStringStream.newOutputStringStream();
                  ...
                  stream007.nativeStream.print("While evaluating '" + ((Stella_Object)(Stella.$EVALUATIONTREE$.get())));
                  if (((Stella_Object)(Stella.$EVALUATIONPARENTTREE$.get())) != null) {
                    {
                      stream007.nativeStream.println();
                      stream007.nativeStream.print("' inside '" + ((Stella_Object)(Stella.$EVALUATIONPARENTTREE$.get())));
                    }
;
                  }
                  stream007.nativeStream.println("':");
                  stream007.nativeStream.print("Wrong number of arguments.  Expected `" + minstring + "'`" + maxstring + "' but got `" + nofargs + "'");
                  throw ((EvaluationException)(EvaluationException.newEvaluationException(stream007.theStringReader()).fillInStackTrace()));
                }
              }
            }
  ...
  public static String listSignatureToString(Cons signature) {
    { char sep = '\t';
      OutputStringStream ssig = OutputStringStream.newOutputStringStream();
      ...
      { Cons tuple = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest, iter001 = iter001 + 1) {
          ...
          i = iter001;
          if (i > 0) {
            ssig.nativeStream.print(sep);
          }
          ssig.nativeStream.print(StringWrapper.unwrapString(((StringWrapper)(tuple.value))) + sep + StringWrapper.unwrapString(((StringWrapper)(tuple.rest.value))) + sep + StringWrapper.unwrapString(((StringWrapper)(tuple.rest.rest.value))));
        }
      }
  ...
  public static Cons walkCallSuperMethodTree(Cons tree, Object [] MV_returnarray) {
    { MethodSlot enclosingmethod = ((MethodSlot)(Stella.$METHODBEINGWALKED$.get()));
      Cons calltree = null;
        ...
        { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            if (!(Stella.suppressWarningsP())) {
              ...
              {
                Stella.STANDARD_ERROR.nativeStream.println();
                Stella.STANDARD_ERROR.nativeStream.println(" call-super-method not called within a method: `" + Stella_Object.deUglifyParseTree(tree) + "'.");
              }
;
            }
      ...
      else if (!(((Symbol)(enclosingmethod.methodParameterNames().first())) == tree.rest.value)) {
        { Object old$PrintreadablyP$001 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            if (!(Stella.suppressWarningsP())) {
              ...
              {
                Stella.STANDARD_ERROR.nativeStream.println();
                Stella.STANDARD_ERROR.nativeStream.println(" call-super-method needs to be called with enclosing method's self arg: `" + Stella_Object.deUglifyParseTree(tree) + "'.");
              }
;
            }
      ...
      else if (enclosingmethod.slotDirectEquivalent == null) {
        { Object old$PrintreadablyP$002 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            if (!(Stella.suppressWarningsP())) {
              ...
              {
                Stella.STANDARD_ERROR.nativeStream.println();
                Stella.STANDARD_ERROR.nativeStream.println(" call-super-method: no super method available for: `" + Stella_Object.deUglifyParseTree(((MethodSlot)(Stella.$METHODBEINGWALKED$.get()))) + "'.");
              }
;
            }
        ...
        { Stella_Object value000 = null;
          ...
          { Object [] caller_MV_returnarray = new Object[1];
            ...
            value000 = Cons.walkCallSlotTree(tree, caller_MV_returnarray);
        ...
        baretree = ((Cons)(Stella_Object.walkedExpressionExpression(calltree)));
        if (baretree.value == Stella.SYM_STELLA_SYS_CALL_METHOD) {
          baretree.firstSetter(Stella.SYM_STELLA_SYS_CALL_SUPER_METHOD);
          return (Stella_Object.sysTree(calltree, calltype, MV_returnarray));
        }
        { Object old$PrintreadablyP$003 = Stella.$PRINTREADABLYp$.get();
          ...
          try {
            ...
            if (!(Stella.suppressWarningsP())) {
              ...
              {
                Stella.STANDARD_ERROR.nativeStream.println();
                Stella.STANDARD_ERROR.nativeStream.println(" Illegal call-super-method call or context: `" + Stella_Object.deUglifyParseTree(tree) + "'.");
              }
;
            }
      ...
      return (Stella_Object.walkDontCallMeTree(tree, ((StandardObject)(Stella.$TARGETTYPE$.get())), MV_returnarray));
    }
  }
  ...
  public static Cons walkTheCodeTree(Cons tree, Object [] MV_returnarray) {
    { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree.rest.value));
      ...
      if (testValue000 == Stella.KWD_FUNCTION) {
        ...
        if (!(Stella_Object.symbolP(tree.rest.rest.value))) {
          { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
            ...
            try {
              ...
              if (!(Stella.suppressWarningsP())) {
                ...
                {
                  Stella.STANDARD_ERROR.nativeStream.println();
                  Stella.STANDARD_ERROR.nativeStream.println(" Illegal function name: `" + tree.rest.rest.value + "'.");
                }
;
              }
...
;
        ...
        if (!(Stella_Object.isaP(tree.rest.rest.value, Stella.SGT_STELLA_GENERALIZED_SYMBOL))) {
          { Object old$PrintreadablyP$003 = Stella.$PRINTREADABLYp$.get();
            ...
            try {
              ...
              if (!(Stella.suppressWarningsP())) {
                ...
                {
                  Stella.STANDARD_ERROR.nativeStream.println();
                  Stella.STANDARD_ERROR.nativeStream.println(" Illegal method class: `" + tree.rest.rest.value + "'.");
                }
;
              }
        ...
        if (!(Stella_Object.symbolP(tree.fourth()))) {
          { Object old$PrintreadablyP$004 = Stella.$PRINTREADABLYp$.get();
            ...
            try {
              ...
              if (!(Stella.suppressWarningsP())) {
                ...
                {
                  Stella.STANDARD_ERROR.nativeStream.println();
                  Stella.STANDARD_ERROR.nativeStream.println(" Illegal method name: `" + tree.fourth() + "'.");
                }
;
              }
...
;
            ...
            if ((((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_CPP) ||
                (((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_CPP_STANDALONE)) {
              { Slot method = Stella_Class.lookupSlot(((Stella_Class)(type.surrogateValue)), ((Symbol)(tree.fourth())));

                if ((method != null) &&
                    MethodSlot.cppMethodObjectIsOverloadedFunctionP(((MethodSlot)(method)))) {
                  return (Stella_Object.sysTree(Cons.list$(Cons.cons(Stella.SYM_STELLA_THE_CODE, Cons.cons(Stella.KWD_FUNCTION, Cons.cons(method, Cons.cons(Stella.NIL, Stella.NIL))))), Stella.SGT_STELLA_FUNCTION_CODE, MV_returnarray));
                }
              }
    ...
    { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree.value));
      ...
      if ((testValue000 == Stella.SYM_STELLA_SYS_SLOT_VALUE) ||
          ((testValue000 == Stella.SYM_STELLA_SYS_CALL_METHOD) ||
           ((testValue000 == Stella.SYM_STELLA_SYS_CALL_SUPER_METHOD) ||
...
;
  ...
  public static StringWrapper getenvEvaluatorWrapper(Cons arguments) {
    { String result = Stella.getenv(((StringWrapper)(arguments.value)).wrapperValue, arguments.rest);
  ...
  public static void ensureDirectoriesExistEvaluatorWrapper(Cons arguments) {
    Stella.ensureDirectoriesExist(((StringWrapper)(arguments.value)).wrapperValue);
  }

  public static void createDirectoriesEvaluatorWrapper(Cons arguments) {
    Stella.createDirectories(((StringWrapper)(arguments.value)).wrapperValue);
  }
