...
public class MutableStringWrapper extends LiteralWrapper {
  ...
  public static Stella_Object accessMutableStringWrapperSlotValue(MutableStringWrapper self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_WRAPPER_VALUE) {
      if (setvalueP) {
        self.wrapperValue = ((MutableStringWrapper)(value)).wrapperValue;
      }
      else {
        value = MutableStringWrapper.wrapMutableString(self.wrapperValue);
      }
    }
    else {
