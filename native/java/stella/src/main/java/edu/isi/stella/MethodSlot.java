...
public class MethodSlot extends Slot {
  ...
  public static Cons cppTranslateFunctionSignature(MethodSlot function) {
    { Cons cppsig = MethodSlot.yieldFunctionCppSignature(function, null, true);
      Cons returns = Cons.cons(((StringWrapper)(((Cons)(cppsig.value)).rest.value)), Stella.NIL);
      Cons params = Stella.NIL;
      ...
      { Cons spec = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          ...
          if (collect000 == null) {
            {
              collect000 = Cons.cons((Stella_Object.eqlToStringP(((StringWrapper)(spec.value)), "...") ? ((StringWrapper)(spec.value)) : ((StringWrapper)(spec.rest.value))), Stella.NIL);
              if (params == Stella.NIL) {
                params = collect000;
              }
              else {
                Cons.addConsToEndOfConsList(params, collect000);
              }
            }
          }
          else {
            {
              collect000.rest = Cons.cons((Stella_Object.eqlToStringP(((StringWrapper)(spec.value)), "...") ? ((StringWrapper)(spec.value)) : ((StringWrapper)(spec.rest.value))), Stella.NIL);
              collect000 = collect000.rest;
            }
          }
        }
      }
      return (Cons.list$(Cons.cons(Stella.SYM_STELLA_CPP_FUNCTION_SIGNATURE, Cons.cons(returns, Cons.cons(Cons.cons(params, Stella.NIL), Stella.NIL)))));
    }
  }
  ...
  public static StringWrapper cppTranslateMethodName(MethodSlot method, boolean qualifyP) {
    { Surrogate methodtype = method.slotOwner;
      ...
      if (MethodSlot.cppMethodObjectIsFunctionP(method)) {
        return (MethodSlot.cppTranslateFunctionName(method, qualifyP));
      }
      else {
        return (StringWrapper.wrapString(GeneralizedSymbol.cppTranslateClassName(Symbol.internSymbolInModule(methodtype.symbolName, ((Module)(methodtype.homeContext)), false)).wrapperValue + "::" + MethodSlot.cppTranslateFunctionName(method, false).wrapperValue));
      }
    }
  }
...
;
  ...
  public static Cons yieldMethodCSignature(MethodSlot method, StandardObject firstargtype) {
    { StringWrapper cppname = ((StringWrapper)(((Cons)(MethodSlot.yieldMethodCppSignature(method, firstargtype, true).value)).value));
      Cons sig = null;

      try {
        method.methodFunctionP = true;
        sig = MethodSlot.yieldFunctionCSignature(method, firstargtype);
  ...
  public static Cons yieldMethodCppSignature(MethodSlot method, StandardObject firstargtype, boolean qualifyP) {
    { Object old$Module$000 = Stella.$MODULE$.get();
      Object old$Context$000 = Stella.$CONTEXT$.get();

      try {
        Native.setSpecial(Stella.$MODULE$, (qualifyP ? Stella.$ROOT_MODULE$ : method.homeModule()));
        ...
        { Cons sig = null;
          ...
          try {
            method.methodFunctionP = true;
            sig = MethodSlot.yieldFunctionCppSignature(method, firstargtype, qualifyP);

          } finally {
            method.methodFunctionP = false;
          }
          transname = MethodSlot.cppTranslateMethodName(method, qualifyP).wrapperValue;
          ((Cons)(sig.value)).firstSetter(StringWrapper.wrapString(transname));
          return (sig);
        }
  ...
  public static Cons yieldFunctionCSignature(MethodSlot function, StandardObject firstargtype) {
    { Cons cppsignature = MethodSlot.yieldFunctionCppSignature(function, firstargtype, true);
      Cons csignature = Stella.NIL;
      String name = null;
      String type = null;
      String stellatype = null;

      ((Cons)(cppsignature.value)).firstSetter(Symbol.cppTranslateName(MethodSlot.yieldCCallableWrapperName(function)));
      { Cons tuple = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          ...
          if (collect000 == null) {
            {
              collect000 = Cons.cons(Cons.consList(Cons.cons(StringWrapper.wrapString(name), Cons.cons(StringWrapper.wrapString(Stella.cppTypeToCType(type)), Cons.cons(StringWrapper.wrapString(stellatype), Stella.NIL)))), Stella.NIL);
              if (csignature == Stella.NIL) {
                csignature = collect000;
              }
              else {
                Cons.addConsToEndOfConsList(csignature, collect000);
              }
            }
          }
          else {
            {
              collect000.rest = Cons.cons(Cons.consList(Cons.cons(StringWrapper.wrapString(name), Cons.cons(StringWrapper.wrapString(Stella.cppTypeToCType(type)), Cons.cons(StringWrapper.wrapString(stellatype), Stella.NIL)))), Stella.NIL);
              collect000 = collect000.rest;
            }
          }
        }
  ...
  public static Cons yieldFunctionCppSignature(MethodSlot function, StandardObject firstargtype, boolean qualifyP) {
    { Object old$Module$000 = Stella.$MODULE$.get();
      Object old$Context$000 = Stella.$CONTEXT$.get();

      try {
        Native.setSpecial(Stella.$MODULE$, (qualifyP ? Stella.$ROOT_MODULE$ : function.homeModule()));
        Native.setSpecial(Stella.$CONTEXT$, ((Module)(Stella.$MODULE$.get())));
        if (firstargtype == null) {
          firstargtype = function.slotOwner;
        }
        { StandardObject returntype = MethodSlot.computeMostGeneralReturnType(function, function.computeReturnTypeSpec(firstargtype));
          Cons cppsig = Cons.cons(Cons.cons(MethodSlot.cppTranslateMethodName(function, true), Cons.cons((StandardObject.voidP(returntype) ? StringWrapper.wrapString("void") : StandardObject.cppTranslateAndPointerizeTypeSpec(returntype)), Cons.cons(StringWrapper.wrapString(Native.stringify(StandardObject.typeSpecToBaseType(returntype))), Stella.NIL))), Stella.NIL);
          List returntypes = function.methodReturnTypeSpecifiers();
          List parametertypes = function.methodParameterTypeSpecifiers();
          int retidx = 0;

          { Cons param = null;
            Cons iter000 = ((Cons)(MethodSlot.cppTranslateFunctionParameters(function)));
            int i = Stella.NULL_INTEGER;
            int iter001 = 0;
            ...
            for (;!(iter000 == Stella.NIL); iter000 = iter000.rest, iter001 = iter001 + 1) {
              ...
              i = iter001;
              { Stella_Object type = param.value;
                Stella_Object name = param.rest.value;
                StandardObject stellatype = null;

                if (type == Stella.SYM_STELLA_CPP_VAR_ARGS) {
                  cppsig = Cons.cons(Cons.consList(Cons.cons(name, Cons.cons(StringWrapper.wrapString("int"), Cons.cons(StringWrapper.wrapString(Native.stringify(Stella.SGT_STELLA_INTEGER)), Stella.NIL)))), cppsig);
                  name = StringWrapper.wrapString("...");
                  stellatype = MethodSlot.variableArgumentsType(function);
                  type = StandardObject.cppTranslateAndPointerizeTypeSpec(stellatype);
                }
                else if (Stella.startsWithP(((StringWrapper)(name)).wrapperValue, "_Return", 0)) {
                  retidx = retidx + 1;
                ...
                stellatype = StandardObject.computeRelativeTypeSpec(stellatype, firstargtype);
                cppsig = Cons.cons(Cons.consList(Cons.cons(name, Cons.cons(type, Cons.cons(StringWrapper.wrapString(Native.stringify(StandardObject.typeSpecToBaseType(stellatype))), Stella.NIL)))), cppsig);
              }
            }
          }
...
;
  ...
  public static boolean methodStoresNativeCodePointerP(MethodSlot method) {
    { Symbol name = method.slotName;
      ...
      else if (name == Stella.SYM_STELLA_MAIN) {
        return (false);
      }
      else if (((BooleanWrapper)(KeyValueList.dynamicSlotValue(method.dynamicSlots, Stella.SYM_STELLA_METHOD_NATIVEp, Stella.FALSE_WRAPPER))).wrapperValue) {
        if (Stella.getQuotedTree("((NULL? DEFINED?) \"/STELLA\")", "/STELLA").memberP(name)) {
          return (false);
        }
        if (Stella.$CPP_OPERATOR_TABLE$.lookup(name) != null) {
          return (false);
        }
        { StandardObject type = null;
          Cons iter000 = method.methodParameterTypeSpecifiers().theConsList;
          ...
          for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
            ...
            type = StandardObject.typeSpecToBaseType(StandardObject.computeRelativeTypeSpec(type, owner));
            if (Surrogate.subtypeOfP(((Surrogate)(type)), Stella.SGT_STELLA_LITERAL) &&
                Surrogate.typeToClass(((Surrogate)(type))).abstractP) {
              return (false);
            }
          }
        }
                  ...
                  if (method.methodReturnTypeSpecifiers().memberP(Stella.SGT_STELLA_LISP_CODE)) {
                  ...
                  else {
                    {
                      ...
                      if (!testValue001) {
                        ...
                        if (!testValue001) {
                          testValue001 = (((String)(Stella.$CURRENTFILENAME$.get())) != null) &&
                              ((Native.stringSearch(((String)(Stella.$CURRENTFILENAME$.get())), "cl-primal", 0) != Stella.NULL_INTEGER) ||
                               (Native.stringSearch(((String)(Stella.$CURRENTFILENAME$.get())), "stella-to-cl", 0) != Stella.NULL_INTEGER));
                        }
                      }
                    }
                  }
...
;
  ...
  public static Cons yieldDefineStellaMethodObject(MethodSlot method, MethodSlot codemethod, MethodSlot wrappermethod) {
    { Stella_Object name = StringWrapper.wrapString(Native.stringify(method.slotName));
      ...
      else if (Slot.inlineMethodP(method)) {
        return (Cons.list$(Cons.cons(Stella.SYM_STELLA_DEFINE_INLINE_METHOD_CODE, Cons.cons(method.slotOwner, Cons.cons(Cons.list$(Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_QUOTE, Cons.cons(method.slotName, Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(((codemethod != null) ? ((StandardObject)(Cons.list$(Cons.cons(Stella.SYM_STELLA_THE_CODE, Cons.cons(Stella.KWD_METHOD, Cons.cons(codemethod.slotOwner, Cons.cons(Cons.cons(codemethod.slotName, Stella.NIL), Stella.NIL))))))) : ((StandardObject)(Stella.SYM_STELLA_NULL))), Cons.cons(Cons.cons(Stella.SYM_STELLA_NULL, Stella.NIL), Stella.NIL)))), Stella.NIL)))));
      }
      else {
