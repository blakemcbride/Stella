    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("CPP-GET-NATIVE-TOP-LEVEL-SYSTEM-ROOT", "(DEFUN (CPP-GET-NATIVE-TOP-LEVEL-SYSTEM-ROOT FILE-NAME) ((SYSTEMNAME STRING)))", Native.find_java_method("edu.isi.stella.Stella", "cppGetNativeTopLevelSystemRoot", new java.lang.Class [] {Native.find_java_class("java.lang.String")}), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CURRENT-STREAM* OUTPUT-STREAM STANDARD-OUTPUT)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-TRANSLATED-FILE-SUFFIX* STRING \"\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MAKEFILE-TEMPLATE-VARIABLE-PREFIX* STRING \"#$\")", null);
        }
