  ...
  static void helpStartupCppOutput2() {
    {
      ...
      Stella.defineFunctionObject("CPP-OUTPUT-GOTO", "(DEFUN CPP-OUTPUT-GOTO ((LABEL OBJECT)))", Native.find_java_method("edu.isi.stella.Stella_Object", "cppOutputGoto", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("CPP-OUTPUT-GOTO-LABEL", "(DEFUN CPP-OUTPUT-GOTO-LABEL ((LABEL OBJECT)))", Native.find_java_method("edu.isi.stella.Stella_Object", "cppOutputGotoLabel", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((OBJECT OBJECT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Object", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((CHARACTER CHARACTER-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.CharacterWrapper", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((INT INTEGER-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.IntegerWrapper", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((INT LONG-INTEGER-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.LongIntegerWrapper", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((FLOAT FLOAT-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.FloatWrapper", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((BOOLEAN BOOLEAN-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.BooleanWrapper", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((CONS CONS)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Cons", "cppOutputLiteral", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((STRING STRING)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_cppOutputLiteral", new java.lang.Class [] {Native.find_java_class("java.lang.String")})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((STRING STRING-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StringWrapper", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((STRING MUTABLE-STRING-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.MutableStringWrapper", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((TREE QUOTED-EXPRESSION)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.QuotedExpression", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((SYMBOL SYMBOL)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Symbol", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((SURROGATE SURROGATE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Surrogate", "cppOutputLiteral", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD CPP-OUTPUT-LITERAL ((KEYWORD KEYWORD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Keyword", "cppOutputLiteral", new java.lang.Class [] {})), null);
    }
  }

  static void helpStartupCppOutput3() {
    {
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          _StartupCppOutput.helpStartupCppOutput3();
        }
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CPP-INDENT-CHARS* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *OUTPUTTINGDEFPRINT?* BOOLEAN FALSE :DOCUMENTATION \"`true' when outputting a defprint, used to \n            conditionally dereference streams in print-native-stream \n            statements.  Also used to take the address of streams\n            when passed to functions inside of a defprint\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-MAX-STRING-LITERAL-LENGTH* INTEGER 1024 :DOCUMENTATION \"C++ string literals longer than this are broken\ninto multiple pieces to avoid problems with certain MS compilers.\")", null);
        }
