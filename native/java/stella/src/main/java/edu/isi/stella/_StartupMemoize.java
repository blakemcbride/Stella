    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD INITIALIZE-MEMOIZABLE-ITERATOR ((SELF MEMOIZABLE-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.MemoizableIterator", "initializeMemoizableIterator", new java.lang.Class [] {})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ALL-MEMOIZATION-TABLES* (LIST OF MEMOIZATION-TABLE) (NEW LIST) :DOCUMENTATION \"Holds all currently active memoization tables for timestamp\nmaintenance and clearance purposes.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MEMOIZATION-ENABLED?* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT MEMOIZED-NULL-VALUE SYMBOL (NEW SYMBOL :SYMBOL-NAME \"MEMOIZED-NULL-VALUE\" :HOME-CONTEXT NULL) :DOCUMENTATION \"Used by memoization to indicate that a NULL value\nwas cached.  Needed to distinguish between an undefined value and a\ncached NULL.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TOTAL-MEMOIZATION-LOOKUPS* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *FAILED-MEMOIZATION-LOOKUPS* INTEGER 0)", null);
        }
