...
public abstract class Stella_Object {
    ...
    if (Stella_Object.safePrimaryType(tree) == Stella.SGT_STELLA_CONS) {
      { Cons tree000 = ((Cons)(tree));
        ...
        { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree000.value));
          ...
          else if (testValue000 == Stella.SYM_STELLA_SYS_CALL_SUPER_METHOD) {
            return (Cons.javaTranslateSuperMethodCall(tree000));
          }
  ...
  public static void cppOutputGotoLabel(Stella_Object label) {
    Stella_Object.cppOutputStatement(label);
    ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(":;");
  }

  public static void cppOutputGoto(Stella_Object label) {
    ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.print("goto ");
    Stella_Object.cppOutputStatement(label);
    ((OutputStream)(Stella.$CURRENT_STREAM$.get())).nativeStream.println(";");
  }
      ...
      { Cons statement000 = ((Cons)(statement));
        ...
        if (Stella_Object.consP(statement000.value) ||
          ...
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(statement000.value));
            ...
            else if (testValue000 == Stella.SYM_STELLA_CPP_GOTO) {
              Stella_Object.cppOutputGoto(statement000.rest.value);
            }
            else if (testValue000 == Stella.SYM_STELLA_CPP_GOTO_LABEL) {
              Stella_Object.cppOutputGotoLabel(statement000.rest.value);
            }
      ...
      { Cons tree000 = ((Cons)(tree));
        ...
        { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree000.value));
          ...
          if (testValue000 == Stella.SYM_STELLA_SPECIAL) {
            ...
            return (Cons.cppTranslateSuperMethodCall(tree000.rest));
          }
          else if (testValue000 == Stella.SYM_STELLA_SYS_CALL_FUNCTION) {
          ...
          { Cons conslist = Stella.NIL;
            ...
            { Stella_Object item = null;
              ...
              for (;(!(iter000 == Stella.NIL)) &&
                ...
                if (collect000 == null) {
                  {
                    collect000 = Cons.cons(((i == Stella.$PRETTY_PRINT_LIST_CUTOFF$) ? Stella.ELLIPSIS : item), Stella.NIL);
                  ...
                  {
                    collect000.rest = Cons.cons(((i == Stella.$PRETTY_PRINT_LIST_CUTOFF$) ? Stella.ELLIPSIS : item), Stella.NIL);
          ...
          { Cons conslist = Stella.NIL;
            ...
            { Stella_Object item = null;
              ...
              for (;iter002.nextP() &&
                ...
                if (collect001 == null) {
                  {
                    collect001 = Cons.cons(((i == Stella.$PRETTY_PRINT_LIST_CUTOFF$) ? Stella.ELLIPSIS : item), Stella.NIL);
                    if (conslist == Stella.NIL) {
                      conslist = collect001;
                    }
                    else {
                  ...
                  {
                    collect001.rest = Cons.cons(((i == Stella.$PRETTY_PRINT_LIST_CUTOFF$) ? Stella.ELLIPSIS : item), Stella.NIL);
  ...
  public static SystemDefinition defineSystem(Stella_Object name, Cons options) {
    { String stringname = null;
      ...
      { SystemDefinition self000 = SystemDefinition.newSystemDefinition();
        ...
        self000.definitionFile = ((String)(Stella.$CURRENTLOADFILE$.get()));
                        ...
                        if (testValue001 == Stella.KWD_DIRECTORY) {
                          ...
                          { Stella_Object sys = null;
                            ...
                            for (;!(iter002 == Stella.NIL); iter002 = iter002.rest) {
                              sys = iter002.value;
                              Stella.getSystemDefinition(((StringWrapper)(sys)).wrapperValue, true);
                              if (!Stella.systemLoadedOrStartedUpP(((StringWrapper)(sys)).wrapperValue)) {
                                { PropertyList currentoptions = (((((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())) != null) ? ((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())) : PropertyList.newPropertyList())).copy();
                                  Stella_Object currentaction = currentoptions.lookupWithDefault(Stella.KWD_ACTION, Stella.KWD_LOAD_SYSTEM);
                                  Stella_Object currentlanguage = currentoptions.lookupWithDefault(Stella.KWD_LANGUAGE, Stella.runningInLanguage());

                                  currentoptions.insertAt(Stella.KWD_ACTION, currentaction);
                                  currentoptions.insertAt(Stella.KWD_LANGUAGE, currentlanguage);
                                  if (((GeneralizedSymbol)(currentaction)) == Stella.KWD_MAKE_SYSTEM) {
                                    Stella.STANDARD_OUTPUT.nativeStream.println("Making required system `" + StringWrapper.unwrapString(((StringWrapper)(sys))) + "'");
                                    Stella.makeSystem(((StringWrapper)(sys)).wrapperValue, Cons.cons(Stella.KWD_OPTIONS, Cons.cons(currentoptions, Stella.NIL)));
                                  }
                                  else {
                                    Stella.STANDARD_OUTPUT.nativeStream.println("Loading required system `" + StringWrapper.unwrapString(((StringWrapper)(sys))) + "'");
                                    Stella.loadSystem(((StringWrapper)(sys)).wrapperValue, Cons.cons(Stella.KWD_OPTIONS, Cons.cons(currentoptions, Stella.NIL)));
                                  }
                                }
                              }
                            }
                          ...
                          if (!(Stella_Object.runOptionHandlerP(system, ((Keyword)(key)), value))) {
                            { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
                              ...
                              try {
                                ...
                                if (!(Stella.suppressWarningsP())) {
                                  Stella.printErrorContext(">> WARNING: ", Stella.STANDARD_WARNING);
                                  {
                                    ...
                                    Stella.STANDARD_WARNING.nativeStream.println(" Skipping invalid system option `" + Stella_Object.deUglifyParseTree(key) + "' in the definition of system `" + Stella_Object.deUglifyParseTree(StringWrapper.wrapString(stringname)) + "'.");
                                  }
;
                                }
                  ...
                  SystemDefinition.computeSystemRootDirectories(system);
  ...
  public static PropertyList parseOptions(Stella_Object options, Cons legaloptionsAtypes, boolean coercionerrorP, boolean allowotherkeysP) {
    { PropertyList self000 = PropertyList.newPropertyList();
      ...
      { PropertyList legaloptions = self000;
        ...
        Stella_Object passedoptions = null;
        Surrogate type = null;
        ...
        passedoptions = parsedoptions.lookup(Stella.KWD_OPTIONS);
        if (passedoptions != null) {
          return (Stella_Object.parseOptions(passedoptions, legaloptionsAtypes, coercionerrorP, allowotherkeysP));
        }
...
;
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(value);
      ...
      if (Surrogate.subtypeOfSymbolP(testValue000)) {
        ...
        { StringWrapper value000 = ((StringWrapper)(value));
          ...
          if (Stella.stringEqualP(value000.wrapperValue, "TRUE")) {
            return (Stella.TRUE_WRAPPER);
          }
          else if (Stella.stringEqualP(value000.wrapperValue, "FALSE")) {
            return (Stella.FALSE_WRAPPER);
          }
        }
      }
  ...
  /** Lookup the value of <code>property</code> for the logical host <code>host</code>.
   * @param host
   * @param property
   * @return Stella_Object
   */
  public static Stella_Object getLogicalHostProperty(Stella_Object host, Stella_Object property) {
    return (Stella.lookupLogicalHostProperty(Stella_Object.coerceValueToString(host, true), ((Keyword)(Stella_Object.coerceValueToType(property, Stella.SGT_STELLA_KEYWORD, true)))));
  }
  ...
  public static Stella_Object withSystemDefinition(Stella_Object systemnameexpression, Cons body) {
    return (Cons.list$(Cons.cons(Stella.SYM_STELLA_SPECIAL, Cons.cons(Cons.list$(Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_$CURRENTSYSTEMDEFINITION$, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_GET_SYSTEM_DEFINITION, Cons.cons(systemnameexpression, Cons.cons(Cons.cons(Stella.SYM_STELLA_TRUE, Stella.NIL), Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_DIRECTORY, Cons.cons(Stella.SYM_STELLA_$CURRENTSYSTEMDEFINITION$, Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Cons.cons(Stella.SYM_STELLA_PROGN, body.concatenate(Stella.NIL, Stella.NIL)), Cons.cons(Stella.NIL, Stella.NIL))))));
  }
...
;
  ...
  public static Stella_Object copyTokenText(Stella_Object buffer, Cons options) {
      ...
      { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
        ...
        try {
          ...
          if (!(Stella.suppressWarningsP())) {
            ...
            {
              Stella.STANDARD_ERROR.nativeStream.println();
              Stella.STANDARD_ERROR.nativeStream.println(" Encountered `copy-token-text' outside of `with-tokenizer' macro..");
            }
;
          }
      ...
      { Cons tree000 = ((Cons)(tree));
        ...
        { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree000.value));
          ...
          if (testValue000 == Stella.SYM_STELLA_VOID_SYS) {
            ...
            return (Cons.clTranslateCallSuperMethodTree(tree000));
          }
          else if (testValue000 == Stella.SYM_STELLA_PROGN) {
          ...
          if (Surrogate.subtypeOfSymbolP(testValue000)) {
            { Symbol tree000 = ((Symbol)(tree));
              ...
              if (tree000 == Stella.SYM_STELLA_NULL) {
                ...
                { GlobalVariable global = tree000.lookupGlobalVariable();

                  if (global != null) {
                    { Stella_Object _return_temp = GlobalVariable.readGlobalVariableValue(global);

                      MV_returnarray[0] = ((StandardObject)(KeyValueList.dynamicSlotValue(global.dynamicSlots, Stella.SYM_STELLA_VARIABLE_TYPE_SPECIFIER, null)));
                      return (_return_temp);
                    }
                  }
                  else {
...
;
                      ...
                      stream000.nativeStream.println("':");
                      stream000.nativeStream.print("Undefined variable: `" + tree000 + "'");
                      throw ((EvaluationException)(EvaluationException.newEvaluationException(stream000.theStringReader()).fillInStackTrace()));
                    }
                  }
                }
...
;
          ...
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(tree000.value));
            ...
            else if (testValue000 == Stella.SYM_STELLA_CALL_SUPER_METHOD) {
              return (Cons.walkCallSuperMethodTree(tree000, MV_returnarray));
            }
