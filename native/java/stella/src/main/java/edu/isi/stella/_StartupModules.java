...
public class _StartupModules {
  ...
  static void helpStartupModules2() {
    {
      Stella.defineMethodObject("(DEFMETHOD (PARENT-CONTEXTS (ITERATOR OF CONTEXT)) ((SELF CONTEXT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Context", "parentContexts", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (PARENT-CONTEXTS (ITERATOR OF CONTEXT)) ((SELF MODULE)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Module", "parentContexts", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (PARENT-CONTEXTS (ITERATOR OF CONTEXT)) ((SELF WORLD)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.World", "parentContexts", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (CHANGE-CONTEXT CONTEXT) ((CONTEXT CONTEXT)) :DOCUMENTATION \"Change the current context to be the context\n'context'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Context", "changeContext", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CHANGE-CONTEXT CONTEXT) ((CONTEXTNAME STRING)) :DOCUMENTATION \"Change the current context to be the context named\n'contextName'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_changeContext", new java.lang.Class [] {Native.find_java_class("java.lang.String")})), null);
      Stella.defineMethodObject("(DEFMETHOD (CHANGE-MODULE MODULE) ((MODULE MODULE)) :DOCUMENTATION \"Change the current module to be the module\n'module'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Module", "changeModule", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CHANGE-MODULE MODULE) ((MODULENAME STRING)) :DOCUMENTATION \"Change the current module to be the module named\n'moduleName'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_changeModule", new java.lang.Class [] {Native.find_java_class("java.lang.String")})), null);
      Stella.defineMethodObject("(DEFMETHOD (MULTIPLE-PARENTS? BOOLEAN) ((SELF CONTEXT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Context", "multipleParentsP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (MULTIPLE-PARENTS? BOOLEAN) ((MODULE MODULE)) :DOCUMENTATION \"Return TRUE if 'module' has more than one parent.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Module", "multipleParentsP", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD INHERIT-SUPERCONTEXTS ((CONTEXT CONTEXT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Context", "inheritSupercontexts", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD INHERIT-SUPERCONTEXTS ((WORLD WORLD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.World", "inheritSupercontexts", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD INHERIT-SUPERCONTEXTS ((MODULE MODULE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Module", "inheritSupercontexts", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD UNINHERIT-SUPERCONTEXTS ((CONTEXT CONTEXT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Context", "uninheritSupercontexts", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD UNFINALIZE-MODULE ((SELF MODULE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Module", "unfinalizeModule", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD UNFINALIZE-WORLD ((SELF WORLD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.World", "unfinalizeWorld", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD DESTROY-CONTEXT ((SELF MODULE)) :DOCUMENTATION \"Destroy the context 'self', and recursively destroy\nall contexts that inherit 'self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Module", "destroyContext", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD DESTROY-CONTEXT ((SELF WORLD)) :DOCUMENTATION \"Destroy the context 'self', and recursively destroy\nall contexts that inherit 'self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.World", "destroyContext", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD DESTROY-CONTEXT ((SELF STRING)) :DOCUMENTATION \"Destroy the context 'self', and recursively destroy\nall contexts that inherit 'self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_destroyContext", new java.lang.Class [] {Native.find_java_class("java.lang.String")})), null);
      Stella.defineMethodObject("(DEFMETHOD DESTROY-CONTEXT ((SELF CONTEXT)) :PUBLIC? TRUE :DOCUMENTATION \"Make the translator happy.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Context", "destroyContext", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (MULTIPLE-PARENTS? BOOLEAN) ((WORLD WORLD)) :DOCUMENTATION \"Return FALSE always, since worlds never have more than one parent.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.World", "multipleParentsP", new java.lang.Class [] {})), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SUBCONTEXT-REVISION-POLICY* KEYWORD :CLEAR :DOCUMENTATION \"Controls actions reflexive transitive closure of\n   subcontexts when a context is revised.\n   Values are ':destroy' -- destroy subcontexts;\n   ':clear' -- clear contents of subcontexts;\n   ':preserve' -- don't disturb subcontexts.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *SHADOWEDSURROGATES* (CONS OF SYMBOL) NULL :DOCUMENTATION \"Holds list of symbols representing surrogates\nto be shadowed during module finalization.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DEFINE-MODULE-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST called by 'define-module', applied to a\n'module' argument.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MODULE-NON-STRUCTURAL-OPTIONS* (CONS OF KEYWORD) (BQUOTE (:DOCUMENTATION)) :PUBLIC? FALSE :DOCUMENTATION \"List of non-structural options for Module definitions.\nUsed in testing for module changes and in updating non-structurally changed\nmodules.\")", null);
