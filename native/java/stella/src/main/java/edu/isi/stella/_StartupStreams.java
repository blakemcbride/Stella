  ...
  static void helpStartupStreams1() {
    {
      ...
      Stella.KWD_CREATE_PATH = ((Keyword)(GeneralizedSymbol.internRigidSymbolWrtModule("CREATE-PATH", null, 2)));
  ...
  static void helpStartupStreams4() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (THE-STRING-READER STRING) ((SELF OUTPUT-STRING-STREAM)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.OutputStringStream", "theStringReader", new java.lang.Class [] {})), null);
      ...
      Stella.defineFunctionObject("CLEAR-INPUT", "(DEFUN CLEAR-INPUT ((SELF INPUT-STREAM)) :DOCUMENTATION \"Clear all buffered raw and tokenized input of `self'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.InputStream", "clearInput", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.InputStream")}), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (STREAM-POSITION LONG-INTEGER) ((SELF FILE-INPUT-STREAM)) :DOCUMENTATION \"Return the current position of the file input cursor in `self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.InputFileStream", "streamPosition", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (STREAM-POSITION-SETTER LONG-INTEGER) ((SELF FILE-INPUT-STREAM) (NEWPOS LONG-INTEGER)) :DOCUMENTATION \"Set the current position of the file input cursor in `self' to `newpos'.\nIf `self' has any tokenizer state associated with it, this will also reset\nto the start state of the tokenizer table; otherwise, behavior would be\nunpredictable unless the character class of the new position is exactly the\nsame as the one following the most recent token.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.InputFileStream", "streamPositionSetter", new java.lang.Class [] {java.lang.Long.TYPE})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (STREAM-POSITION LONG-INTEGER) ((SELF FILE-OUTPUT-STREAM)) :DOCUMENTATION \"Return the current position of the file input cursor in `self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.OutputFileStream", "streamPosition", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (STREAM-POSITION-SETTER LONG-INTEGER) ((SELF FILE-OUTPUT-STREAM) (NEWPOS LONG-INTEGER)) :DOCUMENTATION \"Set the current position of the file input cursor in `self' to `newpos'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.OutputFileStream", "streamPositionSetter", new java.lang.Class [] {java.lang.Long.TYPE})), null);
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(5)) {
          ...
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("S-EXPRESSION-ITERATOR", "(DEFCLASS S-EXPRESSION-ITERATOR (STREAM-ITERATOR) :PUBLIC? TRUE :DOCUMENTATION \"Iterator that yields s-expressions from an input stream.\" :PARAMETERS ((ANY-VALUE :TYPE OBJECT)))");
            ...
            renamed_Class.classSlotAccessorCode = Native.find_java_method("edu.isi.stella.SExpressionIterator", "accessSExpressionIteratorSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.SExpressionIterator"), Native.find_java_class("edu.isi.stella.Symbol"), Native.find_java_class("edu.isi.stella.Stella_Object"), java.lang.Boolean.TYPE});
          }
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("LINE-ITERATOR", "(DEFCLASS LINE-ITERATOR (STREAM-ITERATOR) :PUBLIC? TRUE :DOCUMENTATION \"Iterator that yields lines with any line terminator sequence from an input stream.\" :PARAMETERS ((ANY-VALUE :TYPE STRING)))");
            ...
            renamed_Class.classSlotAccessorCode = Native.find_java_method("edu.isi.stella.LineIterator", "accessLineIteratorSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.LineIterator"), Native.find_java_class("edu.isi.stella.Symbol"), Native.find_java_class("edu.isi.stella.Stella_Object"), java.lang.Boolean.TYPE});
          }
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("NATIVE-LINE-ITERATOR", "(DEFCLASS NATIVE-LINE-ITERATOR (STREAM-ITERATOR) :PUBLIC? TRUE :DOCUMENTATION \"Iterator that yields lines from an input stream.\" :PARAMETERS ((ANY-VALUE :TYPE STRING)))");
            ...
            renamed_Class.classSlotAccessorCode = Native.find_java_method("edu.isi.stella.NativeLineIterator", "accessNativeLineIteratorSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.NativeLineIterator"), Native.find_java_class("edu.isi.stella.Symbol"), Native.find_java_class("edu.isi.stella.Stella_Object"), java.lang.Boolean.TYPE});
          }
          { Stella_Class renamed_Class = Stella.defineClassFromStringifiedSource("CHARACTER-ITERATOR", "(DEFCLASS CHARACTER-ITERATOR (STREAM-ITERATOR) :PUBLIC? TRUE :DOCUMENTATION \"Iterator that yields characters from an input stream.\" :PARAMETERS ((ANY-VALUE :TYPE CHARACTER)))");
            ...
            renamed_Class.classSlotAccessorCode = Native.find_java_method("edu.isi.stella.CharacterIterator", "accessCharacterIteratorSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.CharacterIterator"), Native.find_java_class("edu.isi.stella.Symbol"), Native.find_java_class("edu.isi.stella.Stella_Object"), java.lang.Boolean.TYPE});
          }
        }
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF S-EXPRESSION-ITERATOR)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.SExpressionIterator", "nextP", new java.lang.Class [] {})), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF NATIVE-LINE-ITERATOR)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.NativeLineIterator", "nextP", new java.lang.Class [] {})), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF LINE-ITERATOR)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.LineIterator", "nextP", new java.lang.Class [] {})), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF CHARACTER-ITERATOR)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.CharacterIterator", "nextP", new java.lang.Class [] {})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL EOL SYMBOL (QUOTE EOL) :DOCUMENTATION \"Generates a newline character when passed to a stream.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL EOL-STRING STRING \"\n\" :DOCUMENTATION \"A string constant containing the character sequence\nnecessary to generate a newline.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL STELLA-CHARSET NATIVE-CHARSET-ENCODING (VERBATIM :JAVA \"java.nio.charset.Charset.forName(\\\"ISO-8859-1\\\")\" :COMMON-LISP \"(CL:or #+allegro (CL:ignore-errors (excl::find-external-format :iso-8859-1))\n                                 #+cmu :iso-8859-1\n                                 :DEFAULT)\" :OTHERWISE NULL) :DOCUMENTATION \"For STELLA we always assume an 8-bit transparent mapping from bytes to STRING characters\nsuch as ISO-8859-1 (ISO-LATIN-1), since that's what C++ natively supports.  For Java and some Lisps, we have\nto do some extra work to enforce this encoding when creating streams.  This is just a first iteration towards\nthis handling this, for example, in Lisp we'd also have to configure compile and load streams to properly encode\nstring constants that contain non-ASCII characters.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL STANDARD-INPUT INPUT-STREAM NULL :DOCUMENTATION \"Denotes the standard input stream for the host language.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL STANDARD-OUTPUT OUTPUT-STREAM (VERBATIM :OTHERWISE (MAKE-EARLY-OUTPUT-STREAM (VERBATIM :COMMON-LISP CL:*STANDARD-OUTPUT* :CPP \"&std::cout\" :JAVA \"#$(STELLAROOT).javalib.NativeOutputStream.create(java.lang.System.out)\"))) :DOCUMENTATION \"Denotes the standard output stream for the host language.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL STANDARD-WARNING OUTPUT-STREAM (VERBATIM :OTHERWISE (MAKE-EARLY-OUTPUT-STREAM (VERBATIM :COMMON-LISP CL:*ERROR-OUTPUT* :CPP \"&std::cerr\" :JAVA \"#$(STELLAROOT).javalib.NativeOutputStream.create(java.lang.System.err)\"))) :DOCUMENTATION \"Denotes the standard warning stream for the host language.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL STANDARD-ERROR OUTPUT-STREAM (VERBATIM :OTHERWISE (MAKE-EARLY-OUTPUT-STREAM (VERBATIM :COMMON-LISP CL:*ERROR-OUTPUT* :CPP \"&std::cerr\" :JAVA \"#$(STELLAROOT).javalib.NativeOutputStream.create(java.lang.System.err)\"))) :DOCUMENTATION \"Denotes the standard error stream for the host language.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *IGNORETRANSLATIONERRORS?* BOOLEAN TRUE :DOCUMENTATION \"If `true' all passes of a translation will always be performed\nregardless of whether any errors were encountered.  Otherwise, translation\nends with the first pass that encountered an error.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL SINGLE-QUOTE-STRING STRING-WRAPPER (WRAP-LITERAL \"'\") :DOCUMENTATION \"Holds a string containing the single quote character.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL SINGLE-BQUOTE-STRING STRING-WRAPPER (WRAP-LITERAL \"`\") :DOCUMENTATION \"Holds a string containing the single backquote character.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *OPEN-FILE-STREAMS* (LIST OF STREAM) (NEW (LIST OF STREAM)) :DOCUMENTATION \"List of file streams that are currently open.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *HTML-QUOTED-CHARACTERS* STRING \"><&\\\"\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *HTML-ESCAPE-TABLE* KEY-VALUE-LIST (NEW KEY-VALUE-LIST))", null);
          ...
          Stella.$HTML_ESCAPE_TABLE$.insertAt(StringWrapper.wrapString("NBSP"), CharacterWrapper.wrapCharacter(' '));
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOGGING-REGISTRY* (KEY-VALUE-LIST OF STRING-WRAPPER (PROPERTY-LIST OF KEYWORD OBJECT)) (NEW KEY-VALUE-LIST))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOGGING-LOCAL-TIME-ZONE* FLOAT (GET-LOCAL-TIME-ZONE))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOG-INDENT-LEVEL* INTEGER 0 :DOCUMENTATION \"The number of spaces to print before the content of a log message.\" :PUBLIC? TRUE)", null);
        }
