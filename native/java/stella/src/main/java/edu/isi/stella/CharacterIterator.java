...
public class CharacterIterator extends StreamIterator {
  ...
  public static Stella_Object accessCharacterIteratorSlotValue(CharacterIterator self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Stella.SYM_STELLA_VALUE) {
      if (setvalueP) {
        self.value = ((CharacterWrapper)(value)).wrapperValue;
      }
      else {
        value = CharacterWrapper.wrapCharacter(self.value);
      }
    }
    else {
