    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(2)) {
          Stella.SYM_STELLA_SYSTEM_GROUP_NAME = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("SYSTEM-GROUP-NAME", null, 0)));
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          ...
          Stella.$JAVA_BUILD_METHOD$ = Stella.KWD_MAVEN;
        }
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD (JAVA-MAKE-CODE-OUTPUT-FILE-NAME FILE-NAME) ((BAREFILE FILE-NAME) (DONTTRUNCATE? BOOLEAN)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_javaMakeCodeOutputFileName", new java.lang.Class [] {Native.find_java_class("java.lang.String"), java.lang.Boolean.TYPE})), null);
          Stella.defineMethodObject("(DEFMETHOD (JAVA-MAKE-CODE-OUTPUT-FILE-NAME FILE-NAME) ((SOURCE CLASS) (DONTTRUNCATE? BOOLEAN)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "javaMakeCodeOutputFileName", new java.lang.Class [] {java.lang.Boolean.TYPE})), null);
          ...
          Stella.defineFunctionObject("JAVA-OUTPUT-SYSTEM-SPECIFIC-FILES", "(DEFUN JAVA-OUTPUT-SYSTEM-SPECIFIC-FILES ())", Native.find_java_method("edu.isi.stella.Stella", "javaOutputSystemSpecificFiles", new java.lang.Class [] {}), null);
          ...
          Stella.defineFunctionObject("JAVA-GET-SYSTEM-MAVEN-TEMPLATE-FILE", "(DEFUN (JAVA-GET-SYSTEM-MAVEN-TEMPLATE-FILE FILE-NAME) ())", Native.find_java_method("edu.isi.stella.Stella", "javaGetSystemMavenTemplateFile", new java.lang.Class [] {}), null);
          Stella.defineFunctionObject("JAVA-GET-SYSTEM-PARENT-MAVEN-TEMPLATE-FILE", "(DEFUN (JAVA-GET-SYSTEM-PARENT-MAVEN-TEMPLATE-FILE FILE-NAME) ())", Native.find_java_method("edu.isi.stella.Stella", "javaGetSystemParentMavenTemplateFile", new java.lang.Class [] {}), null);
          Stella.defineExternalSlotFromStringifiedSource("(DEFSLOT SYSTEM-DEFINITION SYSTEM-GROUP-NAME :TYPE STRING :DEFAULT \"edu.isi.loom.stella\" :OPTION-KEYWORD :GROUP-NAME :DOCUMENTATION \"Used as the Maven groupId for this system.\" :ALLOCATION :DYNAMIC)");
          Stella.defineFunctionObject("JAVA-YIELD-SYSTEM-GROUP-NAME", "(DEFUN (JAVA-YIELD-SYSTEM-GROUP-NAME STRING) ((SYSTEM SYSTEM-DEFINITION)))", Native.find_java_method("edu.isi.stella.SystemDefinition", "javaYieldSystemGroupName", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.SystemDefinition")}), null);
          Stella.defineFunctionObject("JAVA-YIELD-SYSTEM-VERSION", "(DEFUN (JAVA-YIELD-SYSTEM-VERSION STRING) ((SYSTEM SYSTEM-DEFINITION)))", Native.find_java_method("edu.isi.stella.SystemDefinition", "javaYieldSystemVersion", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.SystemDefinition")}), null);
          Stella.defineFunctionObject("JAVA-YIELD-SYSTEM-PARENT-NAME", "(DEFUN (JAVA-YIELD-SYSTEM-PARENT-NAME STRING) ((SYSTEM SYSTEM-DEFINITION)))", Native.find_java_method("edu.isi.stella.SystemDefinition", "javaYieldSystemParentName", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.SystemDefinition")}), null);
          Stella.defineFunctionObject("SUBSTITUTE-TEMPLATE-VARIABLES-TO-MAVEN-FILE", "(DEFUN SUBSTITUTE-TEMPLATE-VARIABLES-TO-MAVEN-FILE ((TEMPLATEFILE STRING) (OUTPUTFILE STRING) (VARIABLES (KEY-VALUE-LIST OF STRING-WRAPPER STRING-WRAPPER))))", Native.find_java_method("edu.isi.stella.Stella", "substituteTemplateVariablesToMavenFile", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("java.lang.String"), Native.find_java_class("edu.isi.stella.KeyValueList")}), null);
          Stella.defineFunctionObject("JAVA-OUTPUT-SYSTEM-MAVEN-FILES", "(DEFUN JAVA-OUTPUT-SYSTEM-MAVEN-FILES ())", Native.find_java_method("edu.isi.stella.Stella", "javaOutputSystemMavenFiles", new java.lang.Class [] {}), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CURRENT-JAVA-OUTPUT-CLASS* CLASS NULL :PUBLIC? FALSE :DOCUMENTATION \"Holds the current Stella class being output in Java\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *JAVA-BUILD-METHOD* KEYWORD :MAVEN :DOCUMENTATION \"Indicates how JAVA translations of STELLA systems will be compiled and built.\nControls the native java directory structure as well as generation of build files such as pom.xml.\nCurrently supported methods are :JAVAC (the original) and :MAVEN.\" :DEMON-PROPERTY \"stella.javaBuildMethod\" :PUBLIC? TRUE)", null);
        }
