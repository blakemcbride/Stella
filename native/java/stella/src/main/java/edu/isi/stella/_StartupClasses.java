...
public class _StartupClasses {
  ...
  static void helpStartupClasses2() {
    {
      ...
      Stella.defineFunctionObject("CLASS-SURROGATE", "(DEFUN (CLASS-SURROGATE SURROGATE) ((CLASS CLASS)) :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella_Class", "classSurrogate", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Class")}), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (PRIMARY-CLASS CLASS) ((SELF OBJECT)) :PUBLIC? TRUE :C-CALLABLE? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Object", "primaryClass", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (LOOKUP-CLASS CLASS) ((NAME STRING)) :DOCUMENTATION \"Return a class with name `name'.  Scan all\nvisible surrogates looking for one that has a class defined for it.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_lookupClass", new java.lang.Class [] {Native.find_java_class("java.lang.String")})), null);
      Stella.defineMethodObject("(DEFMETHOD (LOOKUP-CLASS CLASS) ((NAME SYMBOL)) :DOCUMENTATION \"Return a class with name `name'.  Scan all\nvisible surrogates looking for one that has a class defined for it.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Symbol", "lookupClass", new java.lang.Class [] {})), null);
      Stella.defineFunctionObject("LOOKUP-CLASS-BY-QUALIFIED-NAME", "(DEFUN (LOOKUP-CLASS-BY-QUALIFIED-NAME CLASS) ((QUALIFIEDNAME STRING)) :DOCUMENTATION \"Variant of `string.lookup-class' that can specify a\nstarting module through a `qualifiedName'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "lookupClassByQualifiedName", new java.lang.Class [] {Native.find_java_class("java.lang.String")}), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (GET-STELLA-CLASS CLASS) ((CLASS-NAME TYPE) (ERROR? BOOLEAN)) :DOCUMENTATION \"Return a class with name `class-name'.  If none exists, break\nif `error?', else return `null'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Surrogate", "getStellaClass", new java.lang.Class [] {java.lang.Boolean.TYPE})), null);
      Stella.defineMethodObject("(DEFMETHOD (GET-STELLA-CLASS CLASS) ((CLASS-NAME STRING) (ERROR? BOOLEAN)) :DOCUMENTATION \"Return a class with name `class-name'.  If none exists, break\nif `error?', else return `null'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_getStellaClass", new java.lang.Class [] {Native.find_java_class("java.lang.String"), java.lang.Boolean.TYPE})), null);
      Stella.defineMethodObject("(DEFMETHOD (GET-STELLA-CLASS CLASS) ((CLASS-NAME SYMBOL) (ERROR? BOOLEAN)) :DOCUMENTATION \"Return a class with name `class-name'.  If non exists, break\nif `error?', else return `null'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Symbol", "getStellaClass", new java.lang.Class [] {java.lang.Boolean.TYPE})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD UNBIND-FROM-SURROGATE ((SELF CLASS)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "unbindFromSurrogate", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD FREE ((SELF OBJECT)) :DOCUMENTATION \"Default method.  Deallocate storage for `self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Object", "free", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD FREE ((SELF ACTIVE-OBJECT)) :DOCUMENTATION \"Remove all pointers between `self' and other objects,\nand then deallocate the storage for self.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.ActiveObject", "free", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD DESTROY-CLASS ((SELF CLASS)) :DOCUMENTATION \"Destroy the Stella class `self'.  \nUnfinalize its subclasses (if it has any).\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "destroyClass", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD DESTROY-CLASS ((SELF TYPE)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Surrogate", "destroyClass", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (PRIMITIVE? BOOLEAN) ((SELF RELATION)) :DOCUMENTATION \"Return `true' if `self' is not a defined relation.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Relation", "primitiveP", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD FINALIZE-SLOT-TYPE-COMPUTATIONS ((SELF SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Slot", "finalizeSlotTypeComputations", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD FINALIZE-SLOT-TYPE-COMPUTATIONS ((SELF STORAGE-SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "finalizeSlotTypeComputations", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD HELP-FINALIZE-LOCAL-SLOT ((SELF SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Slot", "helpFinalizeLocalSlot", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD HELP-FINALIZE-LOCAL-SLOT ((SELF STORAGE-SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "helpFinalizeLocalSlot", new java.lang.Class [] {})), null);
  ...
  static void helpStartupClasses3() {
    {
      Stella.defineMethodObject("(DEFMETHOD UNFINALIZE-LOCAL-SLOT ((SELF SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Slot", "unfinalizeLocalSlot", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD UNFINALIZE-LOCAL-SLOT ((SELF STORAGE-SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "unfinalizeLocalSlot", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (MULTIPLE-PARENTS? BOOLEAN) ((CLASS CLASS)) :DOCUMENTATION \"Return `true' if `class' has more than one direct superclass.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "multipleParentsP", new java.lang.Class [] {})), null);
      ...
      Stella.defineFunctionObject("LOOKUP-SLOT-AND-CLASS-BY-QUALIFIED-NAME", "(DEFUN (LOOKUP-SLOT-AND-CLASS-BY-QUALIFIED-NAME SLOT CLASS) ((QUALIFIEDNAME STRING)) :DOCUMENTATION \"Lookup a slot via dotted notation with a possibly qualified class name.\nExamples: \\\"cons.first\\\" or \\\"stella/cons.first\\\".  This is a variant of `string-to-slot'\nin describe.ste that actually obeys the class module if it is given.  This also returns\nthe specified class as a second value which might differ from the slot's owner class.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "lookupSlotAndClassByQualifiedName", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("[Ljava.lang.Object;")}), null);
      Stella.defineFunctionObject("LOOKUP-SLOT-BY-QUALIFIED-NAME", "(DEFUN (LOOKUP-SLOT-BY-QUALIFIED-NAME SLOT) ((QUALIFIEDNAME STRING)) :DOCUMENTATION \"Lookup a slot via dotted notation with a possibly qualified class name.\nExamples: \\\"cons.first\\\" or \\\"stella/cons.first\\\".  This is a variant of `string-to-slot'\nin describe.ste that actually obeys the class module if it is given.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.Stella", "lookupSlotByQualifiedName", new java.lang.Class [] {Native.find_java_class("java.lang.String")}), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (CONFORMING-SIGNATURES? BOOLEAN) ((SELF SLOT) (SUPERSLOT SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Slot", "conformingSignaturesP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Slot")})), null);
      Stella.defineMethodObject("(DEFMETHOD (CONFORMING-SIGNATURES? BOOLEAN) ((SELF STORAGE-SLOT) (SUPERSLOT SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "conformingSignaturesP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Slot")})), null);
      Stella.defineMethodObject("(DEFMETHOD (CONFORMING-SIGNATURES? BOOLEAN) ((SELF METHOD-SLOT) (SUPERSLOT SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.MethodSlot", "conformingSignaturesP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Slot")})), null);
      Stella.defineMethodObject("(DEFMETHOD (CONFORMING-SIGNATURES? BOOLEAN) ((SELF TABLE) (SUPERSLOT SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Table", "conformingSignaturesP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Slot")})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (DYNAMIC-STORAGE? BOOLEAN) ((SELF STORAGE-SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "dynamicStorageP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (PRIVATE? BOOLEAN) ((SELF RELATION)) :DOCUMENTATION \"Return `true' if `self' is not public.\" :PUBLIC? TRUE :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Relation", "privateP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (PUBLIC? BOOLEAN) ((SELF SLOT)) :DOCUMENTATION \"True if `self' or one it its ancestors is marked public.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Slot", "publicP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (PUBLIC-SLOTS (ITERATOR OF SLOT)) ((SELF CLASS)) :DOCUMENTATION \"Return an iterator over public slots of `self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "publicSlots", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (PUBLIC-SLOTS (ITERATOR OF SLOT)) ((SELF OBJECT)) :DOCUMENTATION \"Return an iterator over public slots of `self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Object", "publicSlots", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (ALL-CLASS-SLOTS (ITERATOR OF SLOT)) ((SELF CLASS)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "allClassSlots", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF ALL-CLASS-SLOTS-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.AllClassSlotsIterator", "nextP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CLASS-SLOTS (ITERATOR OF SLOT)) ((SELF CLASS)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "classSlots", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (LOCAL-SLOTS (LIST OF SLOT)) ((SELF CLASS)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "localSlots", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (DIRECT-SUPER-CLASSES (ITERATOR OF CLASS)) ((SELF CLASS)) :DOCUMENTATION \"Returns an iterator that generates all direct super classes of `self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "directSuperClasses", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (SUPER-CLASSES (ITERATOR OF CLASS)) ((SELF CLASS)) :DOCUMENTATION \"Returns an iterator that generates all proper super classes of `self'.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Class", "superClasses", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (ACTIVE? BOOLEAN) ((SLOT SLOT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Slot", "activeP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (INITIAL-VALUE OBJECT) ((SELF STORAGE-SLOT)) :DOCUMENTATION \"Return an initial value for `self', or `null'.  The\ninitial value can be defined by the slot itself, inherited from an\nequivalent slot, or inherit from the :initial-value option for the \nclass representing the type of `self'.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "initialValue", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (SYSTEM-DEFAULT-VALUE OBJECT) ((SELF SLOT)) :DOCUMENTATION \"Return a default value expression, or if `self'\nhas dynamic storage, an initial value expression.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Slot", "systemDefaultValue", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (SYSTEM-DEFAULT-VALUE OBJECT) ((SELF STORAGE-SLOT)) :DOCUMENTATION \"Return a default value expression, or if `self'\nhas dynamic storage, an initial value expression.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "systemDefaultValue", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (INITIALLY OBJECT) ((SELF STORAGE-SLOT)) :DOCUMENTATION \"Defines the value of a slot before it has been assigned\na value.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StorageSlot", "initially", new java.lang.Class [] {})), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *WARNIFREDEFINE?* BOOLEAN TRUE :DOCUMENTATION \"If set, warn about each redefinition.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *UNFINALIZED-CLASSES* (LIST OF CLASS) (NEW LIST) :DOCUMENTATION \"List of classes whose class or slot inheritance is\ncurrently unfinalized.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NEWLY-UNFINALIZED-CLASSES?* BOOLEAN FALSE :DOCUMENTATION \"Set to `true' by `remember-unfinalized-class'; set\nto `false' by `cleanup-unfinalized-classes'.  Minimizes the time that\n`finalize-classes' spends searching for classes to finalize.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CLASSES-WITH-UNRESOLVED-CHILDREN-REFERENCES* (LIST OF CLASS) (NEW LIST) :DOCUMENTATION \"List of classes defined with a :children option\nwhich still have some of their children references unresolved.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SYMBOL-SLOT-OFFSET-COUNTER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SLOT-CACHE-SIZE* INTEGER 20)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CLASS-TAXONOMY-GRAPH* TAXONOMY-GRAPH (NEW TAXONOMY-GRAPH))", null);
        }
