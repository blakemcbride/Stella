...
;
  ...
  /** Dynamically determine the byte offset where the native value for <code>slot</code> starts in <code>self</code>.
   * This basically performs the function of the C++ macro <code>offsetof</code> but does it dynamically.  Of course, it
   * relies on a working <code>readSwriteSlotValue</code> mechanism and we currently primarily use this for the Python API.
   * This basically writes value changes of <code>slot</code> to determine a byte position where a change occurred and
   * then restores the original value (which can be NULL).  This handles all native OBJECT and LITERAL slots
   * but does not handle special slots such as <code>dynamicSlots</code> or hardwired slots or other non-standard types.
   * @param self
   * @param slot
   * @return int
   */
  public static int cppFindNativeSlotValueOffset(StandardObject self, StorageSlot slot) {
    {
      {
        self = self;
        slot = slot;
  ...
  /** Clear or remove <code>value</code> for the slot <code>slot</code> on <code>self</code>.
  ...
  public static void dropSlotValue(StandardObject self, StorageSlot slot, Stella_Object value) {
    if (slot.collectionValuedP()) {
      { Collection oldvalues = ((Collection)(StandardObject.readSlotValue(self, slot)));
  ...
  /** Set or insert <code>value</code> for the slot <code>slot</code> on <code>self</code>.
   * CAUTION: Assumes that collection-valued slots are non-null.
   * @param self
   * @param slot
   * @param value
  ...
  /** Write a (possibly wrapped) <code>value</code> for the slot <code>slot</code> on <code>self</code>.
   * @param self
   * @param slot
   * @param value
   * @return Stella_Object
  ...
  public static Stella_Object writeSlotValue(StandardObject self, StorageSlot slot, Stella_Object value) {
    { java.lang.reflect.Method code = StorageSlot.getGenericSlotAccessor(slot, self.primaryClass(), true);

      if (code != null) {
        return (((Stella_Object)(edu.isi.stella.javalib.Native.funcall(code, null, new java.lang.Object [] {self, StorageSlot.canonicalSlotName(slot), value, new Boolean(true)}))));
      }
      else {
        return (null);
      }
  ...
  /** Read and return a (possibly wrapped) value for the slot <code>slot</code> on <code>self</code>.
   * @param self
   * @param slot
   * @return Stella_Object
   */
  public static Stella_Object readSlotValue(StandardObject self, StorageSlot slot) {
    { java.lang.reflect.Method code = StorageSlot.getGenericSlotAccessor(slot, self.primaryClass(), true);
      ...
      if (code != null) {
        return (((Stella_Object)(edu.isi.stella.javalib.Native.funcall(code, null, new java.lang.Object [] {self, StorageSlot.canonicalSlotName(slot), ((Stella_Object)(null)), new Boolean(false)}))));
      }
      else {
        return (null);
      }
