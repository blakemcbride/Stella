  ...
  static void helpStartupCppTranslate2() {
    {
      ...
      Stella.SYM_STELLA_CPP_GOTO_LABEL = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("CPP_GOTO_LABEL", null, 0)));
      ...
      Stella.SYM_STELLA_CPP_GOTO = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("CPP_GOTO", null, 0)));
  ...
  static void helpStartupCppTranslate4() {
    {
      ...
      Stella.defineFunctionObject("CPP-TRANSLATE-GLOBAL-VARIABLE-NAME", "(DEFUN (CPP-TRANSLATE-GLOBAL-VARIABLE-NAME STRING-WRAPPER) ((GLOBAL GLOBAL-VARIABLE)))", Native.find_java_method("edu.isi.stella.GlobalVariable", "cppTranslateGlobalVariableName", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.GlobalVariable")}), null);
      Stella.defineFunctionObject("CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS", "(DEFUN (CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS STRING-WRAPPER) ((GLOBAL GLOBAL-VARIABLE)))", Native.find_java_method("edu.isi.stella.GlobalVariable", "cppTranslateGlobalVariableAddress", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.GlobalVariable")}), null);
  ...
  static void helpStartupCppTranslate5() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (CPP-TRANSLATE-ATOMIC-TREE CONS) ((TREE OBJECT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Object", "cppTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CPP-TRANSLATE-ATOMIC-TREE CONS) ((TREE KEYWORD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Keyword", "cppTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CPP-TRANSLATE-ATOMIC-TREE CONS) ((TREE SURROGATE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Surrogate", "cppTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CPP-TRANSLATE-ATOMIC-TREE CONS) ((TREE SYMBOL)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Symbol", "cppTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CPP-TRANSLATE-ATOMIC-TREE CONS) ((TREE QUOTED-EXPRESSION)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.QuotedExpression", "cppTranslateAtomicTree", new java.lang.Class [] {})), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME?", "(DEFUN (CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME? BOOLEAN) ((FUNCTIONNAME SYMBOL)))", Native.find_java_method("edu.isi.stella.Symbol", "cppPossiblyOverloadedFunctionNameP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Symbol")}), null);
          ...
          Stella.defineFunctionObject("CPP-TRANSLATE-SUPER-METHOD-CALL", "(DEFUN (CPP-TRANSLATE-SUPER-METHOD-CALL CONS) ((TREE CONS)))", Native.find_java_method("edu.isi.stella.Cons", "cppTranslateSuperMethodCall", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
          ...
          Stella.defineFunctionObject("CPP-TRANSLATE-FUNCTION-SIGNATURE", "(DEFUN (CPP-TRANSLATE-FUNCTION-SIGNATURE CONS) ((FUNCTION METHOD-SLOT)))", Native.find_java_method("edu.isi.stella.MethodSlot", "cppTranslateFunctionSignature", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.MethodSlot")}), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-TRUE-STRING-WRAPPER* STRING-WRAPPER (WRAP-LITERAL \"TRUE\") :PUBLIC? FALSE :DOCUMENTATION \"Wrapped TRUE string, used to reduce consing.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-FALSE-STRING-WRAPPER* STRING-WRAPPER (WRAP-LITERAL \"FALSE\") :PUBLIC? FALSE :DOCUMENTATION \"Wrapped FALSE string, used to reduce consing.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *DUMMYDECLARATIONS* CONS NULL :DOCUMENTATION \"Temporary List of declarations for unused return parameters\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CURRENTDUMMYINDEX* INTEGER NULL-INTEGER :DOCUMENTATION \"Current index of dummy parameter for unused return value\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-OPERATOR-TABLE* KEY-VALUE-LIST (DICTIONARY @KEY-VALUE-LIST (QUOTE ++) (CONS (WRAP-LITERAL \"++\") NIL) (QUOTE --) (CONS (WRAP-LITERAL \"--\") NIL) (QUOTE +) (CONS (WRAP-LITERAL \"+\") NIL) (QUOTE -) (CONS (WRAP-LITERAL \"-\") NIL) (QUOTE *) (CONS (WRAP-LITERAL \"*\") NIL) (QUOTE /) (CONS (WRAP-LITERAL \"/\") NIL) (QUOTE EQ?) (CONS (WRAP-LITERAL \"==\") NIL) (QUOTE !=) (CONS (WRAP-LITERAL \"!=\") NIL) (QUOTE >) (CONS (WRAP-LITERAL \">\") NIL) (QUOTE >=) (CONS (WRAP-LITERAL \">=\") NIL) (QUOTE =>) (CONS (WRAP-LITERAL \">=\") NIL) (QUOTE <) (CONS (WRAP-LITERAL \"<\") NIL) (QUOTE =<) (CONS (WRAP-LITERAL \"<=\") NIL) (QUOTE <=) (CONS (WRAP-LITERAL \"<=\") NIL) (QUOTE AND) (CONS (WRAP-LITERAL \"&&\") NIL) (QUOTE OR) (CONS (WRAP-LITERAL \"||\") NIL) (QUOTE NOT) (CONS (WRAP-LITERAL \"!\") NIL) (QUOTE CHOOSE) (CONS (WRAP-LITERAL \"?\") (CONS (WRAP-LITERAL \":\") NIL))) :DOCUMENTATION \"Mapping from STELLA operators to C++ operators\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-RESERVED-WORD-TABLE* (STRING-HASH-TABLE OF STRING STRING-WRAPPER) (CPP-CREATE-RESERVED-WORD-TABLE))", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CPP-CURRENT-UNIT-MODULE* MODULE NULL :DOCUMENTATION \"Home module of the currently translated unit.  Needed for\nproper name translation for units whose home module is different than the\nfile module (occurs in some PowerLoom files - I thought we had outlawed that).\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CPPLOOPEXIT* SYMBOL (QUOTE CPP_BREAK))", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CPPLOOPEXITACTIVE?* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-CHARACTER-SUBSTITUTION-TABLE* STRING (CPP-CREATE-CHARACTER-SUBSTITUTION-TABLE))", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CPP-NAME-QUALIFICATION-MODE* KEYWORD :CLEVER)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CPP-NAMESPACE-SEPARATOR* STRING \"::\")", null);
        }
