...
public class Stella {
  ...
  public static Symbol SYM_STELLA_HOME_MODULE = null;

  public static Symbol SYM_STELLA_DELETEDp = null;

  public static Symbol SYM_STELLA_INCREMENT_REFERENCE_COUNT = null;

  public static Symbol SYM_STELLA_DECREMENT_REFERENCE_COUNT = null;

  public static Symbol SYM_STELLA_TYPE_SPEC = null;

  public static boolean $HARDWIRED_TRANSIENTp_ON_TRANSIENT_MIXIN$ = false;

  public static Surrogate SGT_STELLA_REFERENCE_COUNT_OBJECT = null;
  ...
  public static Surrogate SGT_STELLA_DICTIONARY_ITERATOR = null;

  public static Symbol SYM_STELLA_VALUE_SETTER = null;

  public static Symbol SYM_STELLA_KEY_SETTER = null;
  ...
  public static Surrogate SGT_STELLA_ABSTRACT_COLLECTION = null;
  ...
  public static Symbol SYM_STELLA_INSERT = null;

  public static Symbol SYM_STELLA_REMOVE = null;

  public static Symbol SYM_STELLA_OBJECT_COLLECTION = null;

  public static Surrogate SGT_STELLA_SEQUENCE = null;
  ...
  public static Surrogate SGT_STELLA_ABSTRACT_DICTIONARY = null;

  public static Surrogate SGT_STELLA_DICTIONARY = null;
  ...
  public static Symbol SYM_STELLA_PUBLICp = null;

  public static Symbol SYM_STELLA_DIRECT_SUPERS = null;

  public static Symbol SYM_STELLA_ALL_SUPERS = null;

  public static Symbol SYM_STELLA_SLOTS = null;
  ...
  public static Symbol SYM_STELLA_ACTIVEp = null;

  public static Symbol SYM_STELLA_CLASS_CREATOR = null;

  public static Symbol SYM_STELLA_CREATOR = null;

  public static Symbol SYM_STELLA_CLASS_INITIALIZER = null;

  public static Symbol SYM_STELLA_INITIALIZER = null;

  public static Symbol SYM_STELLA_CLASS_TERMINATOR = null;

  public static Symbol SYM_STELLA_TERMINATOR = null;

  public static Symbol SYM_STELLA_CLASS_DESTRUCTOR = null;

  public static Symbol SYM_STELLA_DESTRUCTOR = null;

  public static Symbol SYM_STELLA_REQUIRED_SLOTS = null;
  ...
  public static Symbol SYM_STELLA_INITIAL_VALUE = null;
  ...
  public static Symbol SYM_STELLA_CL_NATIVE_TYPE = null;

  public static Symbol SYM_STELLA_CLASS_CPP_NATIVE_TYPE = null;

  public static Symbol SYM_STELLA_CPP_NATIVE_TYPE = null;

  public static Symbol SYM_STELLA_IDL_NATIVE_TYPE = null;

  public static Symbol SYM_STELLA_CLASS_JAVA_NATIVE_TYPE = null;

  public static Symbol SYM_STELLA_JAVA_NATIVE_TYPE = null;
  ...
  public static Surrogate SGT_STELLA_POLYMORPHIC_RELATION = null;

  public static Symbol SYM_STELLA_OWNER = null;

  public static Symbol SYM_STELLA_RENAMES = null;
  ...
  public static Symbol SYM_STELLA_ALLOCATION = null;

  public static Symbol SYM_STELLA_SLOT_DEFAULT_EXPRESSION = null;

  public static Symbol SYM_STELLA_DEFAULT_FORM = null;

  public static Symbol SYM_STELLA_REQUIREDp = null;

  public static Symbol SYM_STELLA_COMPONENTp = null;

  public static Symbol SYM_STELLA_SLOT_READER = null;

  public static Symbol SYM_STELLA_READER = null;

  public static Symbol SYM_STELLA_SLOT_WRITER = null;

  public static Symbol SYM_STELLA_WRITER = null;
  ...
  public static Symbol SYM_STELLA_SETTERp = null;
  ...
  public static Symbol SYM_STELLA_CONTEXT_NAME = null;
  ...
  public static Symbol SYM_STELLA_PARENT_MODULE = null;

  public static Symbol SYM_STELLA_MODULE_LISP_PACKAGE = null;

  public static Symbol SYM_STELLA_LISP_PACKAGE = null;

  public static Symbol SYM_STELLA_MODULE_CPP_PACKAGE = null;

  public static Symbol SYM_STELLA_CPP_PACKAGE = null;
  ...
  public static Surrogate SGT_STELLA_QUANTITY = null;

  public static Symbol SYM_STELLA_COERCE_TO = null;

  public static Symbol SYM_STELLA_LESSp = null;

  public static Symbol SYM_STELLA_LESS_EQUALp = null;

  public static Symbol SYM_STELLA_GREATER_EQUALp = null;

  public static Symbol SYM_STELLA_GREATERp = null;
  ...
  public static Symbol SYM_STELLA_METHOD_CODEp = null;
  ...
  public static Surrogate SGT_STELLA_NATIVE_OBJECT_POINTER_WRAPPER = null;

  public static Surrogate SGT_STELLA_EXCEPTION_WRAPPER = null;

  public static Symbol SYM_STELLA_THREE_VALUED_BOOLEAN = null;

  public static Symbol SYM_STELLA_PYTHON_OBJECT_POINTER = null;

  public static Surrogate SGT_STELLA_SYSTEM_DEFINITION = null;

  public static Symbol SYM_STELLA_DEFINITION_FILE = null;
  ...
  public static Keyword KWD_CREATE_PATH = null;
   ...
   */
  public static Symbol ELLIPSIS = null;
  ...
  public static Surrogate SGT_STELLA_BUFFERED_STRING = null;

  public static Symbol SYM_STELLA_BUFFER = null;

  public static Symbol SYM_STELLA_BUFFER_SIZE = null;

  public static Symbol SYM_STELLA_STRING_BUFFER = null;
  ...
  public static Symbol SYM_STELLA_WRAP_MUTABLE_STRING = null;
  ...
  public static Symbol SYM_STELLA_DEFINE_INLINE_METHOD_CODE = null;
  ...
  public static Symbol SYM_STELLA_CALL_SUPER_METHOD = null;
  ...
  public static Symbol SYM_STELLA_SYS_CALL_SUPER_METHOD = null;
   ...
   */
  public final static StellaSpecialVariable $CURRENTFILENAME$ = new StellaSpecialVariable();
  ...
  public static Symbol SYM_STELLA_C_CALLABLE_WRAPPER_CODE = null;

  public static Symbol SYM_STELLA_LOOKUP_FUNCTION_BY_NAME = null;
  ...
  public static Symbol SYM_STELLA_DEFINE_GLOBAL_VARIABLE_OBJECT = null;
  ...
  public static Keyword KWD_C_NAMESPACE_PREFIX = null;
  ...
  public static Symbol SYM_STELLA_COPY_TOKEN_TEXT_INTERNAL = null;
  ...
  public final static StellaSpecialVariable $DEFAULTROOTSOURCEDIRECTORY$ = new StellaSpecialVariable();

  public final static StellaSpecialVariable $DEFAULTROOTNATIVEDIRECTORY$ = new StellaSpecialVariable();

  public final static StellaSpecialVariable $DEFAULTROOTBINARYDIRECTORY$ = new StellaSpecialVariable();

  /** Points to a list of directories containing system definition files.
   */
  public final static StellaSpecialVariable $DEFAULTSYSTEMDEFINITIONDIRECTORIES$ = new StellaSpecialVariable();
  ...
  public static Keyword KWD_JAVAC = null;

  public static Keyword KWD_MAVEN = null;
  ...
  public static Keyword KWD_RECURSIVEp = null;

  public static Keyword KWD_LANGUAGE = null;

  public static Keyword KWD_ACTION = null;

  public static Surrogate SGT_STELLA_FILE_NAME = null;

  public static Keyword KWD_PROCESSED = null;

  public static Keyword KWD_TRANSLATE_SYSTEM = null;

  public static Keyword KWD_OPTIONS = null;
   ...
   */
  public final static StellaSpecialVariable $CURRENTLOADFILE$ = new StellaSpecialVariable();
  ...
  public static Keyword KWD_DAYS = null;

  public static Keyword KWD_HOURS = null;

  public static Keyword KWD_MINUTES = null;

  public static Keyword KWD_SECONDS = null;

  public static Symbol SYM_STELLA_SYSTEM_VERSION = null;
   ...
   */
  public static KeyValueList $CPP_OPERATOR_TABLE$ = null;
  ...
  public final static StellaSpecialVariable $CPPLOOPEXIT$ = new StellaSpecialVariable();

  public static Symbol SYM_STELLA_CPP_BREAK = null;

  public final static StellaSpecialVariable $CPPLOOPEXITACTIVEp$ = new StellaSpecialVariable();

  public static Symbol SYM_STELLA_CPP_LOOP = null;

  public static Symbol SYM_STELLA_CPP_GOTO_LABEL = null;

  public static Symbol SYM_STELLA_CPP_WHILE = null;

  public static Symbol SYM_STELLA_CPP_WITH_PROCESS_LOCK = null;

  public static Symbol SYM_STELLA_CPP_GOTO = null;
   ...
   */
  public static Keyword $JAVA_BUILD_METHOD$ = null;

  public static Symbol SYM_STELLA_SYSTEM_GROUP_NAME = null;
  ...
  public static String $STELLA_VERSION$ = "3.7.0";

  public static int $STELLA_MAJOR_VERSION_NUMBER$ = Stella.NULL_INTEGER;

  public static int $STELLA_MINOR_VERSION_NUMBER$ = Stella.NULL_INTEGER;

  public static int $STELLA_PATCH_LEVEL$ = Stella.NULL_INTEGER;

  public static String $STELLA_RELEASE_STATE$ = null;

  public static String $STELLA_VERSION_STRING$ = null;

  /** Run-time version of the GC library used by STELLA.
   */
  public static String $STELLA_GC_VERSION$ = "not-installed";
   ...
   * <code>CCREATE_PATH</code> the file will be created plus any non-existing directories
   * in the directory path of <code>filename</code> will also be created.  If the value is
...
;
   ...
   */
  public static void seedRandomNumberGenerator2() {
    { long seed = (System.currentTimeMillis() ^ System.nanoTime());
      ...
      { InputFileStream in = null;
        ...
        try {
          in = Stella.openInputFile("/dev/urandom", Cons.cons(Stella.KWD_IF_NOT_EXISTS, Cons.cons(Stella.KWD_ABORT, Stella.NIL)));
          if (in != null) {
            { int i = Stella.NULL_INTEGER;
              int iter000 = 1;
              int upperBound000 = 8;
              ...
              for (;iter000 <= upperBound000; iter000 = iter000 + 1) {
                i = iter000;
                i = i;
                seed = (((seed ^ (((long)((int) (InputStream.readCharacter(in, new Object[1]))))))) << 8);
              }
            }
            seed = (seed & mask);
          }
      ...
      Native.RNG = new java.util.Random(seed);
    }
  }
...
;
  ...
  public static void cppCreateDirectory(String directory) {
    directory = Stella.translateLogicalPathname(Stella.fileNameAsDirectory(directory));
    if (!(Stella.probeDirectoryP(directory))) {
      if (!(((0) == 0))) {
        throw ((InputOutputException)(InputOutputException.newInputOutputException("failed to create directory: " + directory).fillInStackTrace()));
      }
    }
  }

  /** If <code>directory</code> does not yet exist, create it and any of its parents
   * that do not yet exist.  If <code>directory</code> already does exist, this simply is a no-op.
   * @param directory
   */
    ...
    if (!(Stella.probeDirectoryP(directory))) {
      try {
        if (!new java.io.File(directory).mkdirs())
                      throw InputOutputException.newInputOutputException("failed to create directory: " + directory)
;
      } catch (InputOutputException e) {
        throw ((InputOutputException)(e.fillInStackTrace()));
      } catch (java.lang.Exception e) {
        throw ((InputOutputException)(InputOutputException.newInputOutputException("create-directories: " + Stella.exceptionMessage(e)).fillInStackTrace()));
      }
    }
  }

  /** Ensure all physical directories in the directory portion of <code>filename</code> exist.
   * @param filename
   */
  public static void ensureDirectoriesExist(String filename) {
    { String directory = Stella.fileNameDirectory(Stella.translateLogicalPathname(filename));

      if (!(Stella.blankStringP(directory))) {
        Stella.createDirectories(directory);
      }
    }
  }
...
;
  ...
  /** Return the value of the OS environment variable <code>varname</code>.  If it is not defined
   * or if its value is the empty string and a <code>deflt</code> is provided, return the default value instead.
   * @param varname
   * @param deflt
   * @return String
   */
  public static String getenv(String varname, Cons deflt) {
    { String undefined = null;
      String value = System.getenv(varname);

      if ((value == null) ||
          Stella.stringEqlP(value, "")) {
        { String def = null;
          Cons iter000 = deflt;
...
;
   ...
   * <code>internStellaName</code> (which see) for cases where we don't necessarily
   * want to create a symbol in case it doesn't exist already.
   * @param name
   * @return GeneralizedSymbol
   */
  public static GeneralizedSymbol lookupStellaName(String name) {
    { Module module = ((Module)(Stella.$MODULE$.get()));
      ...
      { String barename = null;
        ...
        if (kind == Stella.KWD_SYMBOL) {
          return (Symbol.lookupSymbolInModule(barename, module, false));
        }
        else if (kind == Stella.KWD_SURROGATE) {
          return (Surrogate.lookupSurrogateInModule(barename, module, false));
        }
        else if (kind == Stella.KWD_KEYWORD) {
          return (Stella.lookupRigidSymbolWrtModule(barename, null, Stella.KEYWORD_SYM));
        }
        else {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();
  ...
  /** Return TRUE if <code>ch</code> is in the upper half of the byte set such as UTF-8 codes, etc.
   * @param ch
   * @return boolean
   */
  public static boolean eightBitCharacterP(char ch) {
    return ((int) ch >= 128);
  }
      ...
      { Module module = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          ...
          { boolean testValue000 = false;
            ...
            if (testValue000) {
              { 
                renamed_Class = surrogate.surrogateValue;
  ...
  /** Variant of <code>stringDlookupClass</code> that can specify a
   * starting module through a <code>qualifiedname</code>.
   * @param qualifiedname
   * @return Stella_Class
   */
  public static Stella_Class lookupClassByQualifiedName(String qualifiedname) {
    { String classname = null;
      ...
      { Object [] caller_MV_returnarray = new Object[2];
        ...
        classname = Stella.parseStellaName(qualifiedname, true, caller_MV_returnarray);
        modulename = ((String)(((StringWrapper)(caller_MV_returnarray[0])).wrapperValue));
        kind = ((Keyword)(caller_MV_returnarray[1]));
      }
      kind = kind;
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          Native.setSpecial(Stella.$MODULE$, ((modulename != null) ? Stella.getStellaModule(modulename, true) : ((Module)(Stella.$MODULE$.get()))));
          Native.setSpecial(Stella.$CONTEXT$, ((Module)(Stella.$MODULE$.get())));
          return (Stella.string_lookupClass(classname));
   ...
   * Examples: &quot;cons.first&quot; or &quot;stella/cons.first&quot;.  This is a variant of <code>stringToSlot</code>
   ...
   * @return Slot
   */
  public static Slot lookupSlotAndClassByQualifiedName(String qualifiedname, Object [] MV_returnarray) {
    { int dotpos = Native.string_position(qualifiedname, '.', 0);
      Stella_Class renamed_Class = null;
      Symbol slotname = null;
      Slot slot = null;

      loop000 : while (dotpos != Stella.NULL_INTEGER) {
        renamed_Class = Stella.lookupClassByQualifiedName(Native.string_subsequence(qualifiedname, 0, dotpos));
        if (renamed_Class != null) {
          try {
            slotname = Symbol.lookupSymbolInModule(Stella.parseStellaName(Native.string_subsequence(qualifiedname, dotpos + 1, Stella.NULL_INTEGER), true, new Object[2]), renamed_Class.homeModule(), false);
        ...
        dotpos = Native.string_position(qualifiedname, '.', dotpos + 1);
      }
      { Slot _return_temp = slot;

        MV_returnarray[0] = renamed_Class;
        return (_return_temp);
      }
    }
  }
   ...
   * @return Slot
   */
  public static Slot lookupSlotByQualifiedName(String qualifiedname) {
    return (Stella.lookupSlotAndClassByQualifiedName(qualifiedname, new Object[1]));
  }
  ...
  /** Variant of <code>lookupFunctionByName</code> that can specify a starting
   * module through a <code>qualifiedname</code>.
   * @param qualifiedname
   * @return MethodSlot
   */
  public static MethodSlot lookupFunctionByQualifiedName(String qualifiedname) {
    { String functionname = null;
      ...
      { Object [] caller_MV_returnarray = new Object[2];
        ...
        functionname = Stella.parseStellaName(qualifiedname, true, caller_MV_returnarray);
        modulename = ((String)(((StringWrapper)(caller_MV_returnarray[0])).wrapperValue));
        kind = ((Keyword)(caller_MV_returnarray[1]));
      }
      kind = kind;
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          Native.setSpecial(Stella.$MODULE$, ((modulename != null) ? Stella.getStellaModule(modulename, true) : ((Module)(Stella.$MODULE$.get()))));
          Native.setSpecial(Stella.$CONTEXT$, ((Module)(Stella.$MODULE$.get())));
          return (Stella.lookupFunctionByName(functionname));
  ...
  /** Return a global variable with <code>name</code> visible from the current module.
   ...
   * is a local symbol with <code>name</code> which shadows one higher up that is the name of a global.
   * @param name
   * @return GlobalVariable
   */
  public static GlobalVariable lookupGlobalVariableByName(String name) {
      ...
      { Module module = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          ...
          { boolean testValue000 = false;
            ...
            if (testValue000) {
              { 
                global = symbol.lookupGlobalVariable();
                testValue000 = global != null;
              }
            }
            if (testValue000) {
              return (global);
  ...
  /** Variant of <code>lookupGlobalVariableByName</code> that can specify a starting
   * module through a <code>qualifiedname</code>.
   * @param qualifiedname
   * @return GlobalVariable
   */
  public static GlobalVariable lookupGlobalVariableByQualifiedName(String qualifiedname) {
    { String globalname = null;
      ...
      { Object [] caller_MV_returnarray = new Object[2];
        ...
        globalname = Stella.parseStellaName(qualifiedname, true, caller_MV_returnarray);
        modulename = ((String)(((StringWrapper)(caller_MV_returnarray[0])).wrapperValue));
        kind = ((Keyword)(caller_MV_returnarray[1]));
      }
      kind = kind;
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          Native.setSpecial(Stella.$MODULE$, ((modulename != null) ? Stella.getStellaModule(modulename, true) : ((Module)(Stella.$MODULE$.get()))));
          Native.setSpecial(Stella.$CONTEXT$, ((Module)(Stella.$MODULE$.get())));
          return (Stella.lookupGlobalVariableByName(globalname));
  ...
  /** Define a STELLA global variable object based on <code>definition</code>, and initialize
   * its variable-native-object slot to <code>nativeobject</code> (which is primarily needed for C++).
   * @param definition
   * @param nativeobject
   */
  public static void defineGlobalVariableObject(String definition, Object nativeobject) {
    { GlobalVariable global = Cons.defineStellaGlobalVariableFromParseTree(((Cons)(Stella.unstringifyStellaSource(definition, null))), definition, new Object[1]);

      global.variableNativeObject = nativeobject;
    }
  }

  /** Interpreted variable reader which reads a native code variable represented by
   * <code>var</code> of type <code>type</code> and returns its value which will be wrapped if necessary.  If <code>var</code> is a
   * special variable, this will access the current dynamic value at the top of the special stack.
   * This relies upon <code>type</code> being completely accurate and bad things will happen if it is not.
   * @param var
   * @param type
   * @return Stella_Object
   */
  public static Stella_Object readNativeVariableValue(Object var, Surrogate type) {
    try {;
      java.lang.reflect.Field vfield = (java.lang.reflect.Field)var;
      Object specval = vfield.getType() == StellaSpecialVariable.class ? ((StellaSpecialVariable)vfield.get(null)).get() : vfield;
    if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_LITERAL)) {
      if (type == Stella.SGT_STELLA_STRING) {
        return (StringWrapper.wrapString((String)(specval == vfield ? vfield.get(null) : specval)));
      }
      else if (type == Stella.SGT_STELLA_BOOLEAN) {
        return (((specval == vfield ? vfield.getBoolean(null) : ((Boolean)specval).booleanValue()) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER));
      }
      else if (type == Stella.SGT_STELLA_INTEGER) {
        return (IntegerWrapper.wrapInteger(specval == vfield ? vfield.getInt(null) : ((Integer)specval).intValue()));
      }
      else if (type == Stella.SGT_STELLA_FLOAT) {
        return (FloatWrapper.wrapFloat(specval == vfield ? vfield.getDouble(null) : ((Double)specval).doubleValue()));
      }
      else if (type == Stella.SGT_STELLA_LONG_INTEGER) {
        return (Stella.wrapLongInteger(specval == vfield ? vfield.getLong(null) : ((Long)specval).longValue()));
      }
      else if (type == Stella.SGT_STELLA_CHARACTER) {
        return (CharacterWrapper.wrapCharacter(specval == vfield ? vfield.getChar(null) : ((Character)specval).charValue()));
      }
      else if (type == Stella.SGT_STELLA_MUTABLE_STRING) {
        return (MutableStringWrapper.wrapMutableString((StringBuffer)(specval == vfield ? vfield.get(null) : specval)));
      }
      else if (type == Stella.SGT_STELLA_FUNCTION_CODE) {
        return (FunctionCodeWrapper.wrapFunctionCode((java.lang.reflect.Method)(specval == vfield ? vfield.get(null) : specval)));
      }
      else if (type == Stella.SGT_STELLA_METHOD_CODE) {
        return (MethodCodeWrapper.wrapMethodCode((java.lang.reflect.Method)(specval == vfield ? vfield.get(null) : specval)));
      }
      else {
      }
    }
    else if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_OBJECT)) {
      return ((Stella_Object)(specval == vfield ? vfield.get(null) : specval));
    }
    } catch (Exception e) {};
    { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();

      stream000.nativeStream.print("Cannot read variables of type: `" + type + "'");
      throw ((StellaException)(StellaException.newStellaException(stream000.theStringReader()).fillInStackTrace()));
    }
  }

  /** Interpreted variable writer which sets a native code variable represented by
   * <code>var</code> of type <code>type</code> to <code>value</code> which will be unwrapped if necessary.  If <code>var</code> is a special
   * variable, this will change the current dynamic value at the top of the special stack.  This
   * relies upon <code>type</code> being completely accurate and bad things will happen if it is not.
   * @param var
   * @param type
   * @param value
   */
  public static void writeNativeVariableValue(Object var, Surrogate type, Stella_Object value) {
    { Surrogate valuetype = ((value != null) ? value.primaryType() : type);

      try {;
        java.lang.reflect.Field vfield = (java.lang.reflect.Field)var;
        StellaSpecialVariable specvar = vfield.getType() == StellaSpecialVariable.class ? ((StellaSpecialVariable)vfield.get(null)) : null;
      if (Surrogate.subtypeOfP(type, Stella.SGT_STELLA_LITERAL)) {
        if (!(Surrogate.subtypeOfP(valuetype, Stella.SGT_STELLA_WRAPPER) &&
            Surrogate.subtypeOfP(Surrogate.wrappedTypeToType(valuetype), type))) {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();

            stream000.nativeStream.print("Variable type `" + type + "' not compatible with value type `" + Surrogate.wrappedTypeToType(valuetype) + "'");
            throw ((StellaException)(StellaException.newStellaException(stream000.theStringReader()).fillInStackTrace()));
          }
        }
        if (type == Stella.SGT_STELLA_STRING) {
          { String val = StringWrapper.unwrapString(((StringWrapper)(value)));

            if (specvar == null) vfield.set(null, val); else specvar.set(val);
            return;
          }
        }
        else if (type == Stella.SGT_STELLA_BOOLEAN) {
          { boolean val = ((BooleanWrapper)(value)) == Stella.TRUE_WRAPPER;

            if (specvar == null) vfield.setBoolean(null, val); else specvar.set(val);
            return;
          }
        }
        else if (type == Stella.SGT_STELLA_INTEGER) {
          { int val = IntegerWrapper.unwrapInteger(((IntegerWrapper)(value)));

            if (specvar == null) vfield.setInt(null, val); else specvar.set(val);
            return;
          }
        }
        else if (type == Stella.SGT_STELLA_FLOAT) {
          { double val = FloatWrapper.unwrapFloat(((FloatWrapper)(value)));

            if (specvar == null) vfield.setDouble(null, val); else specvar.set(val);
            return;
          }
        }
        else if (type == Stella.SGT_STELLA_LONG_INTEGER) {
          { long val = LongIntegerWrapper.unwrapLongInteger(((LongIntegerWrapper)(value)));

            if (specvar == null) vfield.setLong(null, val); else specvar.set(val);
            return;
          }
        }
        else if (type == Stella.SGT_STELLA_CHARACTER) {
          { char val = CharacterWrapper.unwrapCharacter(((CharacterWrapper)(value)));

            if (specvar == null) vfield.setChar(null, val); else specvar.set(val);
            return;
          }
        }
        else if (type == Stella.SGT_STELLA_MUTABLE_STRING) {
          { StringBuffer val = MutableStringWrapper.unwrapMutableString(((MutableStringWrapper)(value)));
          ...
          { java.lang.reflect.Method val = FunctionCodeWrapper.unwrapFunctionCode(((FunctionCodeWrapper)(value)));
          ...
          { java.lang.reflect.Method val = MethodCodeWrapper.unwrapMethodCode(((MethodCodeWrapper)(value)));
        ...
        if (!(Surrogate.subtypeOfP(valuetype, type))) {
          { OutputStringStream stream001 = OutputStringStream.newOutputStringStream();

            stream001.nativeStream.print("Variable type `" + type + "' not compatible with value type `" + valuetype + "'");
            throw ((StellaException)(StellaException.newStellaException(stream001.theStringReader()).fillInStackTrace()));
          }
        }
        if (specvar == null) vfield.set(null, value); else specvar.set(value);
        return;
      }
      } catch (Exception e) {};
      { OutputStringStream stream002 = OutputStringStream.newOutputStringStream();

        stream002.nativeStream.print("Cannot write variables of type: `" + type + "'");
...
;
  ...
  public static void defineMethodObject(String definition, CodeWrapper code, CodeWrapper wrappercode) {
...
;
  ...
  public static boolean incrementalTranslationP() {
    return (((String)(Stella.$CURRENTFILENAME$.get())) == null);
  }
  ...
  public static Symbol yieldStartupFunctionName(String file) {
    file = ((file == null) ? ((String)(Stella.$CURRENTFILENAME$.get())) : file);
  ...
  public static void createStartupFunctionUnits() {
    { Symbol startupfnname = (Stella.incrementalTranslationP() ? ((Symbol)(null)) : Stella.yieldStartupFunctionName(((String)(Stella.$CURRENTFILENAME$.get()))));
      boolean systemstartupP = Stella.systemStartupFileP(((String)(Stella.$CURRENTFILENAME$.get())));
      Cons options = (systemstartupP ? Cons.list$(Cons.cons(Stella.KWD_PUBLICp, Cons.cons(Stella.SYM_STELLA_TRUE, Cons.cons(Stella.KWD_C_CALLABLEp, Cons.cons(Stella.SYM_STELLA_TRUE, Cons.cons(Stella.KWD_C_NAMESPACE_PREFIX, Cons.cons(StringWrapper.wrapString("stella_"), Cons.cons(Stella.NIL, Stella.NIL)))))))) : Cons.list$(Cons.cons(Stella.KWD_PUBLICp, Cons.cons(Stella.SYM_STELLA_TRUE, Cons.cons(Stella.NIL, Stella.NIL)))));
      Cons tree = null;
      MethodSlot method = null;
      ...
      if (Stella.dontGenerateStartupCodeP()) {
        ...
        tree = Cons.list$(Cons.cons(Stella.SYM_STELLA_DEFUN, Cons.cons(startupfnname, Cons.cons(Cons.cons(Stella.NIL, options.concatenate(Cons.cons(Stella.SYM_STELLA_NULL, Stella.NIL), Stella.NIL)), Stella.NIL))));
  ...
  public static String cppTypeToCType(String type) {
    { boolean returnparameterP = Stella.endsWithP(type, "&", Stella.NULL_INTEGER);

      if (returnparameterP) {
        type = Native.string_subsequence(type, 0, type.length() - 1);
      }
      if (Stella.stringEqlP(type, "boolean")) {
        type = "int";
      }
      else if (Stella.stringEqlP(type, "char*")) {
      }
      else if (Stella.stringEqlP(type, "const char*")) {
      }
      else if (Stella.stringEqlP(type, "cpp_function_code")) {
        type = "void*";
      }
      else if (Stella.stringEqlP(type, "cpp_method_code")) {
        type = "void*";
      }
      else {
        { int starpos = Native.string_position(type, '*', 0);

          if (starpos != Stella.NULL_INTEGER) {
            type = "void*" + Native.string_subsequence(type, starpos + 1, Stella.NULL_INTEGER);
          }
        }
      }
      if (returnparameterP) {
  ...
  public static java.lang.reflect.Method lookupFunctionCodeByName(String qualifiedname) {
    { MethodSlot function = Stella.lookupFunctionByQualifiedName(qualifiedname);
  ...
  public static java.lang.reflect.Method lookupCCallableWrapperCodeByName(String qualifiedname) {
    { MethodSlot function = Stella.lookupFunctionByQualifiedName(qualifiedname);

      if (function != null) {
        return (((FunctionCodeWrapper)(KeyValueList.dynamicSlotValue(function.dynamicSlots, Stella.SYM_STELLA_C_CALLABLE_WRAPPER_CODE, Stella.NULL_FUNCTION_CODE_WRAPPER))).wrapperValue);
      }
      else {
        return (null);
      }
  ...
  public static String lookupFunctionCppSignatureByName(String qualifiedname) {
    { MethodSlot function = Stella.lookupFunctionByQualifiedName(qualifiedname);

      if (function != null) {
        return (Cons.listSignatureToString(MethodSlot.yieldFunctionCppSignature(function, null, true)));
      }
      else {
        return (null);
      }
  ...
  public static String lookupFunctionCSignatureByName(String qualifiedname) {
    { MethodSlot function = Stella.lookupFunctionByQualifiedName(qualifiedname);

      if (function != null) {
        return (Cons.listSignatureToString(MethodSlot.yieldFunctionCSignature(function, null)));
      }
      else {
        return (null);
      }
  ...
  public static CodeWrapper lookupMethodCodeByName(String qualifiedname) {
    { Slot slot = Stella.lookupSlotByQualifiedName(qualifiedname);

      if (Stella_Object.methodSlotP(slot)) {
        return (((MethodSlot)(slot)).methodCode);
      }
      else {
        return (null);
      }
  ...
  public static String lookupMethodCppSignatureByName(String qualifiedname) {
    { Slot slot = null;
      Stella_Class renamed_Class = null;

      { Object [] caller_MV_returnarray = new Object[1];

        slot = Stella.lookupSlotAndClassByQualifiedName(qualifiedname, caller_MV_returnarray);
        renamed_Class = ((Stella_Class)(caller_MV_returnarray[0]));
      }
      if (Stella_Object.methodSlotP(slot)) {
        return (Cons.listSignatureToString(MethodSlot.yieldMethodCppSignature(((MethodSlot)(slot)), renamed_Class.classType, true)));
      }
      else {
        return (null);
      }
  ...
  public static String lookupMethodCSignatureByName(String qualifiedname) {
    { Slot slot = null;
      Stella_Class renamed_Class = null;
      ...
      if (Stella_Object.methodSlotP(slot)) {
        return (Cons.listSignatureToString(MethodSlot.yieldMethodCSignature(((MethodSlot)(slot)), renamed_Class.classType)));
      }
      else {
        return (null);
      }
  ...
  public static String lookupStorageSlotCppSignatureByName(String qualifiedname) {
    { Slot slot = null;
      Stella_Class renamed_Class = null;
      ...
      if (Stella_Object.storageSlotP(slot)) {
        return (Cons.listSignatureToString(StorageSlot.yieldStorageSlotCppSignature(((StorageSlot)(slot)), renamed_Class.classType, true)));
      }
      else {
        return (null);
      }
  ...
  public static String lookupStorageSlotCSignatureByName(String qualifiedname) {
    { Slot slot = null;
      Stella_Class renamed_Class = null;
      ...
      if (Stella_Object.storageSlotP(slot)) {
        return (Cons.listSignatureToString(StorageSlot.yieldStorageSlotCSignature(((StorageSlot)(slot)), renamed_Class.classType)));
      }
      else {
        return (null);
      }
   ...
   * named by <code>qualifiedname</code> or NULL if no such STELLA class exists.
   * @param qualifiedname
   * @return String
   */
  public static String lookupClassCppTypeByName(String qualifiedname) {
    { Stella_Class renamed_Class = Stella.lookupClassByQualifiedName(qualifiedname);
      ...
      if (renamed_Class != null) {
        { Object old$Module$000 = Stella.$MODULE$.get();
          ...
          try {
            Native.setSpecial(Stella.$MODULE$, Stella.$ROOT_MODULE$);
            Native.setSpecial(Stella.$CONTEXT$, ((Module)(Stella.$MODULE$.get())));
            return (StandardObject.cppTranslateAndPointerizeTypeSpec(renamed_Class.classType).wrapperValue);
  ...
  public static String lookupGlobalVariableCppSignatureByName(String qualifiedname) {
    { GlobalVariable global = Stella.lookupGlobalVariableByQualifiedName(qualifiedname);

      if (global != null) {
        return (Cons.listSignatureToString(GlobalVariable.yieldGlobalVariableCppSignature(global, true)));
      }
      else {
        return (null);
      }
  ...
  public static String lookupGlobalVariableCSignatureByName(String qualifiedname) {
    { GlobalVariable global = Stella.lookupGlobalVariableByQualifiedName(qualifiedname);

      if (global != null) {
        return (Cons.listSignatureToString(GlobalVariable.yieldGlobalVariableCSignature(global)));
      }
      else {
        return (null);
      }
  ...
  public static void clOutputAllUnitsToFile(String sourcefile) {
    { String outputfile = Stella.makeFileName(sourcefile, Stella.KWD_LISP, false);
      OutputFileStream outputstream = Stella.openOutputFile(outputfile, Cons.cons(Stella.KWD_IF_NOT_EXISTS, Cons.cons(Stella.KWD_CREATE_PATH, Stella.NIL)));
...
;
  ...
  public static int copyTokenTextInternal(char[] buffer, int start, int end, int size, boolean upcaseP, BufferedString resultbuffer) {
    if (start >= size) {
      start = start - size;
    }
    else if (start < 0) {
    ...
    { int length = end - start;
      int auxend = end;
      StringBuffer result = resultbuffer.buffer;
      int cursor = resultbuffer.fillPointer;

      if (length < 0) {
        length = length + size;
        auxend = size;
      }
      if ((cursor + length) > resultbuffer.bufferSize) {
        result = resultbuffer.ensureFreeSpace(length);
      }
      if (upcaseP) {
        loop000 : for (;;) {
          while (start < auxend) {
      ...
      resultbuffer.fillPointer = cursor;
      return (cursor);
    }
  }
...
;
  ...
  public static Stella_Object restoreTokenizerStreamState() {
    return (Cons.list$(Cons.cons(Stella.SYM_STELLA_WHEN, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_DEFINEDp, Cons.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_SETQ, Cons.cons(Stella.SYM_STELLA_TOK_CURSOR_, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_CURSOR, Cons.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL))))), Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_SETQ, Cons.cons(Stella.SYM_STELLA_TOK_TABLE_, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_TABLE, Cons.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL))))), Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_SETQ, Cons.cons(Stella.SYM_STELLA_TOK_STATE_, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_STATE, Cons.cons(Stella.SYM_STELLA_TOK_STREAMSTATE_, Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL))))), Cons.cons(Stella.NIL, Stella.NIL))))))));
  }
...
;
  ...
  public static String rootSourceDirectory() {
    if ((((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())) != null) &&
        (((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())).lookup(Stella.KWD_ROOT_SOURCE_DIRECTORY) != null)) {
      return (Stella.translateLogicalPathname(((StringWrapper)(((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())).lookup(Stella.KWD_ROOT_SOURCE_DIRECTORY))).wrapperValue));
    }
    else if ((((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) &&
        (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).sourceRootDirectory != null)) {
      return (Stella.translateLogicalPathname(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).sourceRootDirectory));
    }
    else {
      return (Stella.translateLogicalPathname(((String)(Stella.$DEFAULTROOTSOURCEDIRECTORY$.get()))));
    }
  }
  ...
  public static String rootNativeDirectory() {
    if ((((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())) != null) &&
        (((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())).lookup(Stella.KWD_ROOT_NATIVE_DIRECTORY) != null)) {
      return (Stella.translateLogicalPathname(((StringWrapper)(((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())).lookup(Stella.KWD_ROOT_NATIVE_DIRECTORY))).wrapperValue));
    }
    else if ((((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) &&
        (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).nativeRootDirectory != null)) {
      return (Stella.translateLogicalPathname(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).nativeRootDirectory));
    }
    else {
      return (Stella.translateLogicalPathname(((String)(Stella.$DEFAULTROOTNATIVEDIRECTORY$.get()))));
    }
  }
  ...
  public static String rootBinaryDirectory() {
    if ((((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())) != null) &&
        (((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())).lookup(Stella.KWD_ROOT_BINARY_DIRECTORY) != null)) {
      return (Stella.translateLogicalPathname(((StringWrapper)(((PropertyList)(Stella.$CURRENT_SYSTEM_ACTION$.get())).lookup(Stella.KWD_ROOT_BINARY_DIRECTORY))).wrapperValue));
    }
    else if ((((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())) != null) &&
        (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).binaryRootDirectory != null)) {
      return (Stella.translateLogicalPathname(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).binaryRootDirectory));
    }
    else {
      return (Stella.translateLogicalPathname(((String)(Stella.$DEFAULTROOTBINARYDIRECTORY$.get()))));
    }
  }

  public static Cons systemDefinitionDirectories() {
    { Cons value000 = Stella.NIL;

      { StringWrapper dir = null;
        Cons iter000 = ((Cons)(Stella.$DEFAULTSYSTEMDEFINITIONDIRECTORIES$.get()));
        Cons collect000 = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          ...
          if (collect000 == null) {
            {
              collect000 = Cons.cons(StringWrapper.wrapString(Stella.translateLogicalPathname(dir.wrapperValue)), Stella.NIL);
              if (value000 == Stella.NIL) {
                value000 = collect000;
              }
              else {
            ...
            {
              collect000.rest = Cons.cons(StringWrapper.wrapString(Stella.translateLogicalPathname(dir.wrapperValue)), Stella.NIL);
              collect000 = collect000.rest;
            }
          }
        }
  ...
  /** Return TRUE if <code>directory</code> is a top-level STELLA installation directory
   ...
   * @return boolean
   */
  public static boolean topLevelStellaSystemDirectoryP(String directory) {
    { String nativename = Stella.relativeUnlogicalizePathname(((String)(Stella.$DEFAULTROOTNATIVEDIRECTORY$.get())));
      String sourcename = Stella.relativeUnlogicalizePathname(((String)(Stella.$DEFAULTROOTSOURCEDIRECTORY$.get())));

      return (Stella.probeFileP(Stella.concatenateFileNames(directory, Cons.cons(StringWrapper.wrapString(nativename), Cons.cons(StringWrapper.wrapString("cpp"), Stella.NIL)))) ||
          (Stella.probeFileP(Stella.concatenateFileNames(directory, Cons.cons(StringWrapper.wrapString(nativename), Cons.cons(StringWrapper.wrapString("java"), Stella.NIL)))) ||
           (Stella.probeFileP(Stella.concatenateFileNames(directory, Cons.cons(StringWrapper.wrapString(nativename), Cons.cons(StringWrapper.wrapString("lisp"), Stella.NIL)))) ||
            Stella.probeFileP(Stella.concatenateFileNames(directory, Cons.cons(StringWrapper.wrapString(sourcename), Cons.cons(StringWrapper.wrapString("systems"), Stella.NIL)))))));
    }
  }
  ...
  public static void operateOnFile(String file, Keyword operation) {
    { String targetlanguage = ((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())).symbolName;
      ...
      { Object old$Translationphase$000 = Stella.$TRANSLATIONPHASE$.get();
        ...
        Object old$Currentfilename$000 = Stella.$CURRENTFILENAME$.get();
        Object old$Module$000 = Stella.$MODULE$.get();
        Object old$Context$000 = Stella.$CONTEXT$.get();
        ...
        try {
          ...
          Native.setIntSpecial(Stella.$TRANSLATIONWARNINGS$, 0);
          Native.setIntSpecial(Stella.$TRANSLATIONNOTES$, 0);
          Native.setSpecial(Stella.$CURRENTFILENAME$, Stella.fileBaseName(file));
          ...
          Stella.$CONTEXT$.set(old$Context$000);
          Stella.$MODULE$.set(old$Module$000);
          Stella.$CURRENTFILENAME$.set(old$Currentfilename$000);
  ...
  /** If <code>pathname</code> is a logical pathname translate it, however, remove the
   * :root-directory prefix of the logical host.  Otherwise, return <code>pathname</code> as is.
   * @param pathname
   * @return String
   */
  public static String relativeUnlogicalizePathname(String pathname) {
    if (!(Stella.logicalPathnameP(pathname))) {
      return (pathname);
    }
    { String host = Stella.getLogicalHostName(pathname);
      String rootprefix = Stella.translateLogicalPathname(host + ":");

      return (Native.string_subsequence(Stella.translateLogicalPathname(pathname), rootprefix.length(), Stella.NULL_INTEGER));
    }
  }
  ...
  /** Intelligently join <code>file</code> and <code>otherfiles</code> into a concatenated path where each
   * component is separated by a single separator (similar to Python's os.path.join).  Keeps the result
   * a logical pathname as long as possible, but converts to physical as soon as any of <code>otherfiles</code>
   * contain a physical directory separator.
   * @param file
   * @param otherfiles
   * @return String
   */
  public static String concatenateFileNames(String file, Cons otherfiles) {
    { char separator = Stella.directorySeparator();

      { String otherfile = null;
        Cons iter000 = otherfiles;

        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          otherfile = ((StringWrapper)(iter000.value)).wrapperValue;
          if (Stella.absolutePathnameP(otherfile)) {
            file = otherfile;
          }
          else {
            if ((separator != Stella.NULL_CHARACTER) &&
                Native.string_memberP(otherfile, separator)) {
              file = Stella.translateLogicalPathname(file);
              separator = Stella.NULL_CHARACTER;
            }
            file = Stella.fileNameAsDirectory(file) + otherfile;
          }
        }
      }
      return (file);
  ...
  /** Given a <code>file</code>, determine which STELLA installation root directory
   * tree it naturally belongs to based on its extension (i.e., source, native or binary).
   * @param file
   * @return String
   */
  public static String getRootDirectoryFromFileExtension(String file) {
    return (Keyword.getRootDirectoryFromFileType(Stella.classifyFileExtension(file)));
  }

  /** Make an absolute file-name string from 'filePath' with directory location
   * and file extension determined by 'type' and 'relative?'.  <code>type</code> is the main determiner
   ...
   * one on <code>filepath</code>.  If 'relative?' is TRUE, then the respective root directory prefix is appended,
   * plus any additional relevant language, system and source subdirectories.  If 'relative?' is
   * FALSE, then the current directory prefix of <code>filepath</code> as indicated by its extension is switched
   * to the new root directory indicated by <code>type</code>.  In this case, only the root and language directories
  ...
  public static String makeFileName(String filepath, Keyword type, boolean relativeP) {
    { String extension = Keyword.selectFileExtension(type);
      ...
      if (relativeP) {
        rootpath = Keyword.getRootDirectoryFromFileType(type);
        languagedir = Keyword.getLanguageSubdirectoryFromFileType(type);
        systemdir = Keyword.getSystemSubdirectoryFromFileType(type);
        sourcedir = Keyword.getNativeSourceSubdirectoryFromFileType(type);
        if (!(type == Stella.KWD_OTHER)) {
          filepath = Stella.fileNameWithoutExtension(filepath);
        }
      }
      else {
        { String rootprefix = Stella.fileNameAsDirectory(Stella.getRootDirectoryFromFileExtension(filepath));
      ...
      return (Stella.concatenateFileNames(rootpath, Cons.cons(StringWrapper.wrapString(languagedir), Cons.cons(StringWrapper.wrapString(systemdir), Cons.cons(StringWrapper.wrapString(sourcedir), Cons.cons(StringWrapper.wrapString(filepath + extension), Stella.NIL))))));
    }
  }
...
;
  ...
  /** Try to find a STELLA source file based on the name and system components of <code>nativefilename</code>.
   ...
   * @return String
   */
  public static String findSourceFromNativeFileName(String nativefilename) {
    { String nativedir = Stella.fileNameDirectory(nativefilename);
      String nativename = Stella.fileNameWithoutExtension(Stella.fileBaseName(nativefilename));
      String nativesystemdir = null;
      String sourcefilename = null;
      String sourcesdir = Stella.relativeUnlogicalizePathname(((String)(Stella.$DEFAULTROOTSOURCEDIRECTORY$.get())));
      Cons stelladirectories = Stella.buildStellaSystemsPath();

      { int level = Stella.NULL_INTEGER;
        int iter000 = 1;

        loop000 : for (;true; iter000 = iter000 + 1) {
          level = iter000;
          nativesystemdir = Stella.directoryParentDirectory(nativedir, level);
          if (Stella.blankStringP(nativesystemdir)) {
            break loop000;
          }
          nativesystemdir = Native.string_subsequence(nativedir, nativesystemdir.length(), Stella.NULL_INTEGER);
          sourcefilename = Stella.concatenateFileNames(nativesystemdir, Cons.cons(StringWrapper.wrapString(nativename + ".ste"), Stella.NIL));
          { StringWrapper dir = null;
            Cons iter001 = stelladirectories;

            for (;!(iter001 == Stella.NIL); iter001 = iter001.rest) {
              dir = ((StringWrapper)(iter001.value));
              if (Stella.probeFileP(Stella.concatenateFileNames(dir.wrapperValue, Cons.cons(StringWrapper.wrapString(sourcesdir), Cons.cons(StringWrapper.wrapString(sourcefilename), Stella.NIL))))) {
                return (Stella.concatenateFileNames(dir.wrapperValue, Cons.cons(StringWrapper.wrapString(sourcesdir), Cons.cons(StringWrapper.wrapString(sourcefilename), Stella.NIL))));
              }
            }
          }
        }
  ...
  public static boolean systemNeedsTranslationP(String systemname, Keyword language) {
    { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
      ...
      try {
        Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITION$, Stella.getSystemDefinition(systemname, true));
        Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$, ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).directory);
        {
          { boolean foundP000 = false;
   ...
   * <p>
   * <code>CrecursiveP</code> (default false): if true, perform <code>translateSystem</code> with the provided
   * options on <code>systemname</code> as well as all its required systems and so on.  Required
   ...
   * that is assumed when loading <code>systemname</code> and supporting modules from a definition file.
   * <p>
   * <code>CrootSourceDirectory</code>, <code>CrootNativeDirectory</code>, <code>CrootBinaryDirectory</code>: if
  ...
  public static boolean translateSystem(String systemname, Cons languageAoptions) {
    { Cons options = languageAoptions;
      ...
      if (!(Stella.getQuotedTree("((:COMMON-LISP :CPP :JAVA) \"/STELLA\")", "/STELLA").memberP(options.value))) {
        options = Cons.cons(Stella.runningInLanguage(), options);
      }
      { PropertyList theoptions = Stella_Object.parseOptions(options.rest, Cons.list$(Cons.cons(Stella.KWD_TWO_PASSp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_DEVELOPMENT_SETTINGSp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_PRODUCTION_SETTINGSp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_FORCE_TRANSLATIONp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_RECURSIVEp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_LANGUAGE, Cons.cons(Stella.SGT_STELLA_KEYWORD, Cons.cons(Stella.KWD_ACTION, Cons.cons(Stella.SGT_STELLA_KEYWORD, Cons.cons(Stella.KWD_ROOT_SOURCE_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_ROOT_NATIVE_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_ROOT_BINARY_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_PROCESSED, Cons.cons(Stella.SGT_STELLA_LIST, Cons.cons(Stella.NIL, Stella.NIL)))))))))))))))))))))))), true, false);
        Keyword language = ((Keyword)(theoptions.lookupWithDefault(Stella.KWD_LANGUAGE, options.value)));
        boolean twopassP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_TWO_PASSp, ((!Stella.systemLoadedOrStartedUpP(systemname)) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER)))));
        boolean productionmodeP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_PRODUCTION_SETTINGSp, Stella.TRUE_WRAPPER)))) ||
            (!BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_DEVELOPMENT_SETTINGSp, Stella.FALSE_WRAPPER)))));
        boolean forcetranslationP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_FORCE_TRANSLATIONp, Stella.FALSE_WRAPPER))));
        boolean recursiveP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_RECURSIVEp, Stella.FALSE_WRAPPER))));
        List processed = ((List)(theoptions.lookupWithDefault(Stella.KWD_PROCESSED, List.list(Stella.NIL))));
        Stella_Object action = theoptions.lookupWithDefault(Stella.KWD_ACTION, Stella.KWD_TRANSLATE_SYSTEM);
        boolean translatedsomethingP = false;
        int oldgensymcounter = Stella.$GENSYM_COUNTER$;

        theoptions.insertAt(Stella.KWD_LANGUAGE, language);
        theoptions.insertAt(Stella.KWD_ACTION, action);
        theoptions.insertAt(Stella.KWD_PROCESSED, processed);
        try {
          { Object old$Translatoroutputlanguage$000 = Stella.$TRANSLATOROUTPUTLANGUAGE$.get();
            Object old$Translationphase$000 = Stella.$TRANSLATIONPHASE$.get();
            ...
            try {
              ...
              Native.setSpecial(Stella.$CURRENT_SYSTEM_ACTION$, theoptions);
              { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
                Object old$Currentsystemdefinitionsubdirectory$000 = Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$.get();
                ...
                try {
                  ...
                  Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$, ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).directory);
                  {
                    processed.insertNew(StringWrapper.wrapString(systemname));
                    if (recursiveP &&
                        (((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).requiredSystems != null)) {
                      { StringWrapper reqsys = null;
                        Cons iter000 = ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).requiredSystems;

                        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
                          reqsys = ((StringWrapper)(iter000.value));
                          if (!processed.memberP(reqsys)) {
                            Stella.STANDARD_OUTPUT.nativeStream.println("Translating required system `" + StringWrapper.unwrapString(reqsys) + "'");
                            Stella.translateSystem(reqsys.wrapperValue, Cons.cons(Stella.KWD_OPTIONS, Cons.cons(theoptions, Stella.NIL)));
                          }
                        }
                      }
                    }
                    ...
                    if (forcetranslationP ||
                      ...
                      translatedsomethingP = Cons.helpTranslateSystem(Cons.filesPlusSystemStartup(SystemDefinition.systemDefinitionSourceFiles(((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())))), twopassP, forcetranslationP);
                    }
          ...
          Stella.$GENSYM_COUNTER$ = oldgensymcounter;
        }
  ...
  public static void loadFile(String file) {
    ...
    { boolean toplevelinvocationP = ((String)(Stella.$CURRENTFILENAME$.get())) == null;
      ...
      try {
        { Object old$Currentloadfile$000 = Stella.$CURRENTLOADFILE$.get();
          Object old$Currentfilename$000 = Stella.$CURRENTFILENAME$.get();

          try {
            Native.setSpecial(Stella.$CURRENTLOADFILE$, file);
            Native.setSpecial(Stella.$CURRENTFILENAME$, Stella.fileBaseName(file));
            ...
            Stella.$CURRENTFILENAME$.set(old$Currentfilename$000);
            Stella.$CURRENTLOADFILE$.set(old$Currentloadfile$000);
          }
        }
  ...
  /** Make a canonical system definition file name for a system named <code>name</code>.
   * @param name
   * @return String
   */
  public static String makeSystemDefinitionFileName(String name) {
    return (Native.stringDowncase(name) + "-system.ste");
  }

  public static Cons buildStellaSystemsPath() {
    { String explicitpathvalue = Stella.getenv("STELLA_SYSTEMS_PATH", Cons.cons(StringWrapper.wrapString(":"), Stella.NIL));
      List explicitpath = List.newList();
      List implicitpath = List.newList();

      { StringWrapper dir = null;
        Cons iter000 = Stella.splitString(explicitpathvalue, ':');

        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          dir = ((StringWrapper)(iter000.value));
          if (!Stella.blankStringP(dir.wrapperValue)) {
            explicitpath.insertNew(dir);
          }
        }
      }
      explicitpath.reverse();
      if (explicitpath.nonEmptyP() &&
          ((!Stella.startsWithP(explicitpathvalue, ":", 0)) &&
           (!Stella.endsWithP(explicitpathvalue, ":", Stella.NULL_INTEGER)))) {
        return (explicitpath.consify());
      }
      implicitpath.insertNew(StringWrapper.wrapString(Stella.findSystemRootDirectoryFromFile(Stella.rootSourceDirectory())));
      implicitpath.insertNew(StringWrapper.wrapString(Stella.findSystemRootDirectoryFromFile(Stella.rootNativeDirectory())));
      implicitpath.insertNew(StringWrapper.wrapString(Stella.findSystemRootDirectoryFromFile(Stella.rootBinaryDirectory())));
      { StringWrapper dir = null;
        Cons iter001 = Stella.systemDefinitionDirectories();

        for (;!(iter001 == Stella.NIL); iter001 = iter001.rest) {
          dir = ((StringWrapper)(iter001.value));
          implicitpath.insertNew(dir);
        }
      }
      { SystemDefinition sys = null;
        Cons iter002 = Stella.$SYSTEMDEFINITIONS$.theConsList;

        for (;!(iter002 == Stella.NIL); iter002 = iter002.rest) {
          sys = ((SystemDefinition)(iter002.value));
          implicitpath.insertNew(StringWrapper.wrapString(SystemDefinition.findSystemRootDirectory(sys)));
        }
      }
      if (explicitpath.emptyP()) {
        { StringWrapper dir = null;
          Cons iter003 = implicitpath.copy().theConsList;

          for (;!(iter003 == Stella.NIL); iter003 = iter003.rest) {
            dir = ((StringWrapper)(iter003.value));
            if ((!Stella.blankStringP(dir.wrapperValue)) &&
                Stella.probeDirectoryP(dir.wrapperValue)) {
              { String systemparentdir = Stella.directoryParentDirectory(dir.wrapperValue, 1);
                Cons systemparentdirfiles = Stella.listDirectoryFiles(systemparentdir);

                { StringWrapper dir000 = null;
                  Cons iter004 = systemparentdirfiles;

                  for (;!(iter004 == Stella.NIL); iter004 = iter004.rest) {
                    dir000 = ((StringWrapper)(iter004.value));
                    dir000 = StringWrapper.wrapString(Stella.fileNameAsDirectory(Stella.concatenateFileNames(systemparentdir, Cons.cons(StringWrapper.wrapString(dir000.wrapperValue), Stella.NIL))));
                    if (Stella.probeFileP(dir000.wrapperValue) &&
                        Stella.topLevelStellaSystemDirectoryP(dir000.wrapperValue)) {
                      implicitpath.insertNew(dir000);
                    }
                  }
                }
              }
      ...
      implicitpath.reverse().remove(Stella.NULL_STRING_WRAPPER);
      if (Stella.startsWithP(explicitpathvalue, ":", 0)) {
        return (((Cons)(implicitpath.concatenate(explicitpath, Stella.NIL).consify())));
      }
      else {
        return (((Cons)(explicitpath.concatenate(implicitpath, Stella.NIL).consify())));
      }
    }
  }

  /** Try to find an existing system definition file for a system named <code>name</code>
   * in the current STELLA_SYSTEMS_PATH or built-in implicit systems path.  Return NULL if no
   * such definition file can be found.  See <code>buildStellaSystemsPath</code> on where it looks.
   * @param name
   * @return String
   */
  public static String findSystemDefinitionFile(String name) {
    { String systemfilename = Stella.makeSystemDefinitionFileName(name);
      String systemfile = null;
      Cons relativesystemdirs = Cons.consList(Cons.cons(StringWrapper.wrapString(""), Cons.cons(StringWrapper.wrapString("systems"), Cons.cons(StringWrapper.wrapString(Stella.concatenateFileNames("sources", Cons.cons(StringWrapper.wrapString("systems"), Stella.NIL))), Stella.NIL))));

      { StringWrapper dir = null;
        Cons iter000 = Stella.buildStellaSystemsPath();

        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          dir = ((StringWrapper)(iter000.value));
          if ((!Stella.blankStringP(dir.wrapperValue)) &&
              Stella.probeDirectoryP(dir.wrapperValue)) {
            { Stella_Object subdir = null;
              Cons iter001 = relativesystemdirs;

              for (;!(iter001 == Stella.NIL); iter001 = iter001.rest) {
                subdir = iter001.value;
                systemfile = Stella.concatenateFileNames(dir.wrapperValue, Cons.cons(StringWrapper.wrapString(((StringWrapper)(subdir)).wrapperValue), Cons.cons(StringWrapper.wrapString(systemfilename), Stella.NIL)));
                if (Stella.probeFileP(systemfile)) {
                  return (systemfile);
                }
              }
            }
  ...
  /** Given a system definition file <code>sysdeffile</code> try to determine the root directory
   * of the STELLA installation containing this system by looking for top-level native directories.
   * @param sysdeffile
   * @return String
   */
  public static String findSystemRootDirectoryFromFile(String sysdeffile) {
    { String directory = Stella.fileNameDirectory(sysdeffile);
      ...
      { int level = Stella.NULL_INTEGER;
        ...
        for (;iter000 <= upperBound000; iter000 = iter000 + 1) {
          level = iter000;
          parent = Stella.directoryParentDirectory(directory, level);
          if (Stella.topLevelStellaSystemDirectoryP(parent)) {
            return (parent);
          }
        }
      }
   ...
   * look for a system definition file for <code>name</code> in standard locations and try to load it.
   * If no matching system could be found or loaded and <code>errorP</code> is true, raise an error,
   * otherwise, simply return NULL.
   * @param name
   * @param errorP
   * @return SystemDefinition
   */
  public static SystemDefinition getSystemDefinition(String name, boolean errorP) {
    { SystemDefinition value000 = null;
      ...
      { SystemDefinition system = value000;
        ...
        if (system == null) {
          { String systemfile = Stella.findSystemDefinitionFile(name);

            if (systemfile == null) {
              if (errorP) {
                { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();

                  stream000.nativeStream.print("Cannot define system `" + name + "' since its system definition file cannot be found");
                  throw ((StellaException)(StellaException.newStellaException(stream000.theStringReader()).fillInStackTrace()));
                }
              }
              return (null);
            }
            Stella.loadFile(systemfile);
            ...
            if ((system == null) &&
              ...
              { OutputStringStream stream001 = OutputStringStream.newOutputStringStream();
                ...
                stream001.nativeStream.print("Cannot find a system definition for system `" + name + "' within file `" + systemfile + "'");
                throw ((StellaException)(StellaException.newStellaException(stream001.theStringReader()).fillInStackTrace()));
              }
            }
          }
  ...
  public static void cleanSystem(String systemname) {
    { SystemDefinition system = Stella.getSystemDefinition(systemname, true);
   ...
   * <p>
   * <code>CrecursiveP</code> (default false): if true, perform <code>makeSystem</code> with the provided
   * options on <code>systemname</code> as well as all its required systems and so on.  Required
   * systems will be processed first.  Note that even without this option, any required
   * systems that have not yet been loaded or started up will also be processed, since
   * that is assumed when loading <code>systemname</code> and supporting modules from a definition file.
  ...
  public static boolean makeSystem(String systemname, Cons languageAoptions) {
    { Cons options = languageAoptions;
      ...
      { PropertyList theoptions = Stella_Object.parseOptions(options.rest, Cons.list$(Cons.cons(Stella.KWD_TWO_PASSp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_DEVELOPMENT_SETTINGSp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_PRODUCTION_SETTINGSp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_FORCE_TRANSLATIONp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_FORCE_RECOMPILATIONp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_LOAD_SYSTEMp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_STARTUPp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_RECURSIVEp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_LANGUAGE, Cons.cons(Stella.SGT_STELLA_KEYWORD, Cons.cons(Stella.KWD_ACTION, Cons.cons(Stella.SGT_STELLA_KEYWORD, Cons.cons(Stella.KWD_ROOT_SOURCE_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_ROOT_NATIVE_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_ROOT_BINARY_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_PROCESSED, Cons.cons(Stella.SGT_STELLA_LIST, Cons.cons(Stella.NIL, Stella.NIL)))))))))))))))))))))))))))))), true, false);
        Keyword language = ((Keyword)(theoptions.lookupWithDefault(Stella.KWD_LANGUAGE, options.value)));
        boolean twopassP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_TWO_PASSp, ((!Stella.systemLoadedOrStartedUpP(systemname)) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER)))));
        boolean productionsettingsP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_PRODUCTION_SETTINGSp, Stella.TRUE_WRAPPER))));
        boolean developmentsettingsP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_DEVELOPMENT_SETTINGSp, ((!productionsettingsP) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER)))));
        boolean forcetranslationP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_FORCE_TRANSLATIONp, Stella.FALSE_WRAPPER))));
        boolean forcerecompilationP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_FORCE_RECOMPILATIONp, Stella.FALSE_WRAPPER))));
        boolean loadsystemP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_LOAD_SYSTEMp, ((language == Stella.KWD_COMMON_LISP) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER)))));
        boolean recursiveP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_RECURSIVEp, Stella.FALSE_WRAPPER))));
        List processed = ((List)(theoptions.lookupWithDefault(Stella.KWD_PROCESSED, List.list(Stella.NIL))));
        boolean startupsystemP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_STARTUPp, ((language == Stella.KWD_COMMON_LISP) ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER)))));
        Stella_Object action = theoptions.lookupWithDefault(Stella.KWD_ACTION, Stella.KWD_MAKE_SYSTEM);
            ...
            { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
              ...
              try {
                ...
                Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$, ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).directory);
                {
                  ...
                  if (recursiveP &&
                    ...
                    { StringWrapper reqsys = null;
                      ...
                      for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
                        reqsys = ((StringWrapper)(iter000.value));
                        if (!processed.memberP(reqsys)) {
                          Stella.STANDARD_OUTPUT.nativeStream.println("Making required system `" + StringWrapper.unwrapString(reqsys) + "'");
                          Stella.makeSystem(reqsys.wrapperValue, Cons.cons(Stella.KWD_OPTIONS, Cons.cons(theoptions, Stella.NIL)));
                        }
                      }
                    }
                  }
                  ...
                  updatedsystemP = Stella.translateSystem(systemname, Cons.cons(language, Cons.cons(Stella.KWD_TWO_PASSp, Cons.cons((twopassP ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Cons.cons(Stella.KWD_FORCE_TRANSLATIONp, Cons.cons((forcetranslationP ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Cons.cons(Stella.KWD_DEVELOPMENT_SETTINGSp, Cons.cons((developmentsettingsP ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Cons.cons(Stella.KWD_RECURSIVEp, Cons.cons((recursiveP ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Cons.cons(Stella.KWD_PROCESSED, Cons.cons(theoptions.lookup(Stella.KWD_PROCESSED), Cons.cons(Stella.KWD_ROOT_SOURCE_DIRECTORY, Cons.cons(theoptions.lookup(Stella.KWD_ROOT_SOURCE_DIRECTORY), Cons.cons(Stella.KWD_ROOT_NATIVE_DIRECTORY, Cons.cons(theoptions.lookup(Stella.KWD_ROOT_NATIVE_DIRECTORY), Cons.cons(Stella.KWD_ROOT_BINARY_DIRECTORY, Cons.cons(theoptions.lookup(Stella.KWD_ROOT_BINARY_DIRECTORY), Stella.NIL))))))))))))))))));
                  if (loadsystemP &&
                      Stella.loadSystem(systemname, Cons.cons(language, Cons.cons(Stella.KWD_FORCE_RECOMPILATIONp, Cons.cons((forcerecompilationP ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Cons.cons(Stella.KWD_STARTUPp, Cons.cons((startupsystemP ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Cons.cons(Stella.KWD_RECURSIVEp, Cons.cons((recursiveP ? Stella.TRUE_WRAPPER : Stella.FALSE_WRAPPER), Cons.cons(Stella.KWD_PROCESSED, Cons.cons(theoptions.lookup(Stella.KWD_PROCESSED), Cons.cons(Stella.KWD_ROOT_SOURCE_DIRECTORY, Cons.cons(theoptions.lookup(Stella.KWD_ROOT_SOURCE_DIRECTORY), Cons.cons(Stella.KWD_ROOT_NATIVE_DIRECTORY, Cons.cons(theoptions.lookup(Stella.KWD_ROOT_NATIVE_DIRECTORY), Cons.cons(Stella.KWD_ROOT_BINARY_DIRECTORY, Cons.cons(theoptions.lookup(Stella.KWD_ROOT_BINARY_DIRECTORY), Stella.NIL))))))))))))))))) {
                    updatedsystemP = true;
                  }
                }
  ...
  public static void loadPreprocessedFiles(String systemname) {
    if ((!Stella.runningAsLispP()) ||
        (Stella.getSystemDefinition(systemname, true).preprocessedFiles == null)) {
      return;
    }
    { Object old$Translatoroutputlanguage$000 = Stella.$TRANSLATOROUTPUTLANGUAGE$.get();
   ...
   * be called once all files have been loaded.
   * <p>
   * <code>CrecursiveP</code> (default false): if true, perform <code>loadSystem</code> with the provided
   * options on <code>systemname</code> as well as all its required systems and so on.  Required
   * systems will be processed first.  Note that even without this option, any required
   * systems that have not yet been loaded or started up will also be processed, since
   * that is assumed when loading <code>systemname</code> and supporting modules from a definition file.
  ...
  public static boolean loadSystem(String systemname, Cons languageAoptions) {
    { Cons options = languageAoptions;
      ...
      { PropertyList theoptions = Stella_Object.parseOptions(options.rest, Cons.list$(Cons.cons(Stella.KWD_FORCE_RECOMPILATIONp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_STARTUPp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_RECURSIVEp, Cons.cons(Stella.SGT_STELLA_BOOLEAN, Cons.cons(Stella.KWD_LANGUAGE, Cons.cons(Stella.SGT_STELLA_KEYWORD, Cons.cons(Stella.KWD_ACTION, Cons.cons(Stella.SGT_STELLA_KEYWORD, Cons.cons(Stella.KWD_ROOT_SOURCE_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_ROOT_NATIVE_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_ROOT_BINARY_DIRECTORY, Cons.cons(Stella.SGT_STELLA_FILE_NAME, Cons.cons(Stella.KWD_PROCESSED, Cons.cons(Stella.SGT_STELLA_LIST, Cons.cons(Stella.NIL, Stella.NIL)))))))))))))))))))), true, true);
        Keyword language = ((Keyword)(theoptions.lookupWithDefault(Stella.KWD_LANGUAGE, options.value)));
        boolean forcerecompilationP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_FORCE_RECOMPILATIONp, Stella.FALSE_WRAPPER))));
        boolean startupsystemP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_STARTUPp, Stella.TRUE_WRAPPER))));
        boolean recursiveP = BooleanWrapper.coerceWrappedBooleanToBoolean(((BooleanWrapper)(theoptions.lookupWithDefault(Stella.KWD_RECURSIVEp, Stella.FALSE_WRAPPER))));
        List processed = ((List)(theoptions.lookupWithDefault(Stella.KWD_PROCESSED, List.list(Stella.NIL))));
        Stella_Object action = theoptions.lookupWithDefault(Stella.KWD_ACTION, Stella.KWD_LOAD_SYSTEM);
                  ...
                  if (recursiveP &&
                    ...
                    { StringWrapper reqsys = null;
                      ...
                      for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
                        reqsys = ((StringWrapper)(iter000.value));
                        if (!processed.memberP(reqsys)) {
                          Stella.STANDARD_OUTPUT.nativeStream.println("Loading required system `" + StringWrapper.unwrapString(reqsys) + "'");
                          Stella.loadSystem(reqsys.wrapperValue, Cons.cons(Stella.KWD_OPTIONS, Cons.cons(theoptions, Stella.NIL)));
                        }
                      }
                    }
                  }
...
;
  ...
  public static boolean systemStartupFileP(String file) {
    if (file == null) {
      file = ((String)(Stella.$CURRENTFILENAME$.get()));
    }
    return ((file != null) &&
...
;
  ...
  public static String cppGetNativeTopLevelSystemRoot(String systemname) {
    { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
      Object old$Currentsystemdefinitionsubdirectory$000 = Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$.get();
      ...
      try {
        ...
        Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$, ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).directory);
        {
          return (Stella.concatenateFileNames(Keyword.getRootDirectoryFromFileType(Stella.KWD_CPP), Cons.cons(StringWrapper.wrapString(Keyword.getLanguageSubdirectoryFromFileType(Stella.KWD_CPP)), Stella.NIL)));
        }
  ...
  public static String cppRelativizeHeaderFile(String headerfile, String systemname) {
    { String headerroot = Stella.fileNameAsDirectory(Stella.cppGetNativeTopLevelSystemRoot(systemname));

      return (Stella.relativizeFileName(headerfile, headerroot));
    }
  }
  ...
  public static void cppOutputAllUnitsToFile(String filename) {
    { String codeoutputfile = Stella.makeFileName(filename, Stella.KWD_CPP_CODE, false);
      ...
      { OutputFileStream codeoutputstream = null;
        ...
        try {
          codeoutputstream = Stella.openOutputFile(codeoutputfile, Cons.cons(Stella.KWD_IF_NOT_EXISTS, Cons.cons(Stella.KWD_CREATE_PATH, Stella.NIL)));
          { OutputFileStream headeroutputstream = null;

            try {
              headeroutputstream = Stella.openOutputFile(headeroutputfile, Cons.cons(Stella.KWD_IF_NOT_EXISTS, Cons.cons(Stella.KWD_CREATE_PATH, Stella.NIL)));
  ...
  public static String cppYieldStellaRootDirectory() {
    { String systemsroot = Stella.cppYieldSystemsRootDirectory();
      ...
      { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
        ...
        try {
          Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITION$, Stella.getSystemDefinition("STELLA", true));
          Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$, ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).directory);
          {
        ...
        if (system.requiredSystems != null) {
          { StringWrapper reqsys = null;
            ...
            for (;!(iter001 == Stella.NIL); iter001 = iter001.rest) {
              ...
              requiredsystemdirs.nativeStream.print(Stella.getSystemDefinition(reqsys.wrapperValue, true).directory + " ");
            }
          }
          { StringWrapper reqsys = null;
    ...
    { InputFileStream in = null;
      ...
      try {
        ...
        { OutputFileStream out = null;
          ...
          try {
            out = Stella.openOutputFile(outputfile, Cons.cons(Stella.KWD_IF_NOT_EXISTS, Cons.cons(Stella.KWD_CREATE_PATH, Stella.NIL)));
            {
...
;
          ...
          { Object old$Module$000 = Stella.$MODULE$.get();
            ...
            try {
              ...
              { OutputFileStream classoutputstream = null;
                ...
                try {
                  classoutputstream = Stella.openOutputFile(classoutputfile, Cons.cons(Stella.KWD_IF_NOT_EXISTS, Cons.cons(Stella.KWD_CREATE_PATH, Stella.NIL)));
                  if (classunit != null) {
  ...
  public static void javaOutputSystemSpecificFiles() {
    if (Stella.$JAVA_BUILD_METHOD$ == Stella.KWD_MAVEN) {
      Stella.javaOutputSystemMavenFiles();
    }
    else {
    }
  }
  ...
  public static String javaGetSystemMavenTemplateFile() {
    { String pomfile = Stella.makeFileName("pom", Stella.KWD_STELLA, true);
      String templatefile = Stella.fileNameWithoutExtension(pomfile) + ".xml.in";
      ...
      if (!(Stella.probeFileP(templatefile))) {
        { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
          ...
          try {
            ...
            Native.setSpecial(Stella.$CURRENTSYSTEMDEFINITIONSUBDIRECTORY$, ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get())).directory);
            {
              pomfile = Stella.makeFileName("pom", Stella.KWD_STELLA, true);
              templatefile = Stella.fileNameWithoutExtension(pomfile) + ".xml-default.in";
            }
  ...
  public static String javaGetSystemParentMavenTemplateFile() {
    { String pomfile = Stella.makeFileName("pom", Stella.KWD_STELLA, true);
      String templatefile = Stella.fileNameWithoutExtension(pomfile) + ".xml.parent.in";
      ...
      if (!(Stella.probeFileP(templatefile))) {
        { Object old$Currentsystemdefinition$000 = Stella.$CURRENTSYSTEMDEFINITION$.get();
          ...
          try {
            ...
            {
              pomfile = Stella.makeFileName("pom", Stella.KWD_STELLA, true);
              templatefile = Stella.fileNameWithoutExtension(pomfile) + ".xml.parent-default.in";
            }
  ...
  public static void substituteTemplateVariablesToMavenFile(String templatefile, String outputfile, KeyValueList variables) {
    { InputFileStream in = null;
  ...
  public static void javaOutputSystemMavenFiles() {
    { SystemDefinition system = ((SystemDefinition)(Stella.$CURRENTSYSTEMDEFINITION$.get()));
      String templatefile = Stella.javaGetSystemMavenTemplateFile();
      String parenttemplatefile = Stella.javaGetSystemParentMavenTemplateFile();
      KeyValueList variables = KeyValueList.newKeyValueList();
      OutputStringStream requiredsystems = OutputStringStream.newOutputStringStream();
      OutputStringStream childsystems = OutputStringStream.newOutputStringStream();
      String nativeroot = Stella.rootNativeDirectory();
      String languagesubdir = Keyword.getLanguageSubdirectoryFromFileType(Stella.KWD_JAVA);
      String languagedirectory = Stella.concatenateFileNames(nativeroot, Cons.cons(StringWrapper.wrapString(languagesubdir), Stella.NIL));
      String systemsubdir = Keyword.getSystemSubdirectoryFromFileType(Stella.KWD_JAVA);
      String pomfile = Stella.concatenateFileNames(languagedirectory, Cons.cons(StringWrapper.wrapString(systemsubdir), Cons.cons(StringWrapper.wrapString("pom.xml"), Stella.NIL)));
      String parentpomfile = Stella.concatenateFileNames(languagedirectory, Cons.cons(StringWrapper.wrapString("pom.xml"), Stella.NIL));
      boolean firstlineP = true;

      variables.insertAt(StringWrapper.wrapString("SYSTEM-NAME"), StringWrapper.wrapString(system.name));
      variables.insertAt(StringWrapper.wrapString("SYSTEM-GROUP-NAME"), StringWrapper.wrapString(SystemDefinition.javaYieldSystemGroupName(system)));
      variables.insertAt(StringWrapper.wrapString("SYSTEM-VERSION"), StringWrapper.wrapString(SystemDefinition.javaYieldSystemVersion(system)));
      variables.insertAt(StringWrapper.wrapString("SYSTEM-PARENT-NAME"), StringWrapper.wrapString(SystemDefinition.javaYieldSystemParentName(system)));
      variables.insertAt(StringWrapper.wrapString("SYSTEM-PARENT-GROUP-NAME"), StringWrapper.wrapString("stella-parent-systems"));
      variables.insertAt(StringWrapper.wrapString("SYSTEM-PARENT-VERSION"), StringWrapper.wrapString(CalendarDate.dateToVersionString(CalendarDate.makeCurrentDateTime(), Stella.KWD_MINUTES)));
      if (system.requiredSystems != null) {
        firstlineP = true;
        { StringWrapper reqsys = null;
          Cons iter000 = system.requiredSystems;
          ...
          for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
            reqsys = ((StringWrapper)(iter000.value));
            system = Stella.getSystemDefinition(reqsys.wrapperValue, true);
            if (!(firstlineP)) {
              {
                requiredsystems.nativeStream.println();
                requiredsystems.nativeStream.print("    ");
              }
;
            }
            requiredsystems.nativeStream.println("<dependency>");
            requiredsystems.nativeStream.println("      <groupId>" + SystemDefinition.javaYieldSystemGroupName(system) + "</groupId>");
            requiredsystems.nativeStream.println("      <artifactId>" + system.name + "</artifactId>");
            requiredsystems.nativeStream.println("      <version>[0,10000]</version>");
            requiredsystems.nativeStream.print("    </dependency>");
            firstlineP = false;
          }
        }
      }
      variables.insertAt(StringWrapper.wrapString("REQUIRED-SYSTEMS"), StringWrapper.wrapString(requiredsystems.theStringReader()));
      Stella.substituteTemplateVariablesToMavenFile(templatefile, pomfile, variables);
      firstlineP = true;
      { StringWrapper dir = null;
        Cons iter001 = Stella.listDirectoryFiles(languagedirectory);

        for (;!(iter001 == Stella.NIL); iter001 = iter001.rest) {
          dir = ((StringWrapper)(iter001.value));
          if (Stella.probeFileP(Stella.concatenateFileNames(languagedirectory, Cons.cons(StringWrapper.wrapString(dir.wrapperValue), Cons.cons(StringWrapper.wrapString("pom.xml"), Stella.NIL))))) {
            if (!(firstlineP)) {
              {
                childsystems.nativeStream.println();
                childsystems.nativeStream.print("    ");
              }
;
            }
            childsystems.nativeStream.print("<module>" + StringWrapper.unwrapString(dir) + "</module>");
            firstlineP = false;
          }
        }
      }
      variables.insertAt(StringWrapper.wrapString("CHILD-SYSTEMS"), StringWrapper.wrapString(childsystems.theStringReader()));
      Stella.substituteTemplateVariablesToMavenFile(parenttemplatefile, parentpomfile, variables);
    }
  }
...
;
  ...
  public static String stellaVersionString() {
    return ("STELLA " + Stella.$STELLA_VERSION$);
  }
