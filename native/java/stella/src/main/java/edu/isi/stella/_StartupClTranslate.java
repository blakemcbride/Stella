  ...
  static void helpStartupClTranslate2() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (CL-TRANSLATE-ATOMIC-TREE OBJECT) ((TREE OBJECT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Object", "clTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CL-TRANSLATE-ATOMIC-TREE OBJECT) ((TREE FLOAT-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.FloatWrapper", "clTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CL-TRANSLATE-ATOMIC-TREE OBJECT) ((TREE SYMBOL)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Symbol", "clTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CL-TRANSLATE-ATOMIC-TREE OBJECT) ((TREE KEYWORD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Keyword", "clTranslateAtomicTree", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (CL-TRANSLATE-ATOMIC-TREE OBJECT) ((TREE SURROGATE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Surrogate", "clTranslateAtomicTree", new java.lang.Class [] {})), null);
      ...
      Stella.defineFunctionObject("CL-TRANSLATE-CALL-SUPER-METHOD-TREE", "(DEFUN (CL-TRANSLATE-CALL-SUPER-METHOD-TREE OBJECT) ((TREE CONS)))", Native.find_java_method("edu.isi.stella.Cons", "clTranslateCallSuperMethodTree", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")}), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CL-TRUE-STRING-WRAPPER* VERBATIM-STRING-WRAPPER (NEW VERBATIM-STRING-WRAPPER :WRAPPER-VALUE \"CL:T\"))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CL-FALSE-STRING-WRAPPER* VERBATIM-STRING-WRAPPER (NEW VERBATIM-STRING-WRAPPER :WRAPPER-VALUE \"CL:NIL\"))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CL-OPERATOR-TABLE* KEY-VALUE-LIST NULL :DOCUMENTATION \"Mapping from STELLA operators to Common-Lisp operators.\")", null);
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *NEEDEXPLICITRETURN?* BOOLEAN FALSE)", null);
        }
