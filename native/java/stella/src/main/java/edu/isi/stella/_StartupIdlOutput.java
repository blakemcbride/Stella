    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((OBJECT OBJECT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella_Object", "idlOutputLiteral", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((STRING STRING)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Stella", "string_idlOutputLiteral", new java.lang.Class [] {Native.find_java_class("java.lang.String")})), null);
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((STRING STRING-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.StringWrapper", "idlOutputLiteral", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((STRING MUTABLE-STRING-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.MutableStringWrapper", "idlOutputLiteral", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((TREE QUOTED-EXPRESSION)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.QuotedExpression", "idlOutputLiteral", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((SYMBOL SYMBOL)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Symbol", "idlOutputLiteral", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((SURROGATE SURROGATE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Surrogate", "idlOutputLiteral", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD IDL-OUTPUT-LITERAL ((KEYWORD KEYWORD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.Keyword", "idlOutputLiteral", new java.lang.Class [] {})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *IDL-INDENT-CHARS* INTEGER 0)", null);
        }
