...
;
  ...
  public static void defineInlineMethodCode(Surrogate classtype, Symbol methodname, CodeWrapper code, CodeWrapper wrappercode) {
    wrappercode = wrappercode;
    { MethodSlot method = ((MethodSlot)(Stella_Class.lookupSlot(((Stella_Class)(classtype.surrogateValue)), methodname)));
