...
public class TranslationUnit extends StandardObject {
  ...
  public static Cons cppTranslateDefineGlobalVariableUnit(TranslationUnit unit) {
    { GlobalVariable global = ((GlobalVariable)(unit.theObject));
      ...
      StringWrapper variablename = GlobalVariable.cppTranslateGlobalVariableName(global);
  ...
  public static void cppOutputMain(TranslationUnit unit) {
    { OutputFileStream out = null;
      ...
      try {
        out = Stella.openOutputFile(Stella.cppYieldMainFileName(), Cons.cons(Stella.KWD_IF_NOT_EXISTS, Cons.cons(Stella.KWD_CREATE_PATH, Stella.NIL)));
...
;
  ...
  public static void walkGlobalUnit(TranslationUnit unit) {
    { GlobalVariable global = ((GlobalVariable)(unit.theObject));
      ...
      if (!(unit.auxiliaryP)) {
        Cons.walkAuxiliaryTree(Cons.list$(Cons.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_DEFINE_GLOBAL_VARIABLE_OBJECT, Cons.cons(StringWrapper.wrapString(stringifiedsource), Cons.cons(Cons.cons(((((Keyword)(Stella.$TRANSLATOROUTPUTLANGUAGE$.get())) == Stella.KWD_CPP) ? ((StandardObject)(Cons.list$(Cons.cons(Stella.SYM_STELLA_VERBATIM, Cons.cons(Stella.KWD_CPP, Cons.cons(GlobalVariable.cppTranslateGlobalVariableAddress(global), Cons.cons(Stella.NIL, Stella.NIL))))))) : ((StandardObject)(Stella.SYM_STELLA_NULL))), Stella.NIL), Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL)))));
      }
    }
  }
...
;
            ...
            storecodepointerP = MethodSlot.methodStoresNativeCodePointerP(method);
            ...
            if (MethodSlot.methodNeedsCCallableWrapperP(method) &&
              ...
              Cons.walkAuxiliaryTree(Cons.list$(Cons.cons(Stella.SYM_STELLA_STARTUP_TIME_PROGN, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_SETF, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_C_CALLABLE_WRAPPER_CODE, Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_LOOKUP_FUNCTION_BY_NAME, Cons.cons(StringWrapper.wrapString(name.symbolName), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Stella.NIL, Stella.NIL)))), Cons.cons(Cons.list$(Cons.cons(Stella.SYM_STELLA_THE_CODE, Cons.cons(Stella.KWD_FUNCTION, Cons.cons(MethodSlot.yieldCCallableWrapperName(method), Cons.cons(Stella.NIL, Stella.NIL))))), Cons.cons(Stella.NIL, Stella.NIL))))), Cons.cons(Stella.NIL, Stella.NIL)))));
            }
          }
        }
