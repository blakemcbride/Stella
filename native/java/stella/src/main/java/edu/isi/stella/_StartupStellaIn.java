    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("DEFINE-METHOD-OBJECT", "(DEFUN DEFINE-METHOD-OBJECT ((DEFINITION STRING) (CODE CODE-WRAPPER) (WRAPPERCODE CODE-WRAPPER)))", Native.find_java_method("edu.isi.stella.Stella", "defineMethodObject", new java.lang.Class [] {Native.find_java_class("java.lang.String"), Native.find_java_class("edu.isi.stella.CodeWrapper"), Native.find_java_class("edu.isi.stella.CodeWrapper")}), null);
          Stella.defineFunctionObject("DEFINE-INLINE-METHOD-CODE", "(DEFUN DEFINE-INLINE-METHOD-CODE ((CLASSTYPE SURROGATE) (METHODNAME SYMBOL) (CODE CODE-WRAPPER) (WRAPPERCODE CODE-WRAPPER)))", Native.find_java_method("edu.isi.stella.Surrogate", "defineInlineMethodCode", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Surrogate"), Native.find_java_class("edu.isi.stella.Symbol"), Native.find_java_class("edu.isi.stella.CodeWrapper"), Native.find_java_class("edu.isi.stella.CodeWrapper")}), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *REDEFINE-IDENTICAL-CLASSES?* BOOLEAN FALSE :DOCUMENTATION \"If `true', always redefine classes, even if an\n                  identical class exists\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *UNSUPPORTED-EXTERNAL-SLOT-OPTIONS* (LIST OF KEYWORD) (LIST :ALLOCATION :INITIALLY :CONTEXT-SENSITIVE? :HARDWIRED?))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DEFAULT-OPTION-HANDLER* METHOD-SLOT NULL)", null);
