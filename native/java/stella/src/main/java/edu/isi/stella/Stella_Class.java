    ...
    { boolean foundP000 = false;
      ...
      { Slot slot = null;
        ...
        loop000 : while (iter000.nextP()) {
          slot = ((Slot)(iter000.value));
          if (Stella_Object.storageSlotP(slot) &&
              StorageSlot.genericSlotReaderP(((StorageSlot)(slot)), renamed_Class)) {
            foundP000 = true;
            break loop000;
          }
        }
...
;
  ...
  /** Returns an iterator that generates all proper super classes of <code>self</code>.
   * @return Iterator
   */
  ...
  /** Returns an iterator that generates all direct super classes of <code>self</code>.
   * @return Iterator
   */
...
;
  ...
  public static Surrogate classSurrogate(Stella_Class renamed_Class) {
