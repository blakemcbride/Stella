    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineFunctionObject("READ-SLOT-VALUE", "(DEFUN (READ-SLOT-VALUE OBJECT) ((SELF STANDARD-OBJECT) (SLOT STORAGE-SLOT)) :DOCUMENTATION \"Read and return a (possibly wrapped) value for the slot `slot' on `self'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.StandardObject", "readSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.StandardObject"), Native.find_java_class("edu.isi.stella.StorageSlot")}), null);
          Stella.defineFunctionObject("WRITE-SLOT-VALUE", "(DEFUN (WRITE-SLOT-VALUE OBJECT) ((SELF STANDARD-OBJECT) (SLOT STORAGE-SLOT) (VALUE OBJECT)) :DOCUMENTATION \"Write a (possibly wrapped) `value' for the slot `slot' on `self'.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.StandardObject", "writeSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.StandardObject"), Native.find_java_class("edu.isi.stella.StorageSlot"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
          Stella.defineFunctionObject("PUT-SLOT-VALUE", "(DEFUN (PUT-SLOT-VALUE OBJECT) ((SELF STANDARD-OBJECT) (SLOT STORAGE-SLOT) (VALUE OBJECT)) :DOCUMENTATION \"Set or insert `value' for the slot `slot' on `self'.\nCAUTION: Assumes that collection-valued slots are non-null.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.StandardObject", "putSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.StandardObject"), Native.find_java_class("edu.isi.stella.StorageSlot"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
          Stella.defineFunctionObject("DROP-SLOT-VALUE", "(DEFUN DROP-SLOT-VALUE ((SELF STANDARD-OBJECT) (SLOT STORAGE-SLOT) (VALUE OBJECT)) :DOCUMENTATION \"Clear or remove `value' for the slot `slot' on `self'.\nCAUTION: Assumes that collection-valued slots are non-null.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.StandardObject", "dropSlotValue", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.StandardObject"), Native.find_java_class("edu.isi.stella.StorageSlot"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
          Stella.defineFunctionObject("CPP-FIND-NATIVE-SLOT-VALUE-OFFSET", "(DEFUN (CPP-FIND-NATIVE-SLOT-VALUE-OFFSET INTEGER) ((SELF STANDARD-OBJECT) (SLOT STORAGE-SLOT)) :DOCUMENTATION \"Dynamically determine the byte offset where the native value for `slot' starts in `self'.\nThis basically performs the function of the C++ macro `offsetof' but does it dynamically.  Of course, it\nrelies on a working `read/write-slot-value' mechanism and we currently primarily use this for the Python API.\nThis basically writes value changes of `slot' to determine a byte position where a change occurred and\nthen restores the original value (which can be NULL).  This handles all native OBJECT and LITERAL slots\nbut does not handle special slots such as `dynamic-slots' or hardwired slots or other non-standard types.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.stella.StandardObject", "cppFindNativeSlotValueOffset", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.StandardObject"), Native.find_java_class("edu.isi.stella.StorageSlot")}), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD INSERT ((SELF ACTIVE-LIST) (VALUE (LIKE (ANY-VALUE SELF)))))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.ActiveList", "insert", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")})), null);
          Stella.defineMethodObject("(DEFMETHOD INSERT ((SELF ACTIVE-SET) (VALUE (LIKE (ANY-VALUE SELF)))))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.ActiveSet", "insert", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")})), null);
          Stella.defineMethodObject("(DEFMETHOD (REMOVE ACTIVE-LIST) ((SELF ACTIVE-LIST) (VALUE (LIKE (ANY-VALUE SELF)))))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.ActiveList", "remove", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")})), null);
          Stella.defineMethodObject("(DEFMETHOD (REMOVE ACTIVE-SET) ((SELF ACTIVE-SET) (VALUE (LIKE (ANY-VALUE SELF)))))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.stella.ActiveSet", "remove", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DEMONS-TABLE* STRING-HASH-TABLE (NEW STRING-HASH-TABLE) :DOCUMENTATION \"Table containing all active and inactive demons, indexed\non their names.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CONSTRUCTOR-DEMONS* (LIST OF DEMON) NULL :DOCUMENTATION \"These demons trigger every time an active instance is created.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DESTRUCTOR-DEMONS* (LIST OF DEMON) NULL :DOCUMENTATION \"These demons trigger every time an active instance is destroyed.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ALL-SLOTS-DEMONS* (LIST OF DEMON) NULL :DOCUMENTATION \"These demons trigger every time a slot value is modified.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ALL-SLOTS-GUARD-DEMONS* (LIST OF DEMON) NULL :DOCUMENTATION \"These demons trigger every time a slot value is modified, and\ncancel slot update when they return `false'.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CHANGE-MODULE-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST called by `in-module', applied to a\n`module' argument.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CLEAR-MODULE-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST called by `clear-module', applied to a\n`module' argument.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DESTROY-CONTEXT-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST called by `clear-module', applied to a\n`module' argument.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *REDEFINE-RELATION-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST is called by `undefine-old-class'.  Each\nhook function is passed a LIST of two RELATION objects; the first is the\nold relation object and the second is the new (redefined) relation object.\nThe hook functions are expected to copy/transfer information from the\nold relation to the new relation so that it won't be lost.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *FINALIZE-RELATION-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST is called by `finalize-one-class'\nand `finalize-local-slot', applied to a RELATION argument.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *BLOCK-NATIVE-CLASS-CREATION-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST called by `create-native-class', applied to\na STELLA class.  Return value of TRUE blocks creation.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *STELLA-EXIT-HOOKS* HOOK-LIST (NEW HOOK-LIST) :DOCUMENTATION \"HOOK-LIST of cleanup functions to be called upon exit from\nthe STELLA application or any point where such cleanup is required.  The\nfunctions on this list should be highly tolerant of their invocation environment\nand not assume any special state; that is, they should be no-ops if no special\ncleanup is required.\")", null);
        }
