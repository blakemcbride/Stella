...
(CL:DEFUN METHOD-STORES-NATIVE-CODE-POINTER? (METHOD)
  (CL:LET* ((NAME (%SLOT-NAME METHOD)) (OWNER (%SLOT-OWNER METHOD)))
   (CL:COND
    ((%ABSTRACT? METHOD)
    ...
    (CL:COND
     ...
     ((CL:OR
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
         SYM-WALK-STELLA-SLOT-AUXILIARY? FALSE-WRAPPER))
       (CL:AND (%AUXILIARY? UNIT) (CL:NOT (INLINE-METHOD? METHOD))))
      (CL:SETQ CREATEMETHODOBJECT? CL:NIL)
        ...
        (LIST* SYM-WALK-STELLA-SETF
         (LIST* SYM-WALK-STELLA-C-CALLABLE-WRAPPER-CODE
          (LIST* SYM-WALK-STELLA-LOOKUP-FUNCTION-BY-NAME
           (WRAP-STRING (%SYMBOL-NAME NAME)) NIL)
          NIL)
     ...
     (CL:WHEN (CL:NOT (SYMBOL? (%%VALUE (%%REST (%%REST TREE)))))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Illegal function name: `" (%%VALUE (%%REST (%%REST TREE)))
         "'." EOL)))
      (CL:RETURN-FROM WALK-THE-CODE-TREE
       (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-FUNCTION-CODE)))
     (CL:WHEN
     ...
     (CL:WHEN
      ...
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Illegal method class: `" (%%VALUE (%%REST (%%REST TREE)))
         "'." EOL)))
      (CL:RETURN-FROM WALK-THE-CODE-TREE
       (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-METHOD-CODE)))
     (CL:WHEN (CL:NOT (SYMBOL? (FOURTH TREE)))
      (CL:LET* ((*PRINTREADABLY?* CL:T))
       ...
       (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
        (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
        (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
         " Illegal method name: `" (FOURTH TREE) "'." EOL)))
      (CL:RETURN-FROM WALK-THE-CODE-TREE
       (WALK-DONT-CALL-ME-TREE TREE SGT-WALK-STELLA-METHOD-CODE)))
      ...
      (CL:IF (CL:EQ (%SURROGATE-VALUE TYPE) NULL)
       ...
       (CL:COND
        ((CL:OR (CL:EQ *TRANSLATOROUTPUTLANGUAGE* KWD-WALK-CPP)
         ...
         (CL:LET*
          ((METHOD
            (LOOKUP-SLOT (%SURROGATE-VALUE TYPE) (FOURTH TREE))))
          (CL:WHEN
           (CL:AND (CL:NOT (CL:EQ METHOD NULL))
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:OR (CL:EQ ENCLOSINGMETHOD NULL)
      (%METHOD-FUNCTION? ENCLOSINGMETHOD))
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " call-super-method not called within a method: `"
        (DE-UGLIFY-PARSE-TREE TREE) "'." EOL))))
    ((CL:NOT
     ...
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       ...
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        ...
        (DE-UGLIFY-PARSE-TREE TREE) "'." EOL))))
    ((CL:EQ (%SLOT-DIRECT-EQUIVALENT ENCLOSINGMETHOD) NULL)
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
      (SIGNAL-TRANSLATION-ERROR)
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " call-super-method: no super method available for: `"
        (DE-UGLIFY-PARSE-TREE *METHODBEINGWALKED*) "'." EOL))))
    (CL:T (FIRST-SETTER TREE (%SLOT-NAME ENCLOSINGMETHOD))
     (CL:LET* ((VALUE-000 NULL) (VALUE-001 NULL))
      (CL:MULTIPLE-VALUE-SETQ (VALUE-000 VALUE-001)
       (WALK-CALL-SLOT-TREE TREE))
     ...
     (CL:LET* ((*PRINTREADABLY?* CL:T))
      ...
      (CL:WHEN (CL:NOT (SUPPRESS-WARNINGS?))
       (PRINT-ERROR-CONTEXT ">> ERROR: " STANDARD-ERROR)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR) EOL
        " Illegal call-super-method call or context: `"
        (DE-UGLIFY-PARSE-TREE TREE) "'." EOL)))))
   (CL:RETURN-FROM WALK-CALL-SUPER-METHOD-TREE
...
(CL:DEFUN YIELD-C-CALLABLE-WRAPPER-NAME (METHOD)
  (CL:LET*
   ((METHODNAME (%SLOT-NAME METHOD))
    (BASENAME (%SYMBOL-NAME METHODNAME))
    (PREFIX
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS METHOD)
   ...
   (CL:WHEN (CL:NOT (%METHOD-FUNCTION? METHOD))
    (CL:SETQ BASENAME
     (CONCATENATE (%SYMBOL-NAME (%SLOT-OWNER METHOD)) "-" BASENAME)))
      ...
      (LIST* KWD-WALK-DOCUMENTATION
       (WRAP-STRING
        (CONCATENATE "C-callable wrapper for `"
         (%WRAPPER-VALUE (CPP-TRANSLATE-METHOD-NAME METHOD CL:T))
         "'."))
...
(CL:DEFUN YIELD-FUNCTION-CPP-SIGNATURE (FUNCTION FIRSTARGTYPE QUALIFY?)
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ FIRSTARGTYPE NULL)
    (CL:SETQ FIRSTARGTYPE (%SLOT-OWNER FUNCTION)))
   (CL:LET*
    ((RETURNTYPE
     ...
     (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
      ...
      (CL:LET*
       ...
       (CL:COND
        ...
        ((STARTS-WITH? (%WRAPPER-VALUE NAME) "_Return" 0)
  ...
  (CL:LET*
   ...
   (CL:LET* ((TUPLE NULL) (ITER-000 CPPSIGNATURE) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:SETQ NAME (%WRAPPER-VALUE (%%VALUE TUPLE)))
     (CL:SETQ TYPE (%WRAPPER-VALUE (%%VALUE (%%REST TUPLE))))
     (CL:SETQ STELLATYPE
...
(CL:DEFUN YIELD-METHOD-CPP-SIGNATURE (METHOD FIRSTARGTYPE QUALIFY?)
  (CL:LET*
   ...
   (CL:LET* ((SIG NULL) (TRANSNAME STELLA::NULL-STRING))
    ...
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETF (%METHOD-FUNCTION? METHOD) CL:T)
      (CL:SETQ SIG
       (YIELD-FUNCTION-CPP-SIGNATURE METHOD FIRSTARGTYPE QUALIFY?)))
     (CL:SETF (%METHOD-FUNCTION? METHOD) CL:NIL))
    (CL:SETQ TRANSNAME
     (%WRAPPER-VALUE (CPP-TRANSLATE-METHOD-NAME METHOD QUALIFY?)))
...
(CL:DEFUN YIELD-METHOD-C-SIGNATURE (METHOD FIRSTARGTYPE)
  (CL:LET*
   ...
   (FIRST-SETTER (%%VALUE SIG)
    (WRAP-STRING
     (REPLACE-SUBSTRINGS (%WRAPPER-VALUE CPPNAME) "_" "::")))
...
(CL:DEFUN YIELD-STORAGE-SLOT-CPP-SIGNATURE (SLOT FIRSTARGTYPE QUALIFY?)
  (CL:LET*
   ...
   (CL:DECLARE (CL:SPECIAL *MODULE* *CONTEXT*))
   (CL:WHEN (CL:EQ FIRSTARGTYPE NULL)
    (CL:SETQ FIRSTARGTYPE (%SLOT-OWNER SLOT)))
   (CL:LET*
...
(CL:DEFUN YIELD-STORAGE-SLOT-C-SIGNATURE (SLOT FIRSTARGTYPE)
  (CL:LET*
   ...
   (SECOND-SETTER (%%VALUE SIG)
    (WRAP-STRING (CPP-TYPE-TO-C-TYPE (%WRAPPER-VALUE CPPTYPE))))
  ...
  (CL:LET* ((SEP #\Tab) (SSIG (NEW-OUTPUT-STRING-STREAM)))
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (CL:> I 0) (%%PRINT-STREAM (%NATIVE-STREAM SSIG) SEP))
     (%%PRINT-STREAM (%NATIVE-STREAM SSIG)
...
(CL:DEFUN LOOKUP-METHOD-CODE-BY-NAME (QUALIFIEDNAME)
  ...
  (CL:LET* ((SLOT (LOOKUP-SLOT-BY-QUALIFIED-NAME QUALIFIEDNAME)))
   (CL:IF (METHOD-SLOT? SLOT)
    (CL:RETURN-FROM LOOKUP-METHOD-CODE-BY-NAME (%METHOD-CODE SLOT))
  ...
  (CL:LET* ((SLOT NULL) (CLASS NULL))
   ...
   (CL:IF (METHOD-SLOT? SLOT)
    (CL:RETURN-FROM LOOKUP-METHOD-CPP-SIGNATURE-BY-NAME
     (LIST-SIGNATURE-TO-STRING
      (YIELD-METHOD-CPP-SIGNATURE SLOT (%CLASS-TYPE CLASS) CL:T)))
    (CL:RETURN-FROM LOOKUP-METHOD-CPP-SIGNATURE-BY-NAME
     STELLA::NULL-STRING))))
  ...
  (CL:LET* ((SLOT NULL) (CLASS NULL))
   ...
   (CL:IF (METHOD-SLOT? SLOT)
    (CL:RETURN-FROM LOOKUP-METHOD-C-SIGNATURE-BY-NAME
     (LIST-SIGNATURE-TO-STRING
      (YIELD-METHOD-C-SIGNATURE SLOT (%CLASS-TYPE CLASS))))
    (CL:RETURN-FROM LOOKUP-METHOD-C-SIGNATURE-BY-NAME
     STELLA::NULL-STRING))))
  ...
  (CL:LET* ((SLOT NULL) (CLASS NULL))
   ...
   (CL:IF (STORAGE-SLOT? SLOT)
    (CL:RETURN-FROM LOOKUP-STORAGE-SLOT-CPP-SIGNATURE-BY-NAME
     (LIST-SIGNATURE-TO-STRING
      (YIELD-STORAGE-SLOT-CPP-SIGNATURE SLOT (%CLASS-TYPE CLASS)
       CL:T)))
    (CL:RETURN-FROM LOOKUP-STORAGE-SLOT-CPP-SIGNATURE-BY-NAME
     STELLA::NULL-STRING))))
  ...
  (CL:LET* ((SLOT NULL) (CLASS NULL))
   ...
   (CL:IF (STORAGE-SLOT? SLOT)
    (CL:RETURN-FROM LOOKUP-STORAGE-SLOT-C-SIGNATURE-BY-NAME
     (LIST-SIGNATURE-TO-STRING
      (YIELD-STORAGE-SLOT-C-SIGNATURE SLOT (%CLASS-TYPE CLASS))))
    (CL:RETURN-FROM LOOKUP-STORAGE-SLOT-C-SIGNATURE-BY-NAME
     STELLA::NULL-STRING))))
    ...
    (CL:COND
     ...
     (CL:T
      (CL:LET* ((STREAM-006 (NEW-OUTPUT-STRING-STREAM)))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-006) "While evaluating '"
        *EVALUATIONTREE*)
       (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-006) EOL "' inside '"
         *EVALUATIONPARENTTREE*))
       (%%PRINT-STREAM (%NATIVE-STREAM STREAM-006) "':" EOL)
      ...
      (CL:LET*
       ...
       (CL:LET* ((STREAM-007 (NEW-OUTPUT-STRING-STREAM)))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-007)
         "While evaluating '" *EVALUATIONTREE*)
        (CL:WHEN (CL:NOT (CL:EQ *EVALUATIONPARENTTREE* NULL))
         (%%PRINT-STREAM (%NATIVE-STREAM STREAM-007) EOL "' inside '"
          *EVALUATIONPARENTTREE*))
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-007) "':" EOL)
        (%%PRINT-STREAM (%NATIVE-STREAM STREAM-007)
