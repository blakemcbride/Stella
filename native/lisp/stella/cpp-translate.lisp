...
(CL:DEFVAR SYM-CPP-TRANSLATE-STELLA-SYS-CALL-SUPER-METHOD NULL)
...
;;; (DEFGLOBAL *CPP-OPERATOR-TABLE* ...)

(CL:DEFVAR *CPP-OPERATOR-TABLE* NULL
...
(CL:DEFUN CPP-LOOKUP-OPERATOR-TABLE (OPERATOR)
  (CL:LET*
   ((ENTRY (LOOKUP *CPP-OPERATOR-TABLE* OPERATOR)) (COPIEDENTRY NIL))
    ...
    (CL:PROGN
     ...
     (CL:LET* ((TEST-VALUE-000 (%%VALUE TREE)))
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000
         SYM-CPP-TRANSLATE-STELLA-SYS-CALL-SUPER-METHOD)
        (CL:RETURN-FROM CPP-TRANSLATE-A-TREE
         (CPP-TRANSLATE-SUPER-METHOD-CALL (%%REST TREE))))
       ((CL:EQ TEST-VALUE-000
        ...
        (CONS
         (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_CALL
          ...
          (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_ACTUALS
           (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
            (CPP-TRANSLATE-GLOBAL-VARIABLE-NAME VARIABLE) NIL)
           (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
...
(CL:DEFUN CPP-TRANSLATE-DEFINE-GLOBAL-VARIABLE-UNIT (UNIT)
  (CL:LET*
   ((GLOBAL (%THE-OBJECT UNIT))
    ...
    (VARIABLENAME (CPP-TRANSLATE-GLOBAL-VARIABLE-NAME GLOBAL)))
   (CL:COND
...
;;; (DEFUN (CPP-TRANSLATE-GLOBAL-VARIABLE-NAME STRING-WRAPPER) ...)

(CL:DEFUN CPP-TRANSLATE-GLOBAL-VARIABLE-NAME (GLOBAL)
  (CL:RETURN-FROM CPP-TRANSLATE-GLOBAL-VARIABLE-NAME
   (CPP-TRANSLATE-GLOBAL-NAME
    (CPP-FIXUP-NAME-SYMBOL (%VARIABLE-NAME GLOBAL)
     (HOME-MODULE GLOBAL)))))

;;; (DEFUN (CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS STRING-WRAPPER) ...)

(CL:DEFUN CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS (GLOBAL)
  (CL:RETURN-FROM CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS
   (WRAP-STRING
    (CONCATENATE "&"
     (%WRAPPER-VALUE (CPP-TRANSLATE-GLOBAL-VARIABLE-NAME GLOBAL))))))
...
(CL:DEFUN CPP-TRANSLATE-CASE-TREE (TREE)
  (CL:LET*
   ...
   (CL:LET* ((*CPPLOOPEXITACTIVE?* CL:T))
    (CL:DECLARE (CL:SPECIAL *CPPLOOPEXITACTIVE?*))
        ...
        (CL:PROGN
         (CL:IF
          (CL:EQ (%%VALUE CONDITION)
           SYM-CPP-TRANSLATE-STELLA-OTHERWISE)
...
;;; (DEFSPECIAL *CPPLOOPEXIT* ...)

(CL:DEFVAR *CPPLOOPEXIT* NULL)

;;; (DEFSPECIAL *CPPLOOPEXITACTIVE?* ...)

(CL:DEFVAR *CPPLOOPEXITACTIVE?* CL:NIL)

;;; (DEFUN (CPP-TRANSLATE-LOOP CONS) ...)

(CL:DEFUN CPP-TRANSLATE-LOOP (TREE)
  (CL:LET* ((*CPPLOOPEXIT* NULL))
   (CL:DECLARE (CL:SPECIAL *CPPLOOPEXIT*))
   (CL:LET*
    ((OTREE
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_LOOP
       (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_PROGN
        ...
        NIL)
       NIL)))
    (CL:WHEN (CL:NOT (CL:EQ *CPPLOOPEXIT* NULL))
     (CL:SETQ OTREE
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS OTREE
       (CONS
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_GOTO_LABEL
         (CPP-TRANSLATE-A-TREE *CPPLOOPEXIT*) NIL)
        NIL))))
    (CL:RETURN-FROM CPP-TRANSLATE-LOOP OTREE))))
      ...
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS OTREE
       (CONS
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_GOTO_LABEL
         (CPP-TRANSLATE-A-TREE *CPPLOOPEXIT*) NIL)
        NIL))))
    (CL:RETURN-FROM CPP-TRANSLATE-WHILE OTREE))))
...
(CL:DEFUN CPP-TRANSLATE-BREAK (TREE)
  (CL:COND
   ((CL:AND
     (CL:NOT (CL:EQ *CPPLOOPEXIT* SYM-CPP-TRANSLATE-STELLA-CPP_BREAK))
     *CPPLOOPEXITACTIVE?*)
    (CL:WHEN (CL:EQ *CPPLOOPEXIT* NULL)
     (CL:SETQ *CPPLOOPEXIT* (LOCAL-GENSYM "LOOP-EXIT")))
    (CL:RETURN-FROM CPP-TRANSLATE-BREAK
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_GOTO
      (CPP-TRANSLATE-A-TREE *CPPLOOPEXIT*) NIL)))
   (CL:T (FIRST-SETTER TREE SYM-CPP-TRANSLATE-STELLA-CPP_BREAK)
  ...
  (CL:LET* ((*CPPLOOPEXIT* NULL))
   ...
   (CL:LET*
    ((ITERATORBINDINGS (%%VALUE (%%REST TREE)))
     ...
     (VALUEASSIGNMENTS NIL) (NEXTASSIGNMENTS NIL)
     (VARARGSITERATOR NULL) (VARIABLES NIL) (OTREE NIL))
    (CL:LET*
      ...
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_STATEMENTS OTREE
       (CONS
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_GOTO_LABEL
         (CPP-TRANSLATE-A-TREE *CPPLOOPEXIT*) NIL)
        NIL))))
    (CL:RETURN-FROM CPP-TRANSLATE-FOREACH-TREE OTREE))))
   ...
   (CL:LET* ((TEST-VALUE-000 (%%VALUE (%%REST TREE))))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 KWD-CPP-TRANSLATE-FUNCTION)
      (CL:LET*
       ((METHODSPEC (%%VALUE (%%REST (%%REST TREE))))
        (OVERLOADED?
         (CL:OR
          (CL:AND (SYMBOL? METHODSPEC)
           (CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME? METHODSPEC))
          (CL:AND (METHOD-SLOT? METHODSPEC)
           (CPP-METHOD-OBJECT-IS-OVERLOADED-FUNCTION? METHODSPEC)))))
       (CL:SETQ OTREE
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_POINTER
         (CL:IF (METHOD-SLOT? METHODSPEC)
          (CPP-TRANSLATE-FUNCTION-NAME METHODSPEC CL:T)
          (CPP-TRANSLATE-FUNCTION-NAME-FROM-NAME METHODSPEC))
         NIL))
       (CL:WHEN OVERLOADED?
        (CL:WHEN (SYMBOL? METHODSPEC)
         (CL:SETQ METHODSPEC (LOOKUP-FUNCTION METHODSPEC)))
        (CL:SETQ OTREE
         (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_CAST OTREE
          (CONS (CPP-TRANSLATE-FUNCTION-SIGNATURE METHODSPEC) NIL))))
       (CL:SETQ OTREE
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_CAST OTREE
         (CONS (WRAP-STRING "cpp_function_code") NIL)))))
     ((CL:EQ TEST-VALUE-000 KWD-CPP-TRANSLATE-METHOD)
      (CL:LET*
       ((METHODSPEC (FOURTH TREE))
        (OWNERSPEC (%%VALUE (%%REST (%%REST TREE)))))
       (CL:SETQ OTREE
        (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_CAST
         (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_METHOD_POINTER
          (CL:IF (METHOD-SLOT? METHODSPEC)
           (CPP-TRANSLATE-METHOD-NAME METHODSPEC CL:T)
           (CPP-TRANSLATE-METHOD-NAME-FROM-NAME METHODSPEC OWNERSPEC))
          NIL)
  ...
  (CL:LET*
   ...
   (CL:COND
    ((CL:NOT (CL:EQ GLOBALVAR NULL))
     (CL:RETURN-FROM CPP-TRANSLATE-ATOMIC-TREE
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
       (CPP-TRANSLATE-GLOBAL-VARIABLE-NAME GLOBALVAR) NIL)))
    (CL:T
     (CL:RETURN-FROM CPP-TRANSLATE-ATOMIC-TREE
      (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
    ...
    (CL:RETURN-FROM CPP-TRANSLATE-METHOD-NAME
     (WRAP-STRING
      (CONCATENATE
       ...
       "::"
       (%WRAPPER-VALUE (CPP-TRANSLATE-FUNCTION-NAME METHOD CL:NIL))))))))
...
(CL:DEFUN CPP-TRANSLATE-DEFINE-METHOD-UNIT (UNIT)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:WHEN (C-CALLABLE-WRAPPER-METHOD? METHOD)
     (CL:SETQ OTREE (CONS SYM-CPP-TRANSLATE-STELLA-CPP_EXTERN_C OTREE))
     (THIRD-SETTER OTREE
      (SUBSTITUTE-CONS-TREE (%%VALUE (%%REST (%%REST OTREE)))
       (WRAP-STRING "int") (WRAP-STRING "boolean")))
     (CL:LET* ((VARDECL NULL) (ITER-000 (FIFTH OTREE)))
      (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
       (CL:SETQ VARDECL (%%VALUE ITER-000))
       (CL:WHEN
        (CL:AND (CONS? VARDECL)
         (EQL-TO-STRING? (%%VALUE VARDECL) "boolean"))
        (FIRST-SETTER VARDECL (WRAP-STRING "int")))
       (CL:SETQ ITER-000 (%%REST ITER-000)))))
...
;;; (DEFUN (CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME? BOOLEAN) ...)

(CL:DEFUN CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME? (FUNCTIONNAME)
  (CL:LET*
   ((FNAME (%SYMBOL-NAME FUNCTIONNAME))
    (DASHPOS (POSITION FNAME #\- 0)) (CLASS NULL))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING FNAME)
    (CL:TYPE CL:FIXNUM DASHPOS))
   (CL:LOOP WHILE (CL:NOT (CL:= DASHPOS NULL-INTEGER)) DO
    (CL:SETQ CLASS (LOOKUP-CLASS (SUBSEQUENCE FNAME 0 DASHPOS)))
    (CL:WHEN
     (CL:AND (CL:NOT (CL:EQ CLASS NULL))
      (CL:NOT
       (SUBTYPE-OF? (%CLASS-TYPE CLASS)
        SGT-CPP-TRANSLATE-STELLA-OBJECT)))
     (CL:RETURN-FROM CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME? CL:T))
    (CL:SETQ DASHPOS (POSITION FNAME #\- (CL:1+ DASHPOS))))
   (CL:RETURN-FROM CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME? CL:NIL)))
...
;;; (DEFUN (CPP-TRANSLATE-SUPER-METHOD-CALL CONS) ...)

(CL:DEFUN CPP-TRANSLATE-SUPER-METHOD-CALL (TREE)
  (CL:LET*
   ((METHODNAME (%%VALUE (%%REST TREE))) (OWNER (%%VALUE TREE))
    (ARGUMENTS (%%REST (%%REST TREE)))
    (SLOT
     (%SLOT-DIRECT-EQUIVALENT
      (LOOKUP-SLOT (%SURROGATE-VALUE OWNER) METHODNAME)))
    (OTREE
     (CPP-TRANSLATE-NORMAL-METHOD-CALL METHODNAME (%SLOT-OWNER SLOT)
      ARGUMENTS CL:NIL))
    (QUALMETHODNAME
     (CONCATENATE (UNWRAP-STRING (CONS-TREE-NTH OTREE 1 1)) "::"
      (%WRAPPER-VALUE (CONS-TREE-NTH OTREE 2 1)))))
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING QUALMETHODNAME))
   (CL:SETQ OTREE
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_CALL
     (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_IDENT
      (WRAP-STRING QUALMETHODNAME) NIL)
     (CONCATENATE (NTH-REST OTREE 4) NIL)))
   (CL:RETURN-FROM CPP-TRANSLATE-SUPER-METHOD-CALL OTREE)))
...
;;; (DEFUN (CPP-TRANSLATE-FUNCTION-SIGNATURE CONS) ...)

(CL:DEFUN CPP-TRANSLATE-FUNCTION-SIGNATURE (FUNCTION)
  (CL:LET*
   ((CPPSIG (YIELD-FUNCTION-CPP-SIGNATURE FUNCTION NULL CL:T))
    (RETURNS (CONS (%%VALUE (%%REST (%%VALUE CPPSIG))) NIL))
    (PARAMS NIL))
   (CL:LET* ((SPEC NULL) (ITER-000 (%%REST CPPSIG)) (COLLECT-000 NULL))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:IF (CL:EQ COLLECT-000 NULL)
      (CL:PROGN
       (CL:SETQ COLLECT-000
        (CONS
         (CL:IF (EQL-TO-STRING? (%%VALUE SPEC) "...") (%%VALUE SPEC)
          (%%VALUE (%%REST SPEC)))
         NIL))
       (CL:IF (CL:EQ PARAMS NIL) (CL:SETQ PARAMS COLLECT-000)
        (ADD-CONS-TO-END-OF-CONS-LIST PARAMS COLLECT-000)))
      (CL:PROGN
       (CL:SETF (%%REST COLLECT-000)
        (CONS
         (CL:IF (EQL-TO-STRING? (%%VALUE SPEC) "...") (%%VALUE SPEC)
       ...
       (CL:SETQ COLLECT-000 (%%REST COLLECT-000))))
     (CL:SETQ ITER-000 (%%REST ITER-000))))
   (CL:RETURN-FROM CPP-TRANSLATE-FUNCTION-SIGNATURE
    (LIST* SYM-CPP-TRANSLATE-STELLA-CPP_FUNCTION_SIGNATURE RETURNS
     (CONS PARAMS NIL)))))
  ...
  (CL:PROGN
   ...
   (CL:SETQ SYM-CPP-TRANSLATE-STELLA-SYS-REFERENCED-CALL-METHOD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SYS-REFERENCED-CALL-METHOD" NULL
     0))
   (CL:SETQ SYM-CPP-TRANSLATE-STELLA-SYS-CALL-SUPER-METHOD
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE3 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-CPP-TRANSLATE-STELLA-CPP_GOTO_LABEL
   ...
   (CL:SETQ SYM-CPP-TRANSLATE-STELLA-CPP_GOTO
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE4 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-CPP-TRANSLATE-STELLA-CPP_EXTERN_C
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE6 ()
  (CL:PROGN (CL:SETQ *CPP-TRUE-STRING-WRAPPER* (WRAP-STRING "TRUE"))
   ...
   (CL:SETQ *CPPLOOPEXIT* SYM-CPP-TRANSLATE-STELLA-CPP_BREAK)
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE7 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "CPP-TRANSLATE-GLOBAL-VARIABLE-NAME"
    "(DEFUN (CPP-TRANSLATE-GLOBAL-VARIABLE-NAME STRING-WRAPPER) ((GLOBAL GLOBAL-VARIABLE)))"
    (CL:FUNCTION CPP-TRANSLATE-GLOBAL-VARIABLE-NAME) NULL)
   (DEFINE-FUNCTION-OBJECT "CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS"
    "(DEFUN (CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS STRING-WRAPPER) ((GLOBAL GLOBAL-VARIABLE)))"
    (CL:FUNCTION CPP-TRANSLATE-GLOBAL-VARIABLE-ADDRESS) NULL)
...
(CL:DEFUN HELP-STARTUP-CPP-TRANSLATE8 ()
  (CL:PROGN
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION CPP-TRANSLATE-ATOMIC-TREE)) NULL)
   (DEFINE-METHOD-OBJECT
...
(CL:DEFUN STARTUP-CPP-TRANSLATE ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    ...
    (DEFINE-FUNCTION-OBJECT "CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME?"
     "(DEFUN (CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME? BOOLEAN) ((FUNCTIONNAME SYMBOL)))"
     (CL:FUNCTION CPP-POSSIBLY-OVERLOADED-FUNCTION-NAME?) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "CPP-TRANSLATE-SUPER-METHOD-CALL"
     "(DEFUN (CPP-TRANSLATE-SUPER-METHOD-CALL CONS) ((TREE CONS)))"
     (CL:FUNCTION CPP-TRANSLATE-SUPER-METHOD-CALL) NULL)
    ...
    (DEFINE-FUNCTION-OBJECT "CPP-TRANSLATE-FUNCTION-SIGNATURE"
     "(DEFUN (CPP-TRANSLATE-FUNCTION-SIGNATURE CONS) ((FUNCTION METHOD-SLOT)))"
     (CL:FUNCTION CPP-TRANSLATE-FUNCTION-SIGNATURE) NULL)
...
file module (occurs in some PowerLoom files - I thought we had outlawed that).\")"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *CPPLOOPEXIT* SYMBOL (QUOTE CPP_BREAK))" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *CPPLOOPEXITACTIVE?* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *CPP-CHARACTER-SUBSTITUTION-TABLE* STRING (CPP-CREATE-CHARACTER-SUBSTITUTION-TABLE))"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *CPP-NAME-QUALIFICATION-MODE* KEYWORD :CLEVER)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *CPP-NAMESPACE-SEPARATOR* STRING \"::\")" NULL)))
  :VOID)
