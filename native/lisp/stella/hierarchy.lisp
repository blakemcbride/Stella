  ...
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%VALUE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%VALUE SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFUN ACCESS-STRING-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-VALUE)
    (CL:IF SETVALUE? (CL:SETF (%VALUE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-CHARACTER (%VALUE SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFUN ACCESS-METHOD-SLOT-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-CODE)
    (CL:IF SETVALUE? (CL:SETF (%METHOD-CODE SELF) VALUE)
     (CL:SETQ VALUE (%METHOD-CODE SELF))))
...
(CL:DEFCLASS GLOBAL-VARIABLE (MAPPABLE-OBJECT)
  ((DOCUMENTATION :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
   ...
   (VARIABLE-AUXILIARY? :ALLOCATION :INSTANCE :ACCESSOR
    %VARIABLE-AUXILIARY?)
   (VARIABLE-NATIVE-OBJECT :DOCUMENTATION
    "Points to a handle that can be used to access the native value."
    :ALLOCATION :INSTANCE :ACCESSOR %VARIABLE-NATIVE-OBJECT)
...
(CL:DEFUN NEW-GLOBAL-VARIABLE ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%VARIABLE-NATIVE-OBJECT SELF) NULL)
...
(CL:DEFUN ACCESS-MUTABLE-STRING-WRAPPER-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-WRAPPER-VALUE)
    (CL:IF SETVALUE?
     (CL:SETF (%WRAPPER-VALUE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-MUTABLE-STRING (%WRAPPER-VALUE SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFCLASS CODE-WRAPPER (WRAPPER)
  ((METHOD-CODE? :DOCUMENTATION
    "Redundant slot that supports a fast type test." :ALLOCATION
    :INSTANCE :ACCESSOR %METHOD-CODE?)))

(CL:DEFUN ACCESS-CODE-WRAPPER-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-METHOD-CODE?)
    (CL:IF SETVALUE?
     (CL:SETF (%METHOD-CODE? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%METHOD-CODE? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
(CL:DEFUN NEW-FUNCTION-CODE-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE)
   (CL:SETF (%METHOD-CODE? SELF) CL:NIL)
...
;;; (DEFCLASS NATIVE-OBJECT-POINTER-WRAPPER ...)

(CL:DEFCLASS NATIVE-OBJECT-POINTER-WRAPPER (WRAPPER)
  ((WRAPPER-VALUE :ALLOCATION :INSTANCE :ACCESSOR %WRAPPER-VALUE))
  (:DOCUMENTATION
...
(CL:DEFUN NEW-NATIVE-OBJECT-POINTER-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-INSTANCE (CL:QUOTE NATIVE-OBJECT-POINTER-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE)
...
;;; (DEFCLASS EXCEPTION-WRAPPER ...)

(CL:DEFCLASS EXCEPTION-WRAPPER (WRAPPER)
  ((WRAPPER-VALUE :ALLOCATION :INSTANCE :ACCESSOR %WRAPPER-VALUE))
  (:DOCUMENTATION
...
(CL:DEFUN NEW-EXCEPTION-WRAPPER (WRAPPER-VALUE)
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF (CL:MAKE-INSTANCE (CL:QUOTE EXCEPTION-WRAPPER)))
   (CL:SETF (%WRAPPER-VALUE SELF) WRAPPER-VALUE)
...
(CL:DEFCLASS SYSTEM-DEFINITION (STANDARD-OBJECT)
  ((NAME :TYPE CL:SIMPLE-STRING :INITFORM STELLA::NULL-STRING
   ...
   (DEFINITION-FILE :ALLOCATION :INSTANCE :ACCESSOR %DEFINITION-FILE)
...
(CL:DEFUN NEW-SYSTEM-DEFINITION ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DEFINITION-FILE SELF) STELLA::NULL-STRING)
...
(CL:DEFUN ACCESS-SYSTEM-DEFINITION-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-HIERARCHY-STELLA-DEFINITION-FILE)
    (CL:IF SETVALUE?
     (CL:SETF (%DEFINITION-FILE SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-STRING (%DEFINITION-FILE SELF)))))
