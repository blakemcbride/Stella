  ...
  (CL:WHEN
   ...
   (CL:LET*
    ((TYPE
      (CANONICAL-TYPE
       (TYPE-SPEC-TO-BASE-TYPE
        (COMPUTE-REAL-SLOT-TYPE SLOT (%CLASS-TYPE CLASS)
...
NOTE: the accessor expects `canonical-slot-name's (which see)."
  ...
  (CL:LET*
   ((SLOTVISIBLE?
     (SUBCLASS-OF? CLASS (%SURROGATE-VALUE (%SLOT-OWNER SLOT))))
    ...
    (ACCESSORCODE
     (CL:IF (CL:AND SLOTVISIBLE? SLOTREADABLE?)
      (%CLASS-SLOT-ACCESSOR-CODE (NATIVE-SLOT-HOME SLOT CLASS)) NULL)))
